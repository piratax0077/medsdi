...
@section('head')
    @include('include.head_urgencia')
@endsection

@section('header')
    @include('include.header_urgencia')
@endsection
        ...
        <div class="pcoded-content">
                    ...
                    <div class="row align-items-center pb-2">
                        <div class="col-md-6">
                            <div class="page-header-title">
                                <h5 class="text-white d-inline f-16 mt-1"><strong>ATENCIÓN MÉDICO DE URGENCIAS</strong></h5>
            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-12 col-lg-4 col-xl-4">
                    @include('page.general.secciones_ficha.fmu_urgencia')
                </div>
                        ...
                        <div class="col-md-12">
                            <div class="tab-content" id="at-oftalmo">
                                ...
                                <div class="tab-pane fade show active" id="atender" role="tabpanel" aria-labelledby="atender-tab">
                                    @include('page.profesional.secciones_ficha.ficha_urgencia')
                                </div>
