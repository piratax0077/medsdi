...
Route::group([
    ...
    Route::post('/Administracion/Comercial/remuneracion/registrarProfesional', [App\Http\Controllers\RemuneracionesController::class, 'registrarProfesional'])->name('adm_cm.remuneracion.registrar_profesional');
