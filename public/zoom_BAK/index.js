...
function websdkready() {
  ...
  // ZoomMtg.setZoomJSLib("https://source.zoom.us/3.1.6/lib", "/av"); // default, don't need call it
  // ZoomMtg.setZoomJSLib("https://jssdk.zoomus.cn/3.1.6/lib", "/av"); // china cdn option
  ZoomMtg.preLoadWasm(); // pre download wasm file to save time.

  // var CLIENT_ID = "XQYahWJTRGe6Bnri_bijMA";
  var CLIENT_ID = "INK3LTlsTDSOfxYXN0xueA";
  /**
   ...
   */
  // var CLIENT_SECRET = "3aEdtyVvpLJE2ARNe6aJ0QIUsnWHoLh4";
  var CLIENT_SECRET = "zV6j3MbIvHiz3fToo6cmgvJTvp9Ny47c";
  ...
  document
    ...
    .addEventListener("click", function (e) {
      ...
      var signature = ZoomMtg.generateSDKSignature({
        ...
        //   var joinUrl = "https://meetingsdk-web-sample.test/CDN/meeting.html?" + testTool.serialize(meetingConfig);
            var joinUrl = "https://medichile_sistema.test/meeting?" + testTool.serialize(meetingConfig);
            console.log(joinUrl);
            //   window.open(joinUrl, "_blank");
            $('#contenedorZoom').show();
            $('#contenedorZoom_2').html('<iframe src="'+joinUrl+'" allow="camera; microphone; display-capture" style="width: 100%;height: 500px;"></iframe>');
        },
      });
    });
  ...
  window.copyJoinLink = function (element) {
    ...
    var signature = ZoomMtg.generateSDKSignature({
      ...
      success: function (res) {
        ...
        meetingConfig.sdkKey = CLIENT_ID;
        var joinUrl = testTool.getCurrentDomain() +"https://medichile_sistema.test/meeting?" +testTool.serialize(meetingConfig);
        document
