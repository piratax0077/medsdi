...
const CLIENT_ID = "INK3LTlsTDSOfxYXN0xueA";
/**
 ...
 */
const CLIENT_SECRET = "zV6j3MbIvHiz3fToo6cmgvJTvp9Ny47c";

// testTool = window.testTool;
// document.getElementById("display_name").value = "Local" +ZoomMtg.getWebSDKVersion()[0] +testTool.detectOS() +"#" +testTool.getBrowserInfo();
...
document.getElementById("join_meeting").addEventListener("click", (e) => {
  ...
  const signature = ZoomMtg.generateSDKSignature({
    ...
    //   const joinUrl = "http://127.0.0.1:9999/meeting.html?" + testTool.serialize(meetingConfig);
      const joinUrl = "https://medichile_sistema.test/meeting?" + testTool.serialize(meetingConfig);
      console.log(joinUrl);
  ...
  const signature = ZoomMtg.generateSDKSignature({
    ...
    success: function (res) {
      ...
      const joinUrl =
        ...
        "https://medichile_sistema.test/meeting?" +
