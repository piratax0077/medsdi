                            ...
                            <Col md={8} className="mt-md-4">
                                ...
                                <ul className="nav nav-tabs profile-tabs nav-fill" id="myTab" role="tablist">
                                    <li className="nav-item">
                                        <a
                                            className={data.activeProfileTab === 'home' ? profileTabActiveClass : profileTabClass}
                                            onClick={() => {
                                    ...
                                    <li className="nav-item">
                                        <a
                                            className={data.activeProfileTab === 'contact' ? profileTabActiveClass : profileTabClass}
                                            onClick={() => {
                                    ...
                                    <li className="nav-item">
                                        <a
                                            className={data.activeProfileTab === 'gallery' ? profileTabActiveClass : profileTabClass}
                                            onClick={() => {
