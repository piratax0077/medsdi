                            ...
                            <Row>
                                <Col md={3}>
                                    ...
                                    <Form.Group>
                                        <Form.Check
                                            ...
                                            id="custom-color"
                                            label="Custom Colors"
                                            defaultChecked={data.showCustomColors}
                                            onChange={toggleValue}
                                        />
                                    </Form.Group>
                                    ...
                                    <Form.Group>
                                        <Form.Check
                                            ...
                                            id="show-output"
                                            label="Show Output"
                                            defaultChecked={data.showOutput}
                                            onChange={toggleValue}
                                        />
                                    </Form.Group>
                                    <Form.Group>
                                        <Form.Check
                                            ...
                                            id="show-footer"
                                            label="Show Footer"
                                            defaultChecked={data.showFooter}
                                            onChange={toggleValue}
                                        />
                                    </Form.Group>
                                    <Form.Group>
                                ...
                                <Col md={9}>
                                    <Stickies
                                        ...
                                        tape={data.showTape}
                                        style={{ float: 'left' }}
                                        colors={data.showCustomColors ? data.colors : undefined}
