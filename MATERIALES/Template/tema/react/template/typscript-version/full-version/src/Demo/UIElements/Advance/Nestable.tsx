...
const AdvanceNestable = () => {
    ...
    const renderExampleOne = () => {
        return (
            <div>
                <Nestable items={items} collapsed={defaultCollapsed} renderItem={renderItem} ref={(el: any) => (refNestable = el)} />
        ...
        return (
            <div>
                <Nestable
                    ...
                    ref={(el: any) => (refNestableHandler = el)}
                />
            </div>
        );
    };
