...
class MaskWithValidation extends BaseFormControl<MaskWithValidationProps, {}> {
    ...
    constructor(props: MaskWithValidationProps) {
        super(props);
                    ...
                    <Card>
                        ...
                        <Card.Body>
                                    ...
                                    <Form.Group as={Col} sm="6" className="mb-5">
                                        ...
                                        <div className="switch">
                                            <Checkbox
                                                ...
                                                label=""
                                                id="check-me"
                                                defaultValue={data.checkMeSwitch}
                                                required
                                                inline
                            ...
                            <AnimatedModal
                                ...
                                onClose={() => setData({ ...data, showModal: false })}
                            >
                                <Card>
