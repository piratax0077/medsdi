                ...
                <Col sm={12} md={6} xl={4}>
                    <Card>
                        ...
                        <Card.Body>
                            ...
                            <Rating
                                stop={10}
                                initialRating={data.blockRating}
                                emptySymbol={
                                ...
                                onChange={(rate) => setData({ ...data, blockRating: rate })}
                                onHover={(rate) => {
                                    const blockRatinggDom = document.getElementById('block-rating');
                                    if (blockRatinggDom) {
                                        (blockRatinggDom as HTMLDivElement).innerHTML = `${rate || data.blockRating}`;
                                    }
                                }}
                            />
                        ...
                        <Card.Body>
                            ...
                            <div className="pill-rating">
                                <Rating
                                    ...
                                    onChange={(rate) => setData({ ...data, pillRating: rate })}
                                />
                            </div>
                        </Card.Body>
                    </Card>
                ...
                <Col sm={12} md={6} xl={4}>
                    <Card>
                        ...
                        <Card.Body>
                            ...
                            <Rating
                                initialRating={data.squareRating}
                                ...
                                onChange={(rate) => setData({ ...data, squareRating: rate })}
                            />
                        </Card.Body>
                    </Card>
                </Col>
                ...
                <Col sm={12} md={6} xl={4}>
                    <Card>
                        ...
                        <Card.Body>
                            ...
                            <Rating
                                initialRating={data.featherRating}
                                emptySymbol={
                                ...
                                onChange={(rate) => setData({ ...data, featherRating: rate })}
                            />
                        </Card.Body>
                    </Card>
                </Col>
                    ...
                    <Card>
                        ...
                        <Card.Body>
                            ...
                            <div className="text-warning">
                                <Rating
                                    stop={10}
                                    initialRating={data.fractionalRating}
                                    emptySymbol="fa fa-star-o fa-2x"
                                    fullSymbol="fa fa-star fa-2x"
                                    fractions={4}
                                    onChange={(rate) => setData({ ...data, fractionalRating: rate })}
                                    onHover={(rate) => {
                ...
                <Col sm={12} md={6} xl={4}>
                    <Card>
                        ...
                        <Card.Body>
                            ...
                            <Rating
                                stop={4}
                                initialRating={data.movieRating}
                                emptySymbol={
                                ...
                                onChange={(rate) => setData({ ...data, movieRating: rate })}
                                onHover={(rate) => {
                    ...
                    <Card>
                        ...
                        <Card.Body>
                            ...
                            <div className="reverse-rating">
                                <Rating
                                    initialRating={data.reverseRating}
                                    emptySymbol={
                                    ...
                                    onChange={(rate) => setData({ ...data, reverseRating: rate })}
                                    onHover={(rate) => {
                                        const reverseRatingDom = document.getElementById('reverse-rating');
                                        if (reverseRatingDom)
                                            (reverseRatingDom as HTMLDivElement).innerHTML = `${
                                                reverseRate[rate - 1] || reverseRate[data.reverseRating - 1]
                                            }`;
                                    }}
                                />
                            </div>
                    ...
                    <Card>
                        ...
                        <Card.Body>
                            ...
                            <div className="horizontal-rating">
                                <Rating
                                    stop={10}
                                    initialRating={data.horizontalRating}
                                    emptySymbol={
                                    ...
                                    onChange={(rate) => setData({ ...data, horizontalRating: rate })}
                                    onHover={(rate) => {
                                        const horizontalRatingDom = document.getElementById('horizontal-rating');
                                        if (horizontalRatingDom)
                                            (horizontalRatingDom as HTMLDivElement).innerHTML = `${rate || data.horizontalRating}`;
                                    }}
                                />
                            </div>
