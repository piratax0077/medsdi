...
const GoogleMap = (props: GoogleMapProps) => {
    ...
    const [data, setData] = useState({
        activeMarker: {} as {} | null,
        selectedPlace: {} as { name?: string },
        showingInfoWindow: false,
        position: null
    });
    const onMarkerClick = (props: any, marker: any) =>
        setData({ ...data, activeMarker: marker, selectedPlace: props, showingInfoWindow: true });
    const onInfoWindowClose = () => setData({ ...data, activeMarker: null, showingInfoWindow: false });
    const onMapClicked = () => {
        if (data.showingInfoWindow) setData({ ...data, activeMarker: null, showingInfoWindow: false });
    };
