...
const FormsElements = () => {
    ...
    const handleSubmitTooltip = (event: React.FormEvent) => {
        const form = event.currentTarget;
        if (!(form as HTMLFormElement).checkValidity()) {
            event.preventDefault();
            event.stopPropagation();
    ...
    const supportedSelectHandler = (event: React.ChangeEvent<HTMLInputElement>) => {
        setData({ ...data, supportedSelect: parseInt(event.target.value) });
    };
    const supportedFileHandler = (event: React.ChangeEvent<HTMLInputElement>) => {
                                ...
                                <Col>
                                    <Form.Group>
                                        <Form.Check
                                            ...
                                            feedback={data.supportedCheckbox ? false : 'Example invalid feedback text.'}
                                            onChange={() =>
                                                setData((prevState) => {
                                    ...
                                    <Form.Group>
                                        <Form.Check
                                            ...
                                            name="supportedRadio"
                                            id="supportedRadio1"
                                            onChange={() => setData({ ...data, supportedRadio: true })}
                                        />
                                        <Form.Check
                                            custom
                                            required
                                            ...
                                            name="supportedRadio"
                                            id="supportedRadio2"
                                            feedback={data.supportedRadio ? false : 'More example invalid feedback text.'}
                                            onChange={() => setData({ ...data, supportedRadio: true })}
                                        />
                                    </Form.Group>
                                    <Form.Group className="mt-3">
