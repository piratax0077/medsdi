...
const FormsWizard = () => {
    ...
    const customRenderer = ({ currentStep, stepIndex, cantBack, isInFinalStep, backHandler, nextHandler }: any) => {
        let i = 0;
    ...
    const customActions = ({ currentStep, stepIndex, cantBack, isInFinalStep, backHandler, nextHandler }: any) => {
        return (
    ...
    const customComponents = ({ currentStep }: { currentStep: number }) => {
