...
const FormsAdvance = () => {
    const [data, setData] = useState<{ defaultSwitch: boolean; tags: Tag[]; tagsSuggestions: Tag[]; suggestions: Tag[] }>({
        defaultSwitch: true,
        tags: [
    ...
    const handleSuggestionsDelete = (i: number) => {
        const tags = data.tagsSuggestions.slice(0);
        tags.splice(i, 1);
        setData({ ...data, tagsSuggestions: tags });
    };
    const handleSuggestionsAddition = (tag: Tag) => {
                                    ...
                                    <Form.Group>
                                        <div className="switch d-inline m-r-10">
                                            <Form.Control
                                                type="checkbox"
                                                id="checked-default"
                                                defaultChecked={data.defaultSwitch}
                    ...
                    <Card>
                        ...
                        <Card.Body>
                            ...
                            <ReactTags
                                ...
                                tags={data.tagsSuggestions}
                                minQueryLength={1}
                                suggestions={data.suggestions}
                                onDelete={handleSuggestionsDelete}
                                onAddition={handleSuggestionsAddition}
                            />
