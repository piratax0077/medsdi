...
class CreateControlesMaxilaresInferioresTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('controles_maxilares_inferiores', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('controles_maxilares_inferiores');
    }
}