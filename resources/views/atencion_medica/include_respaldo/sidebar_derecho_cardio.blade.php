    ...
    <div id="formularios_cardiologicos" class="bs-canvas bs-canvas-anim bs-canvas-right position-fixed bg-light h-100 shadow-lg" data-width="370px" data-offset="true">
         <header class="bs-canvas-header p-3 bg-info overflow-auto">
            <button type="button" class="bs-canvas-close float-left close" aria-label="Close" onclick="$('#formularios_cardiologicos').modal('hide');"> <span aria-hidden="true" class="text-white">&times;</span></button>
        ...
        <div class="bs-canvas-content">
                ...
                <div class="card-sidebar">
                    ...
                    <div id="collapse_recom" class="collapse" aria-labelledby="heading_recom" data-parent="#accordion_side_bar">
                        <div class="card-body-sidebar">
                            <button type="button" class="btn btn-sm btn-info btn-block text-left" onclick="recom_cardiogen()";>+ Recomendaciones Generales cardiología</button>
                            <button type="button" class="btn btn-sm btn-info btn-block text-left" onclick="recom_marcap()";>+ Recomendaciones uso marcapasos</button>
                            <button type="button" class="btn btn-sm btn-info btn-block text-left" onclick="r_ingreso()";>+ Requisitos de ingreso</button>
                    ...
                    @include("atencion_medica.formularios.modal_atencion_especialidad.cardiologia.recom_cardio_gen")
                    @include('atencion_medica.formularios.modal_atencion_especialidad.cardiologia.recom_marcapasos')
    ...
    <script>
        /** recom pacientes**/
        function recom_cardiogen() {
            $('#m_ind_gen_cardio').modal('show');
        }
        function recom_marcap() {
            $('#m_ind_marcap').modal('show');
        }
    </script>
