    <!--Sidebar broncopulmonar)-->
        <div class="position-fixed w-100 h-100"></div>
        <div id="formularios_broncopulmonar" class="bs-canvas bs-canvas-anim bs-canvas-right position-fixed bg-light h-100 shadow-lg" data-width="370px" data-offset="true">
            <header class="bs-canvas-header p-3 bg-info overflow-auto">
            <button type="button" class="bs-canvas-close float-left close" aria-label="Close" onclick="$('#formularios_broncopulmonar').modal('hide');"> <span aria-hidden="true" class="text-white">&times;</span></button>
                <h5 class="d-inline-block text-light mb-0 float-right">Formularios Broncopulmonar</h5>
            </header>
                ...
                <div class="accordion" id="accordion_side_bar">
                  ...
                  <div class="accordion" id="accordion_side_bar">
                    ...
                    <div class="card-sidebar">
                        ...
                        <div class="card-body-sidebar">
                            <button type="button" class="btn btn-sm btn-info btn-block text-left" onclick="recom_broncogen()";>+ Recomendaciones Generales Broncopulmonares</button>
                            <button type="button" class="btn btn-sm btn-info btn-block text-left" onclick="recom_epoc()";>+ Recomendaciones paciente EPOC</button>
                    ...
                    @include("atencion_medica.formularios.modal_atencion_especialidad.broncopulmonar.recom_bronco_gen")
                    @include('atencion_medica.formularios.modal_atencion_especialidad.broncopulmonar.recom_epoc')
    ...
    <script>
        /** recom pacientes**/
       function recom_broncogen() {
            $('#m_ind_gen_bronco').modal('show');
        }
        function recom_epoc() {
            $('#m_ind_epoc').modal('show');
        }
