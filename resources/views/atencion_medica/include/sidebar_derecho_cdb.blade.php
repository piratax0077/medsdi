                ...
                <div class="card-sidebar">
                    ...
                    <div id="collapse_solicitud_examenes" class="collapse" aria-labelledby="heading_solicitud_examenes" data-parent="#accordion_side_bar">
                        <div class="card-body-sidebar">
                            ...
                            <button type="button" class="btn btn-sm btn-info btn-block text-left" onclick="";>+ Exámenes Específicos</button>
                            <button type="button" class="btn btn-sm btn-info btn-block text-left" onclick="";>+ Orden radiología</button>
                            <button type="button" class="btn btn-sm btn-info btn-block text-left" onclick="";>+ Biopsias </button>
                        </div>
                    </div>
                </div>
