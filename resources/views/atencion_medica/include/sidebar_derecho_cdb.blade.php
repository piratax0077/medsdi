    ...
    <div id="formularios_colon" class="bs-canvas bs-canvas-anim bs-canvas-right position-fixed bg-light h-100 shadow-lg" data-width="370px" data-offset="true">
        ...
        <div class="bs-canvas-content">
            <div class="accordion" id="accordion_cirugia_baja">
                <div class="card-sidebar">
                    ...
                    <div id="collapse_solicitud_examenes" class="collapse" aria-labelledby="heading_solicitud_examenes" data-parent="#accordion_cirugia_baja">
                ...
                <div class="card-sidebar">
                    ...
                    <div id="collapse_consentimientos_informados" class="collapse" aria-labelledby="heading_consentimientos_informados" data-parent="#accordion_cirugia_baja">
                        <div class="card-body-sidebar">
