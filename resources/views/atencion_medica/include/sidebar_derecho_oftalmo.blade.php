        ...
        <div class="bs-canvas-content">
            <div class="accordion" id="accordion_gineco_obst">
				...
				<div class="card-sidebar">
                    ...
                    @include("atencion_medica.sidebars.modals_especialidad.oftalmologia.recom_refractiva")
                    @include("atencion_medica.sidebars.modals_especialidad.oftalmologia.recom_retina")
    ...
    {{--  @include("atencion_medica.sidebars.modals_especialidad.modal_exbiopsia_orl");  --}}
    @include("atencion_medica.sidebars.modals_especialidad.oftalmologia.modal_exorina")
    @include("atencion_medica.sidebars.modals_especialidad.oftalmologia.modal_exradiologico_oft")
    @include("atencion_medica.sidebars.modals_especialidad.oftalmologia.modal_exhormonales")
