    ...
    <div id="formularios_cir_dalta" class="bs-canvas bs-canvas-anim bs-canvas-right position-fixed bg-light h-100 shadow-lg" data-width="370px" data-offset="true">
             ...
             <button type="button" class="bs-canvas-close close" onclick="$('#formularios_cir_dalta').modal('hide')" aria-label="Close" data-dismiss="modal"> <span aria-hidden="true" class="text-white">&times;</span></button>
				...
				<div class="card-sidebar">
                    ...
                    <div id="collapse_sugerencias" class="collapse" aria-labelledby="heading_sugerencias" data-parent="#accordion_side_bar">
                        ...
                        <div class="card-body-sidebar">
                            ...
                            <button type="button" class="btn btn-sm btn-danger btn-block text-left" onclick="abrir_modal_nueva_ram('')">
