                   ...
                   <!-- SECCION CONSENTIMIENTOS -->
                    ...
                    <div class="card-sidebar">
                        ...
                        <div id="collapse_recom" class="collapse" aria-labelledby="heading_recom" data-parent="#accordion_side_bar">
                            <div class="card-body-sidebar">
                                <button type="button" class="btn btn-sm btn-info btn-block text-left" onclick="ind()";>+ Indicaciones 1</button>
                                <button type="button" class="btn btn-sm btn-info btn-block text-left" onclick="ind()";>+ Indicaciones 2</button>
                                <button type="button" class="btn btn-sm btn-info btn-block text-left" onclick="ind()";>+ Indicaciones 3</button>
                                <button type="button" class="btn btn-sm btn-info btn-block text-left" onclick="i()";>+ Indicaciones 4</button>
                            </div>
                        </div>
                    </div>
                     <div class="card-sidebar">
