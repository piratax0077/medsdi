 <!--SIDEBAR 3 gastro)-->
        ...
        <div id="formularios_gastroenterologia" class="bs-canvas bs-canvas-anim bs-canvas-right position-fixed bg-light h-100 shadow-lg" data-width="370px" data-offset="true">
             ...
             <button type="button" class="bs-canvas-close close" onclick="$('#formularios_gastroenterologia').modal('hide')" aria-label="Close" data-dismiss="modal"> <span aria-hidden="true" class="text-white">&times;</span></button>

             <h5 class="d-inline-block text-light mb-0 float-right">Formularios Gastroenterología</h5>
