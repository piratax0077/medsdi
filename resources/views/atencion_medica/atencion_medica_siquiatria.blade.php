@extends('template.template_siquiatria')
@section('Content')
                ...
                <div class="page-block">
                    <div class="row align-items-center pb-2">
                        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                            ...
                            <h5 class="text-white d-inline f-16 mt-1"><strong>ATENCION PSIQUIÁTRICA</strong></h5>
                ...
                <div class="col-md-12">
                    <div class="tab-content" id="at-oftalmo">
                        ...
                        <div class="tab-pane fade show active" id="atender" role="tabpanel" aria-labelledby="atender-tab">
                            @include('atencion_medica.secciones_especialidad.ficha_siquiatria')
                        </div>
                        <!--Licencia-->
