<div id="m_espiro" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="m_espiro" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header bg-info">
                <h5 class="modal-title text-white text-center">Solicitud Examen de Espirometría</h5>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-danger btn-sm" onclick="cerrarsol_examen_espiro();" data-dismiss="modal">Cancelar</button>
