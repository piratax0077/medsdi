<div id="m_ex_cardio" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="m_ex_cardio" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header bg-info">
                <h5 class="modal-title text-white text-center">Solicitud Examen de Cardiológicos</h5>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-danger btn-sm" onclick="cerrarsol_examen_cardiologia();" data-dismiss="modal">Cancelar</button>
...
<script>
    ...
    function sol_examen_cardiologia()
    {
        $('#m_ex_cardio').modal('show');
    }
    function cerrarsol_examen_cardiologia() {
        $('#m_ex_cardio').modal ('hide');
      }
