<div id="m_ex_rx_cardio" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="m_ex_rx_cardio" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header bg-info">
                <h5 class="modal-title text-white text-center">Solicitud Examen de Radiológicos cardiovasculares</h5>
                                ...
                                <table class="table table-bordered table-xs">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="text-center align-middle">Reflujo</td>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-danger btn-sm" onclick="cerrarsol_examen_rx_cardio();" data-dismiss="modal">Cancelar</button>
...
<script>
    ...
    function sol_examen_rx_cardio()
    {
        $('#m_ex_rx_cardio').modal('show');
    }
    function cerrarsol_examen_rx_cardio() {
        $('#m_ex_rx_cardio').modal ('hide');
      }
