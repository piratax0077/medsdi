    ...
    <div class="row">
        ...
        <div class="col-sm-12 col-md-6 text-center">
            <div class="btn-group btn-group-xs w-100" data-toggle="buttons">
                <button type="button" id="btn_agregar_medicamento" class=" btn_agregar_medicamento btn btn-primary-light-c btn-xs mt-1" onclick="i_medicamento();"><i class="feather icon-plus"></i> Indicar
                    medicamento</button>
                <button type="button" onclick="ver_pdf_receta($('#id_fc').val());" class=" btn_medicamento_pdf btn btn-info-light-c  btn-xs mt-1" id="btn_medicamento_pdf"><i class="feather icon-file"></i>Ver PDF</button>
            </div>
        </div>
        <div class="col-sm-12 col-md-6">
            <div class="btn-group btn-group-sm w-100" data-toggle="buttons">
                <button type="button" id="btn_agregar_examen" class=" btn_agregar_examen btn btn-primary-light-c btn-xs mt-1" onclick="mostrar_modal_examen_cirguria();"><i class="feather icon-plus"></i>
                    Indicar examen</button>
                <button type="button" onclick="ver_pdf_orden_examenes($('#id_fc').val());" class=" btn_examenes_pdf btn btn-info-light-c btn-xs mt-1" id="btn_examenes_pdf"><i class="feather icon-file"></i>Ver PDF</button>
            </div>
        </div>
        @else
        <div class="col-sm-12 col-md-6 text-center">
