                ...
                <div class="row">
                    <div class="col-md-12">
                        <ul class="nav nav-pills mb-3" id="tablas_examenes" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link-wizard" id="examenes_esp_tab" data-toggle="pill" href="#pills_examenes_esp" role="tab" aria-controls="pills-home" aria-selected="true">Exámenes de Especialidad </a>
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="tab-content" id="pills-tablas_examenes">
                            ...
                            <div class="tab-pane fade" id="pills_examenes_esp" role="tabpanel" aria-labelledby="examenes_esp_tab">
                                <div class="dt-responsive table-responsive pb-4">
                                    <table id="table_examenes_esp" class="display table dt-responsive nowrap table-xs" style="width:100%">
                                        <thead>
                                            <tr>
                                                <th class="text-center align-middle">Fecha</th>
                                                <th class="text-center align-middle">Nº de Orden</th>
