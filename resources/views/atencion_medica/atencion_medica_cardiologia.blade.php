@extends('template.template_cardiologia')
@section('Content')
    <!--Container Completo-->
    <div class="pcoded-main-container">
                ...
                <div class="col-md-12">
                    <div class="tab-content" id="at-oftalmo">
                        ...
                        <div class="tab-pane fade show active" id="atender" role="tabpanel" aria-labelledby="atender-tab">
                            @include('atencion_medica.secciones_especialidad.ficha_cardiologia')
                        </div>
                        <!--Licencia-->
        ...
        @include("atencion_medica.include.sidebar_derecho_cardio")
