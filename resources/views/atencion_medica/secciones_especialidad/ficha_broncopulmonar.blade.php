        ...
        <div class="row mx-0">
            <div class="col-sm-12 col-md-12">
                <ul class="nav nav-tabs-secciones mb-3 mt-3" id="orl" role="tablist">
                    ...
                    {{--  <li class="nav-item-secciones">
                        <a class="nav-secciones text-uppercase" id="broncoscopia-tab" data-toggle="tab" href="#endosc_gastrica" role="tab" aria-controls="broncoscopia" aria-selected="false">Endoscopía Digestiva Alta</a>
                    </li>  --}}
				</ul>
            </div>
             ...
             <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                <form action="{{ route('fichaAtencion.registrar_ficha_cdg') }}" method="POST">
                    ...
                    <div class="tab-content" id="CDA-contenido">
                                                ...
                                                <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6 ">
                                                    <div class="form-row mt-1">
                                                        <div class="form-group col-sm-12 col-md-12 col-lg-6 col-xl-6">
                                                            ...
                                                            <select class="js-example-basic-multiple" name="desinf" id="desinf" multiple="multiple">
                                                        ...
                                                        <div class="form-group col-sm-12 col-md-12 col-lg-6 col-xl-6">
                                                            ...
                                                            <select class="js-example-basic-multiple" name="tpo_cub" id="tpo_cub" multiple="multiple">
                        ...
                        <!--INFORME BRONCOSCOPÍA-->
                        <div class="tab-pane fade" id="broncoscpia" role="tabpanel" aria-labelledby="broncoscpia-tab">
