...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#urogen_cir').change(function() {
            if ($('#urogen_cir').is(':checked')) {
    ...
    // mi-imagen-uro-pre
    var myDropzone_pre ;
    Dropzone.options.miImagenUroPre = {
        init:function()
        {
            myDropzone_pre = this;
        },
        ...
        success: function(file, response){
            // console.log('-------------success-----------------------');
            $('#imagen_uro_pre').val(response.img.nombre_img);
            cargar_lista_imagenes(myDropzone_pre,'pre');
    ...
    // mi-imagen-uro-post
    var myDropzone_post ;
    Dropzone.options.miImagenUroPost = {
        init:function()
        {
            myDropzone_post = this;
        },
        url: "{{ route('profesional.imagen.carga') }}",
        method: 'post',
        createImageThumbnails: true,
        ...
        success: function(file, response){
            // console.log('-------------success-----------------------');
            $('#imagen_uro_post').val(response.img.nombre_img);
            cargar_lista_imagenes(myDropzone_post,'post');
