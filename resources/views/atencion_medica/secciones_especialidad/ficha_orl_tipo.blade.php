                ...
                <div class="container">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input class="form-control form-control-sm "name="registro_f_t_orl_nombre" id="registro_f_t_orl_nombre">
                        </div>

                        <div class="form-group col-md-6">
                            <label class="floating-label-activo-sm">Descripción</label>
                            <textarea class="form-control caja-texto form-control-sm" rows="1"  onfocus="this.rows=6" onblur="this.rows=1;" name="registro_f_t_orl_descripcion" id="registro_f_t_orl_descripcion"></textarea>
                        </div>

                    </div>
                    <div class="form-row">
                        <div class="col-md-12" id ="registro_f_t_orl_detalle" >
