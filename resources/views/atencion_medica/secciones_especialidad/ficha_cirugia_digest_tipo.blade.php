...
<div id="modal_registrar_ficha_tipo_dg" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="modal_registrar_ficha_tipo_dg" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header bg-info">
                <h5 class="modal-title text-white">Registro de Ficha Tipo de Cirugía Digestiva</h5>
