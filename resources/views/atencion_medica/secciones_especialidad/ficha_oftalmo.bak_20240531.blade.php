                                                                        ...
                                                                        <div class="tab-pane fade show" id="examen_biomicroscop" role="tabpanel" aria-labelledby="examen_biomicroscop-tab">
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-sm-10">
                                                                                                ...
                                                                                                <div class="form-row">
                                                                                                    ...
                                                                                                    <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                                                                                        ...
                                                                                                        <div class="form-group" id="div_biocornea_od" style="display:none;">
                                                                                                            <label class="floating-label-activo-sm t-red" for="obs_biocornea_od">Córneas</label>
                                                                                                ...
                                                                                                <div class="form-row">
                                                                                                    ...
                                                                                                    <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                                                                                        ...
                                                                                                        <div class="form-group" id="div_tyndall_od" style="display:none;">
                                                                                                            <label class="floating-label-activo-sm t-red" for="obs_tyndall_od">Tyndall</label>
                                                                                                    ...
                                                                                                    <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                                                                                        ...
                                                                                                        <div class="form-group" id="div_cristalino_bio_od" style="display:none;">
                                                                                                            <label class="floating-label-activo-sm t-red" for="obs_cristalino_bio_od">Cristalino</label>
                                                                                                ...
                                                                                                <div class="form-row">
                                                                                                    ...
                                                                                                    <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                                                                                        ...
                                                                                                        <div class="form-group" id="div_biocornea_oi" style="display:none;">
                                                                                                            <label class="floating-label-activo-sm t-blue" for="obs_biocornea_oi">Córneas</label>
                                                                                                ...
                                                                                                <div class="form-row">
                                                                                                    ...
                                                                                                    <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                                                                                        ...
                                                                                                        <div class="form-group" id="div_tyndall_oi" style="display:none;">
                                                                                                            <label class="floating-label-activo-sm t-blue" for="obs_tyndall_oi">Tyndall</label>
                                                                                                    ...
                                                                                                    <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                                                                                        ...
                                                                                                        <div class="form-group" id="div_cristalino_bio_oi" style="display:none;">
                                                                                                            <label class="floating-label-activo-sm t-blue" for="obs_cristalino_bio_oi">Cristalino</label>
                                                                                    ...
                                                                                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                                                                        <div class="form-group" >
                                                                                            <label class="floating-label-activo-sm t-blue" for="otro">Observaciones Generales</label>
                                                                                                ...
                                                                                                <div class="form-row">
                                                                                                    ...
                                                                                                    <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                                                                                        ...
                                                                                                        <div class="form-group" id="div_bordes_od" style="display:none;">
                                                                                                            <label class="floating-label-activo-sm t-red" for="obs_bordes_od">Bordes</label>
                                                                                                ...
                                                                                                <div class="form-row">
                                                                                                    <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                                                                                        ...
                                                                                                        <div class="form-group" id="div_maculas_fo_od" style="display:none;">
                                                                                                            <label class="floating-label-activo-sm t-red" for="obs_maculas_fo_od">Máculas (describir)</label>
                                                                                                    ...
                                                                                                    <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                                                                                        ...
                                                                                                        <div class="form-group" id="div_vasos_fo_od" style="display:none;">
                                                                                                            <label class="floating-label-activo-sm t-red" for="obs_vasos_fo_od">Vasos</label>
                                                                                                    ...
                                                                                                    <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                                                                                        ...
                                                                                                        <div class="form-group" id="div_periferia_fo_od" style="display:none;">
                                                                                                            <label class="floating-label-activo-sm t-red" for="obs_periferia_fo_od">Periféria</label>
                                                                                        ...
                                                                                        <div class="tab-pane fade " id="fondo_ojo_izq" role="tabpanel" aria-labelledby="fondo_ojo_izq-tab">
                                                                                            ...
                                                                                            <div class="col-sm-12 col-md-12">
                                                                                                ...
                                                                                                <div class="form-row">
                                                                                                    <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                                                                                        <div class="form-group">
                                                                                                            <label class="floating-label-activo-sm" t-blue for="maculas_fo_oi" >Máculas</label>
