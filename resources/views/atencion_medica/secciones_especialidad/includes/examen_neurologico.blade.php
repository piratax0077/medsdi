                                                            ...
                                                            <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select name="eval_conciencia" data-titulo="Evaluación de Conciencia" data-seccion="Funciones Corticales" id="eval_conciencia" class="form-control form-control-sm" onchange="evaluar_para_carga_detalle('eval_conciencia','div_eval_conciencia','obs_eval_conciencia',2);">
                                                                        <option selected  value="1">Normal y Alerta</option>
                                                            ...
                                                            <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select name="conciencia_dism" data-titulo="Conciencia Disminuida" data-seccion="Funciones Corticales" id="conciencia_dism" class="form-control form-control-sm" onchange="evaluar_para_carga_detalle('conciencia_dism','div_conciencia_dism','obs_conciencia_dism',2);">
                                                                        ...
                                                                        <option value="2">Disminuido (Anotar)</option>
                                                                    </select>
                                                                </div>
                                                            ...
                                                            <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select name="orientac" data-titulo="Orientación" data-seccion="Funciones Corticales" id="orientac" class="form-control form-control-sm" onchange="evaluar_para_carga_detalle('orientac','div_orientac','obs_orientac',2);">
                                                                        <option selected  value="1">Orientado en Tiempo y espacio</option>
                                                                        <option value="2">Alterado (Anotar)</option>
                                                                    </select>
                                                                </div>
                                                            ...
                                                            <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select name="l_af_tipo" data-titulo="Tipos" data-seccion="Lenguaje" id="l_af_tipo" class="form-control form-control-sm" onchange="evaluar_para_carga_detalle('l_af_tipo','div_l_af_tipo','obs_l_af_tipo',4);">
                                                                        <option selected  value="1">Motora</option>
                                                                        <option value="2"> Sensitiva</option>
                                                                        <option value="3"> Global</option>
                                                                        <option value="4"> Describir Observaciones</option>
                                                                    </select>
                                                                </div>
                                                        ...
                                                        <div class="form-row">
                                                            ...
                                                            <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select name="lf_ref_hip" data-titulo="Cap. Inhibir Comportamiento I" data-seccion="Lob. Frontal" id="lf_ref_hip"  class="form-control form-control-sm" onchange="evaluar_para_carga_detalle('lf_ref_hip','div_lf_ref_hip','obs_lf_ref_hip',2);">
                                                                        <option selected  value="1">Normal</option>
                                                                        <option value="2">Anormal</option>
                                                                        <option value="3">No Examinado</option>
                                                                    </select>
                                                            ...
                                                            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                                                <div class="form-group fill">
                                                                    <label class="floating-label-activo-sm" for="otros_ex_lob_fr">Otros antecedentes Lobulo Frontal</label>
                                                        ...
                                                        <div class="form-row">
                                                            <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select name="pc_fac" data-titulo="VII.- Facial" data-titulo="VII.- Facial" data-seccion="Nervios Craneales"  id="pc_fac" class="form-control form-control-sm" onchange="evaluar_para_carga_detalle('pc_fac','div_pc_fac','obs_pc_fac',2);">
                                                                        <option selected  value="1">Normales</option>
                                                                        <option value="2">Anormales</option>
                                                                    </select>
                                                                </div>
                                                            ...
                                                            <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select name="pc_glof" data-titulo="Córneas OI" data-titulo="IX.- Glosofaríngeo" data-seccion="Nervios Craneales" id="pc_glof" class="form-control form-control-sm" onchange="evaluar_para_carga_detalle('pc_glof','div_pc_glof','obs_pc_glof',2);">
                                                                        <option selected  value="1">Normal</option>
                                                                        <option value="2">Anormal</option>
                                                                    </select>
                                                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 col-md-12 col-xl-12">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                                    <div class="form-group">
                                                        <label class="floating-label-activo-sm " for="post_p_pie"> Posición de píe</label>
                                                        <select name="post_p_pie" data-titulo="Posición de píe" data-seccion="Examen Postural"  id="post_p_pie" class="form-control form-control-sm" onchange="evaluar_para_carga_detalle('post_p_pie','div_post_p_pie','obs_post_p_pie',2);">
                                                            <option value="1">Normales</option>
                                                            <option value="2">Anormales</option>
                                                        </select>
                                                    </div>
                                                    <div class="form-group" id="div_post_p_pie" style="display:none;">
                                                        <label class="floating-label-activo-sm " for="obs_post_p_pie">Posición de píe<i>(Describir)</i></label>
                                                        <textarea class="form-control form-control-sm" data-titulo="Obs. Posición de píe"  data-seccion="Examen Postural" rows="1"  onfocus="this.rows=3" onblur="this.rows=1;" name="obs_post_p_pie" id="obs_post_p_pie"></textarea>
                                                    </div>
                                                </div>
                                                <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                                    <div class="form-group">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                                    ...
                                                    <div class="form-group" id="div_post_mar_tp" style="display:none;">
                                                        ...
                                                        <textarea class="form-control form-control-sm" data-titulo="Obs. Periferia OD" data-seccion="Examen Marcha" rows="1"  onfocus="this.rows=3" onblur="this.rows=1;" name="obs_post_mar_tp" id="obs_post_mar_tp"></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-row">
                                                <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                                    ...
                                                    <div class="form-group" id="div_post_mar_ampl" style="display:none;">
                                                        <label class="floating-label-activo-sm " for="obs_post_mar_ampl">Amplitud de la Marcha </i><(describir)</label>
                                                ...
                                                <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                                    ...
                                                    <div class="form-group" id="div_post_mar_bs" style="display:none;">
                                                        ...
                                                        <textarea class="form-control form-control-sm" data-titulo="Obs. Vasos OD" data-seccion="Examen Marcha" rows="1"  onfocus="this.rows=3" onblur="this.rows=1;" name="obs_post_mar_bs" id="obs_post_mar_bs"></textarea>
                                                    </div>
                                                </div>
                                                <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                                    <div class="form-group">
                                            ...
                                            <div class="form-row">
                                                <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                                    ...
                                                    <div class="form-group" id="div_im_rnuc" style="display:none;">
                                                        ...
                                                        <textarea class="form-control form-control-sm" data-titulo="Obs. Rigidez de Nuca"  rows="1"  onfocus="this.rows=3" onblur="this.rows=1;" name="obs_im_rnuc" id="obs_im_rnuc"></textarea>
                                                    </div>
                                                </div>
                                                <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group" id="div_im_s_ker" style="display:none;">
                                                        ...
                                                        <textarea class="form-control form-control-sm" data-titulo="Obs. Excavacion OD" data-seccion="Irritación Meningea" rows="1"  onfocus="this.rows=3" onblur="this.rows=1;" name="obs_im_s_ker" id="obs_im_s_ker"></textarea>
                                                    </div>
                                                </div>
                                                <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                                    <div class="form-group">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-sm-12 col-md-12 col-lg-12 col-xl-12 mb-0 mt-0">
                                            ...
                                            <div class="switch switch-success d-inline m-r-10">
                                                <input type="checkbox" id="tto_neuro" name="tto_neuro" value="1" onchange="javascript:showContentneuro()" />
                                        ...
                                        <div class="form-group col-sm-12 col-md-12 col-lg-12 col-xl-12 mb-0 mt-0">
                                            ...
                                            <div class="switch switch-success d-inline m-r-10">
                                                <input type="checkbox" id="pr_neuro" name="pr_neuro" value="1" onchange="javascript: showContentProc_neuro() " />
                                        ...
                                        <div class="form-group col-sm-12 col-md-12 col-lg-12 col-xl-12 mb-0">
                                            <div class="form-group">
                                                <div class="switch switch-success d-inline m-r-10">
                                                    ...
                                                    <input type="checkbox" class="custom-control-input" id="neuro_cir" name="neuro_cir" value="{!! old('neuro_cir') !!}">
