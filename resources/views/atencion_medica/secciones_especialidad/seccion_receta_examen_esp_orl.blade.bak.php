    ...
    <div class="row">
        ...
        <div class="col-sm-12 col-md-6 text-center">
            <div class="btn-group btn-group-xs w-100" data-toggle="buttons">
                ...
                <button type="button" onclick="ver_pdf_receta($('#id_fc').val());" class=" btn_medicamento_pdf btn btn-warning btn-xs mt-1 wid-20" id="btn_medicamento_pdf"><i class="feather icon-file"></i> Ver PDF</button>
            </div>
        </div>
        <div class="col-sm-12 col-md-6">
            <div class="btn-group btn-group-xs w-100" data-toggle="buttons">
                ...
                <button type="button" onclick="ver_pdf_orden_examenes($('#id_fc').val());" class=" btn_examenes_pdf btn btn-warning btn-xs mt-1 wid-20" id="btn_examenes_pdf"><i class="feather icon-file"></i> Ver PDF</button>
            </div>
        </div>
        @else
        <div class="col-sm-12 col-md-6 text-center">
