            ...
            <div class="col-md-12">
                <div class="card-deck m-b-30">
                    <div class="card subir">
                        <a href="{{ ROUTE('app.laboratorio.lab_asistente.agenda_laboratorio') }}">
                    ...
                    <div class="card subir">
                        <a href="{{ ROUTE('app.laboratorio.lab_asistente.orden_laboratorio') }}">
                            <div class="card-body text-center" style="cursor:pointer">
                    ...
                    <div class="card subir">
                        <a href="{{ ROUTE('app.laboratorio.lab_asistente.cotizar_laboratorio') }}">
                            <div class="card-body text-center" style="cursor:pointer">
                    ...
                    <div class="card subir">
                        <a href="{{ ROUTE('app.laboratorio.lab_asistente.pacientes_laboratorio') }}">
                            <div class="card-body text-center" style="cursor:pointer">
								<img class="wid-60 text-center" src="{{ asset('images/iconos/agenda.svg') }}">
