                    ...
                    <div class="card-deck">
                        ...
                        <div class="card subir">
                            <a href="{{ ROUTE('lab.exa.asistente.orden_laboratorio') }}">
                                <div class="card-body text-center" style="cursor:pointer">
                                    <img class="wid-50 text-center" src="{{ asset('images/iconos/orden-examen.png') }}">
            ...
            <div class="row mb-3">
                <div class="col-md-12">
                    <div class="card-deck">
                        ...
                        <div class="card subir">
                            <a href="{{ ROUTE('lab.exa.asistente.cargar_resultados_examenes_laboratorio') }}">
                                <div class="card-body text-center" style="cursor:pointer">
                                    <img class="wid-50 text-center" src="{{ asset('images/iconos/subir-examen.svg') }}">
                                    <h5 class="mt-2">Enviar exámenes a pacientes</h5>
                                </div>
                            </a>
                        </div>
                    </div>
