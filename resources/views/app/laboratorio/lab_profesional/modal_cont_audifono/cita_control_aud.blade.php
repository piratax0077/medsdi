<!--datos Contacto-->
<div id="control_audifono" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="control_audifono" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header bg-info">
                <h5 class="modal-title text-white d-inline mt-1">Control Audífono</h5>
...
<script>
    function cita_cont_audif (){
        $('#control_audifono').modal('show');
    }
