    ...
    <div class="col-md-6 mb-3">
        <div class="card border-info">
            <div class="card-body text-info">
                <h5 class="card-title">Comisión (10%)</h5>
                <h3 class="card-text">${{ number_format($total_valor * 0.10, 0, ',', '.') }}</h3>
            </div>
        </div>
    </div>
    <div class="col-md-12">
...
<div class="row mt-4">
    ...
    <div class="col-md-6 mb-3">
        <div class="card border-info">
            <div class="card-body text-info">
                <h5 class="card-title">Comisión (10%)</h5>
                <h3 class="card-text">${{ number_format($total_Valor_productos * 0.10, 0, ',', '.') }}</h3>
            </div>
        </div>
    </div>
    <div class="col-md-12">
