...
@section('page-script')
    <script>
        ...
        function evaluar_tipo_producto(){
        ...
        function guardarItemFactura() {
            ...
            var lado_producto = $('#lado_producto').val();
            ...
            if(tipo_producto == '9'){
                if(lado_producto === '0'){
                    mensaje += '<li>Debe seleccionar un lado del producto</li>';
                    valido = 0;
                }
            }
            ...
            formData.append('lado_producto', lado_producto);
            ...
            $.ajax({
                url: "{{ route('laboratorio.bodega.guardarItemFactura') }}",
                type: 'POST',
                data: formData,
                processData: false,
                contentType: false,
        ...
        function dameProductosPorTipo(idTipo) {
            ...
            var url = '/Administracion/buscarProductosTipo/' + idTipo + '/' + id_lugar_atencion;
        ...
        function detalleCompraProducto(idProducto) {
            var url = '/Administracion/detalleCompraProducto/' + idProducto;
            $.ajax({
                type: 'get',
                url: url,
                success: function(response) {
                        ...
                        <div id="contenedor_procedimiento" class="d-none">
                            ...
                            <div class="form-row" id="procedimiento">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <select name="producto" class="form-control form-control-sm" id="producto" onchange="evaluar_tipo_producto()">
