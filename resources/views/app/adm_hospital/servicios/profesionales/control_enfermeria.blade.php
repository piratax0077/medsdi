                        ...
                        <ul class="nav nav-tabs-aten nav-fill mb-3" id="enf_urgencia" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link-aten text-reset"  id="enf_tto_tab" data-toggle="tab" href="#enf_tto"
                                    role="tab" aria-controls="enf_tto" aria-selected="true" @if(isset($tiene_receta_pendiente)) style="background: darkred !important; color: white !important;" @endif>Tratamientos</a>
                            </li>
                            <li class="nav-item">
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                        <div class="tab-content" id="orl_adulto">
                            <!--INGRESO ENFERMERIA-->
                            <div class="tab-pane fade show active" id="ing_pac" role="tabpanel"
                        ...
                        <div class="modal-body">
                            ...
                            <form id="form_reseva_de_horas">
                                ...
                                <div id="reserva_datos_paciente" class="row mx-3" style="display:none;">
                                    ...
                                    <div class="modal-footer mb-0 pt-1 pb-0">
                                        ...
                                        <button type="button"   onclick="cobro_urg();"class="btn btn-info" id="btn_cobro_paciente"><i class="feather icon-check"></i>Cobro Ingreso Paciente</button>
                            ...
                            <div class="tab-pane fade show" id="enf_cont_ciclo" role="tabpanel"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                        <table id="tabla_control_ciclo_servicio"
                                            class="display table table-striped table-sm dt-responsive nowrap"
                                            style="width:100%">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="text-center align-middle">PD</th>
                                                    <th class="text-center align-middle">PAM</th>
                                                    <th class="text-center align-middle">Pulso</th>
                                                    <th class="text-center align-middle">EVA</th>
                                                    <th class="text-center align-middle">FR</th>
                                    ...
                                    <div class="col-sm-12 col-md-12 col-xl-12">
                                        <div class="tab-content" id="v-pills-tabContent">
                                            <div class="tab-pane fade show active" id="enf_cont_ciclo"
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                                    {{-- @include('page.general.secciones_ficha.signos_vitales_ingreso_urgencia') --}}
                                                     </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="tab-pane fade show " id="enf_asig_urg" role="tabpanel"
                                ...
                                <div class="row pb-3">
                                    {{-- @include('page.general.secciones_ficha.triage') --}}
                                </div>
                            ...
                            <div class="tab-pane fade show " id="enf_tto"
                                ...
                                {{-- @include('page.general.secciones_ficha.tratamientos_enf') --}}
                            </div>
...
<script>
    ...
    function registrar_paciente() {
        ...
        let profesional_asignado = $('#profesional_asignado').val();
        let sala= $('#salas_servicio').val();
        let cama = $('#cama_atencion').val();
        let tipo_hora_medica = 'C';
        ...
        $.ajax({
            ...
            data: {
                ...
                id_profesional: profesional_asignado,
                sala: sala,
                cama: cama,
                id_lugar_atencion: id_lugar_atencion,
                id_institucion: id_institucion,
                tipo_hora_medica: tipo_hora_medica
            },
        })
            .done(function (data) {
                console.log(data);
