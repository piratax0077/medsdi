    ...
    <div class="pcoded-content m-top">
        ...
        <!-- CIERRE HEADER -->
            <div class="form-row mb-2">
                <div class="col-md-12 bg-info py-2 mt-3 rounded">
                    <h4 class="text-white f-20 mt-2 mb-2 pl-3">Servicio {{ $servicio->nombre_servicio }}</h4>
                </div>
            </div>
            <div class="form-row" id="contenedor_salas_hospital">
                <div class="col-sm-12 col-md-4 col-lg-3 col-xl-3">
                    <div class="card">
                        <div class="card-header">
                            <h6 class="text-c-blue text-uppercase">INFORMACIÓN DEL SERVICIO</h6>
                        </div>
                        <div class="card-body">
                            <div class="form-row">
                                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                    <table  class="display table-bordered table dt-responsive nowrap table-xs" style="width:100%">
                                        <tbody>
                                            <tr>
                                                <td><p><strong>Jefe del Servicio:</strong> <br> {{ $servicio->jefe_servicio->nombre }} {{ $servicio->jefe_servicio->apellido_uno }} {{ $servicio->apellido_dos }}</p></td>
                                            </tr>
                                            <tr>
                                                <td><p><strong>Total camas:</strong> <br> {{ $servicio->numero_camas }}</p></td>
                                            </tr>
                                            <tr>
                                                <td><p><strong>Camas Disponibles:</strong> <br> {{ $servicio->camas_disponibles }}</p></td>
                                            </tr>
                                            <tr>
                                                <td><p><strong>Camas Ocupadas:</strong> <br> {{ $servicio->camas_ocupadas }}</p></td>
                                            </tr>
                                            <tr>
                                                <td><p><strong>N° de Salas:</strong> <br> {{ $servicio->numero_salas }}</p></td>
                                            </tr>
                            ...
                            <!--MÉDICOS-->
                            <h6 class="text-c-blue">MÉDICOS</h6>
                            <table id="tabla_profesionales_servicios" class="display table-bordered table dt-responsive nowrap table-xs" style="width:100%">
                            ...
                            <!--ENFERMERAS-->
                            <h6 class="text-c-blue">ENFERMERAS</h6>
                            <table id="tabla_enfermeras_servicios" class="display table-bordered table dt-responsive nowrap table-xs" style="width:100%">
                                <tbody>
                            ...
                            <!--TENS-->
                            <h6 class="text-c-blue">TENS</h6>
                            <table id="tabla_tens_servicios" class="display table-bordered table dt-responsive nowrap table-xs" style="width:100%">
                                <tbody>
                                    @if (isset($servicio->tens) && count($servicio->tens) > 0)
                                        @foreach ($servicio->tens as $profesional)
                                            <tr>
                ...
                <div class="col-sm-12 col-md-8 col-lg-9 col-xl-9" id="contenedor_salas_servicio">
                    <!--TAB-->
                    <div class="row">
                        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
