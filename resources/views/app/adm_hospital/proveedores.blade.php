                    ...
                    <table id="inventario_insumos" class="display table table-striped  table-sm table-hover dt-responsive nowrap" style="width:100%">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="align-middle text-center">
                                    <span>ventas@todoguantes.cl</span>
                                </td>
                                <td class="align-middle text-center">
                                    <!--Botón Modal-->
                            ...
                            <tr>
                                ...
                                <td class="align-middle text-center">
                                    <span>+56 9 9978 3286</span><br>
                                </td>
                                <td class="align-middle text-center">
                                    <span>contacto@mpmedical.cl</span>
                                </td>
                                <td class="align-middle text-center">
                                    <!--Botón Modal-->
                                    <button type="button" class="btn btn-success btn-sm" onclick="editar_proveedor();"><i class="feather icon-edit"></i> Editar</button>
                    ...
                    <div class="row">
						...
						<div class="col-sm-12">
                            <div class="form-group fill">
                                ...
                                <input class="form-control form-control-sm" name="prov_prod" id="prov_prod" type="text">
                            </div>
                        </div>
                        <div class="col-sm-12">
                        <div class="form-group fill">
