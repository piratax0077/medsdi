...
@section('content')
    <div class="pcoded-main-container">
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <div class="page-header-title">
                                <h5 class="text-white d-inline ml-2 f-16 mt-1"><strong>Registro de atención dental
                                        infantil</strong></h5>
                                <!--Fecha del día-->
                                <button type="button"
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <ul class="nav nav-tabs profile-tabs nav-fill mt-2" id="myTab" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link text-reset active" id="atencion-paciente-tab" data-toggle="pill"
                                            href="#atencion-paciente" role="tab" aria-controls="atencion-paciente"
                                            aria-selected="true">
                                            ATENDER PACIENTE</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link text-reset" id="licencias-tab" data-toggle="pill"
                                            href="#licencias" role="tab" aria-controls="licencias" aria-selected="false">
                                            LICENCIA</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link text-reset" id="fmu-tab" data-toggle="tab" href="#fmu" role="tab"
                                            aria-controls="fmu" aria-selected="false">FMU</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link text-reset" id="atenciones-previas-tab" data-toggle="pill"
                                            href="#atencion-previas" role="tab" aria-controls="atencion-previas"
                                            aria-selected="false">
                                            ATENCIONES PREVIAS</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link text-reset" id="examenes-tab" data-toggle="tab" href="#examenes"
                                            role="tab" aria-controls="examenes" aria-selected="false">Exámenes</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link text-reset" id="presupuesto-tab" data-toggle="tab"
                                            href="#presupuesto" role="tab" aria-controls="presupuesto"
                ...
                <div class="col-md-12">
                    <div class="tab-content" id="at-dental-infantil">
                        ...
                        <div class="tab-pane fade show active" id="atencion-paciente" role="tabpanel"
                            ...
                            @include('app.dental.secciones_dentales.ficha_atencion_dental_infantil')
                        ...
                        <div class="tab-pane fade" id="atencion-previas" role="tabpanel"
                            ...
                            @include('app.dental.secciones_ficha/atenciones_previas')
                    ...
                    <div class="card-sidebar">
                        ...
                        <div id="collapse_form_dental" class="collapse" aria-labelledby="heading_form_dental"
                            ...
                            <div class="card-body-sidebar">
                                ...
                                <img src="{{ asset('img_dental/carie.png') }}"> Caries
                                <hr class="mt-1 mb-1">
                                ...
                                <img src="{{ asset('img_dental/mantenedor_espacio.png') }}"> Mantenedor de Espacio
                                <hr class="mt-1 mb-1">

                                <img src="{{ asset('img_dental/pulpotomia.png') }}"> Pulpotomía
                                <hr class="mt-1 mb-1">
                                <img src="{{ asset('img_dental/pulpectomia.png') }}"> Pulpectomía
                                <hr class="mt-1 mb-1">
        ...
        @include("app.dental.modals.infantil.anestesia")
        @include("app.dental.modals.infantil.hemorragias");
        @include("app.dental.modals.infantil.fracturas");

        <!--Modals odontograma-->
        @include("app.dental.modals.odontograma.modal_odontograma")
        @include("app.dental.modals.odontograma.modal_anestesia_local")
        @include("app.dental.modals.odontograma.modal_fractura")
        @include("app.dental.modals.odontograma.modal_hemorragia")

        <!--Ficha Dental Indicaciones-->
        @include("app.dental.modals.ficha.modal_indicar_medicamentos")
        ...
        <!--Examenes dentales-->
        @include("app.dental.modals.formularios_dentales.examenes_dentales.m_exradiologico")
        @include("app.dental.modals.formularios_dentales.examenes_dentales.m_exbiopsia")

        <!--Laboratorio Dental-->

        @include("app.dental.modals.formularios_dentales.laboratorio_dental.m_trabajo")
        @include("app.dental.modals.formularios_dentales.laboratorio_dental.m_trabajoM")
        ...
        <!--Ayudante Dental-->
        @include("app.dental.modals.formularios_dentales.ayudante_dental.modal_gastosmaterial_gen")
        @include("app.dental.modals.formularios_dentales.ayudante_dental.modal_control_trabajo")

        <!--Concentimiento Informado-->
        @include("app.dental.modals.formularios_dentales.concentimientos_informados.anestesia")
        @include("app.dental.modals.formularios_dentales.concentimientos_informados.cirugia_menor")
        ...
        @include("app.dental.modals.odontograma.tratamiento_boca_completa");
        @include("app.dental.modals.odontograma.tratamiento_maxilar_inferior");
        @include("app.dental.modals.odontograma.tratamiento_maxilar_superior");

        @include("app.dental.modals.infantil.tratamiento_boca_completainf");
        @include("app.dental.modals.infantil.tratamiento_maxilar_inferiorinf");
        @include("app.dental.modals.infantil.tratamiento_maxilar_superiorinf");
        @include("app.dental.modals.infantil.tratamiento_laboratorio");
