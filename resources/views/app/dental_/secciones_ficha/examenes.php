<div class="row">
    <div class="col-sm-6">
        <h5 class="text-c-blue mt-4 mb-1 f-16 float-left d-inline">Resultado de exámenes</h5>
    </div>
    <div class="col-sm-6 d-inline float-right">
        <!--Botón modal agregar examen-->
        <button type="button" class="btn btn-success btn-sm float-right mt-4" data-toggle="modal" data-target="#modal_adjuntar_examen"><i class="fa fa-plus"></i> Agregar Examen</button>
        <!--Cierre: Botón modal agregar examen-->
    </div>
</div>
<hr>
<div class="row">
        ...
        <div class="tab-content" id="pills-tablas_examenes">
            <div class="tab-pane fade show active" id="pills_bandeja_entrada" role="tabpanel" aria-labelledby="examenes_general_tab">
                <div class="dt-responsive table-responsive pb-4">
                    <table id="examenes-1" class="display table table-striped table-hover dt-responsive nowrap table-sm" style="width:100%">
                        <thead>
                            <tr>
            ...
            <div class="tab-pane fade show " id="pills_bandeja_rx" role="tabpanel" aria-labelledby="examenes_rx_tab">
                <div class="dt-responsive table-responsive pb-4">
                    <table id="examenes-2" class="display table table-striped table-hover dt-responsive nowrap table-sm" style="width:100%">
                    <thead>
                    <tr>
                        <th class="text-center align-middle">Fecha</th>
                        <th class="text-center align-middle">Nº de Orden</th>
            ...
            <div class="tab-pane fade" id="pills_examenes_general" role="tabpanel" aria-labelledby="examenes_general_tab">
                <div class="dt-responsive table-responsive pb-4">
                    <table id="examenes-3" class="display table table-striped table-hover dt-responsive nowrap table-sm" style="width:100%">
                        <thead>
                            <tr>
                            <th class="text-center align-middle">Fecha</th>
                            <th class="text-center align-middle">Nº de Orden</th>
