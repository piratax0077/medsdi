                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h5 class="m-b-10 font-weight-bold">Historico de Liquidaciones a Profesionales</h5>
                        </div>
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="asistente_adm.home">Profesionales</a></li>
...
@section('modales')
    @include('app.asistente_adm_cm.modales.registrar_profesional')
    @include('app.asistente_adm_cm.modales.editar_profesional')
    @include('app.asistente_adm_cm.modales.datos_banco')
    @include('app.asistente_adm_cm.modales.horario_usuario')
    @include('app.asistente_adm_cm.modales.convenio_usuario')
    @include('app.asistente_adm_cm.modales.contacto_usuario')
@endsection
