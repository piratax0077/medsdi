 <div id="registrar_administrador" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="registrar_administrador" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header bg-info">
                <h5 class="modal-title text-white text-center">Registrar Nuevo Administrador Médico</h5>
            ...
            <div class="modal-body">
                <form>
                    ...
                    <div class="row">
                        ...
                        <button type="submit" class="btn btn-info">Registrar Administrador Médico</button>
                        </form>
                    </div>
                </form>
        </div>
