 <div id="registrar_profesionalcomercial" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="registrar_profesionalcomercial" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header bg-info">
                <h5 class="modal-title text-white text-center">Registrar Ingeniero</h5>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <select class="form-control form-control-sm">
                                    ...
                                    <option>Ing. Administración</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-sm-4">
