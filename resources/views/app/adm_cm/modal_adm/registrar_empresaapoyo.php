                ...
                <form>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group fill">
                                <div class="form-group fill">
                                    <label class="floating-label-activo-sm">Rubro Comercial</label>
                                    <select class="form-control form-control-sm">
                                        <option>Seleccione  opción</option>
                                        <option value="AL">Aseo</option>
                                        <option value="LA">Mantención Oficinas</option>
                                        <option value="VA">Electricidad</option>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group fill">
                                <div class="form-group fill">
                                    <label class="floating-label-activo-sm">Servicios</label>
                                    <select class="form-control form-control-sm">
                                        <option>Seleccione  opción</option>
                                        <option value="AL">Aseo</option>
                                        <option value="LA">Mantención Oficinas</option>
