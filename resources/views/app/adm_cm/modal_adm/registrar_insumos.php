<div id="registrar_insumos" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="registrar_insumos" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header bg-info">
                <h5 class="modal-title text-white text-center">Registrar registrar_proveedores de insumos</h5>
