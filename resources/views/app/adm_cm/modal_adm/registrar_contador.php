 <div id="registrar_contador" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="registrar_contador" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header bg-info">
                <h5 class="modal-title text-white text-center">Registrar Contador</h5>
