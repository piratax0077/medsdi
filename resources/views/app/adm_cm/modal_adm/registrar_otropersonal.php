  <div id="registrar_otropersonal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="registrar_otropersonal" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header bg-info">
                        <h5 class="modal-title text-white text-center">Registrar Nuevo/a Personal</h5>
