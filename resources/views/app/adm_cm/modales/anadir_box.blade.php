<div id="a_boxes" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="a_boxes" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header bg-info">
                <h5 class="modal-title text-white text-center">Infraestructura y Boxes de Atención</h5>
