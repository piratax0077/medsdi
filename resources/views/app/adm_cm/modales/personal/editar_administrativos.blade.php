                                        ...
                                        <select class="form-control form-control-sm" name="edit_tipo_contrato_administrativo" id="edit_tipo_contrato_administrativo">
                                            ...
                                            @if ($lista_tipo_administrativo)
                                                @foreach ($lista_tipo_administrativo as $item)
                                                    <option value="{{ $item['id'] }}" data-id="{{ $item['id'] }}">{{ $item['nombres'] }}</option>
                                                @endforeach
                                            @endif
                                            {{--  asistente tipo  --}}
                                            {{--  tipo institucion  --}}
...
<script>
    ...
    function registrar_nuevo_empleado_administrativo()
    {
        var valido = 1;
        var mensaje = '';
        let id_institucion = $('#edit_id_institucion_administrativo').val();
        let id_lugar_atencion = $('#edit_id_lugar_atencion_administrativo').val();
        let id_admin_creador = $('#edit_id_admin_creador_administrativo').val();
        let id_tipo_admin_creador = $('#edit_id_tipo_admin_creador_administrativo').val();
        ...
        let apellido_uno = $('#edit_apellido_uno_administrativo').val();
        let apellido_dos = $('#edit_apellido_dos_administrativo').val();
        ...
        let locomocion = ( $('#edit_locomocion_administrativo').val() == ''?'0':$('#edit_locomocion_administrativo').val() );
        var locomocion_porcentaje = '';
        if(locomocion == 1)
            locomocion_porcentaje = $('#edit_locomocion_porcentaje_administrativo').val();
        else
            locomocion_porcentaje = '0';

        let colacion = ( $('#edit_colacion_administrativo').val() == ''?'0':$('#edit_colacion_administrativo').val() );
        var colacion_porcentaje = '';
        if(colacion == 1)
            colacion_porcentaje = $('#edit_colacion_porcentaje_administrativo').val();
        else
            colacion_porcentaje = '0';

        let asignacion_familiar = ( $('#edit_asignacion_familiar_administrativo').val() == ''?'0':$('#edit_asignacion_familiar_administrativo').val() );
        var asignacion_familiar_cantidad = '';
        if(asignacion_familiar == 1)
            asignacion_familiar_cantidad = $('#edit_asignacion_familiar_cantidad_administrativo').val();
        else
            asignacion_familiar_cantidad = '0';

        let caja_compensacion = ( $('#edit_caja_compensacion_administrativo').val() == ''?'0':$('#edit_caja_compensacion_administrativo').val() );
        var caja_compensacion_porcentaje = '';
        if(caja_compensacion == 1)
            caja_compensacion_porcentaje = $('#edit_caja_compensacion_porcentaje_administrativo').val();
        else
        ...
        let clave_ingreso = $('#edit_clave_ingreso_administrativo').val();
