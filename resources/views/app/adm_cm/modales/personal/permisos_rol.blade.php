    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header bg-info">
                ...
                <input type="hidden" id="permisos_rol_id_lugar_atencion"
                    value="{{ isset($institucion) ? $institucion->id_lugar_atencion : '' }}">
            </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-2">
                            <div class="custom-control custom-switch">
                                <input type="checkbox" class="custom-control-input permiso-asistente-check"
                                    id="pa_permiso_cotizar" data-permiso="permiso_cotizar">
                        ...
                        <div class="col-md-6 mb-2">
                            <div class="custom-control custom-switch">
                                <input type="checkbox" class="custom-control-input permiso-asistente-check"
                                    id="pa_permiso_confirmar_hora" data-permiso="permiso_confirmar_hora">
                        ...
                        <div class="col-md-6 mb-2">
                            <div class="custom-control custom-switch">
                                <input type="checkbox" class="custom-control-input permiso-asistente-check"
                                    id="pa_permiso_anular_hora" data-permiso="permiso_anular_hora">
                        ...
                        <div class="col-md-6 mb-2">
                            <div class="custom-control custom-switch">
                                <input type="checkbox" class="custom-control-input permiso-asistente-check"
                                    id="pa_permiso_subir_ver_archivos" data-permiso="permiso_subir_ver_archivos">
                        ...
                        <div class="col-md-6 mb-2">
                            <div class="custom-control custom-switch">
                                <input type="checkbox" class="custom-control-input permiso-asistente-check"
                                    id="pa_permiso_eliminar_archivos" data-permiso="permiso_eliminar_archivos">
                        ...
                        <div class="col-md-6 mb-2">
                            <div class="custom-control custom-switch">
                                <input type="checkbox" class="custom-control-input permiso-asistente-check"
                                    id="pa_permiso_editar_pacientes" data-permiso="permiso_editar_pacientes">
                        ...
                        <div class="col-md-6 mb-2">
                            <div class="custom-control custom-switch">
                                <input type="checkbox" class="custom-control-input permiso-asistente-check"
                                    id="pa_permiso_ver_pacientes" data-permiso="permiso_ver_pacientes">
                        ...
                        <div class="col-md-6 mb-2">
                            <div class="custom-control custom-switch">
                                <input type="checkbox" class="custom-control-input permiso-asistente-check"
                                    id="pa_permiso_agendar_horas_extras" data-permiso="permiso_agendar_horas_extras">
                        ...
                        <div class="col-md-6 mb-2">
                            <div class="custom-control custom-switch">
                                <input type="checkbox" class="custom-control-input permiso-asistente-check"
                                    id="pa_permiso_agendar_examenes" data-permiso="permiso_agendar_examenes">
                        ...
                        <div class="col-md-6 mb-2">
                            <div class="custom-control custom-switch">
                                <input type="checkbox" class="custom-control-input permiso-asistente-check"
                                    id="pa_permiso_transcripcion_examenes"
                                    data-permiso="permiso_transcripcion_examenes">
                        ...
                        <div class="col-md-6 mb-2">
                            <div class="custom-control custom-switch">
                                <input type="checkbox" class="custom-control-input permiso-asistente-check"
                                    id="pa_permiso_entrega_caja" data-permiso="permiso_entrega_caja">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-success btn-sm" id="permisos_rol_btn_guardar"
                    onclick="guardar_permisos_asistente_modal()" style="display:none;">
...
<script>
    ...
    function roles_permisos(id_asistente, nombre, id_lugar_atencion) {
        ...
        $.ajax({
                url: "{{ route('adm_cm.personal.asistente.get.permisos') }}",
                type: 'GET',
                data: {
            ...
            .done(function(data) {
                ...
                if (data.estado != 1) {
                    ...
                    swal({
                        title: 'Error',
                        text: data.msj || 'No se pudieron cargar los permisos.',
                        icon: 'error',
                        buttons: 'Aceptar'
                    });
            ...
            .fail(function(xhr) {
                ...
                swal({
                    title: 'Error',
                    text: xhr.responseJSON?.msj || 'No se pudieron cargar los permisos.',
                    icon: 'error',
                    buttons: 'Aceptar'
                });
    ...
    function guardar_permisos_asistente_modal() {
        ...
        if (!id_asistente || !id_lugar_atencion) {
            swal({
                title: 'Error',
                text: 'No se pudo identificar al asistente o lugar de atención.',
                icon: 'error',
                buttons: 'Aceptar'
            });
        ...
        let $btn = $('#permisos_rol_btn_guardar');
        ...
        $.ajax({
                url: "{{ route('adm_cm.personal.asistente.guardar.permisos') }}",
                type: 'POST',
                data: data
            })
            .done(function(resp) {
                ...
                if (resp.estado == 1) {
                    ...
                    swal({
                        title: 'Error',
                        text: resp.msj || 'No fue posible actualizar los permisos.',
                        icon: 'error',
                        buttons: 'Aceptar'
                    });
                }
            ...
            .always(function() {
                ...
                $btn.prop('disabled', false)
                    .html('<i class="feather icon-save"></i> Guardar permisos');
