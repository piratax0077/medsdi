                ...
                <div class="row align-items-center mt-3">
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ ROUTE('adm_cm.imagenologia') }}">Área de Rayos  {{ mb_strtoupper($institucion->nombre) }}</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        <div class="media">
                          ...
                          <div class="media-body">
                           <h4 class="text-c-blue">Rayos</h4>
                           <p>Área especializada en exámenes de rayos X y estudios radiológicos para apoyo diagnóstico médico</p>
                          </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card py-0">
                    <div class="card-body pb-2 pt-2">
                        <ul class="nav nav-tabs-aten nav-fill" id="pills-tab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link-aten text-reset active" id="prof-rx-cm-tab" data-toggle="pill" href="#prof-rx-cm" role="tab" aria-controls="prof-odonto-cm" aria-selected="true">
                                    Profesionales
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link-aten text-reset" id="ex-rx-cm-tab" data-toggle="pill" href="#ex-rx-cm" role="tab" aria-controls="ex-odonto-cm" aria-selected="false">
                                    Exámenes
                                </a>
                            </li>
                             <li class="nav-item">
                                <a class="nav-link-aten text-reset" id="proc-rx-cm-tab" data-toggle="pill" href="#proc-rx-cm" role="tab" aria-controls="proc-odonto-cm" aria-selected="false">
                                   Procedimientos
                                </a>
                            </li>
                        </ul>
        ...
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12 col-xxxl-12">
                <div class="tab-content">
                    <!--PROFESIONALES-->
                    <div class="tab-pane show active" id="prof-rx-cm" role="tabpanel" aria-labelledby="prof-rx-cm-tab">
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card">
                    ...
                    <!--EXÁMENES-->
                    <div class="tab-pane fade" id="ex-rx-cm" role="tabpanel" aria-labelledby="ex-rx-cm-tab">
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card">
                                     <div class="card-header-principal">
                     ...
                     <!--Procedimientos-->
                    <div class="tab-pane fade" id="proc-rx-cm" role="tabpanel" aria-labelledby="proc-rx-cm-tab">
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-header-principal">
