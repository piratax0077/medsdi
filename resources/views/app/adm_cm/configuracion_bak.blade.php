                                                ...
                                                <li class="nav-item">
                                                    <a class="nav-link text-reset" id="rol-permiso-adm-med-tab"
                                                        ...
                                                        aria-controls="rol-permiso-adm-med" aria-selected="false"><i
                                                            class="feather  icon-users mr-2"></i>Inscripción y manejo de
                                                        administradores</a>
                                                </li>
                                                <li class="nav-item">
                                ...
                                <div class="col-sm-12 col-md-12">
                                    <div class="card mb-1">
                                        <div class="card-body pb-2">
                                            <h4 class="f-18 mb-0 text-info py-0 d-inline">Inscripción y manejo de administradores</h4>
...
<script>
    ...
    function asignar_profesionales_area(elemento) {
    const idArea = $(elemento).data('area-id');
    const profesionales = $(elemento).data('profesionales') || [];
    console.log(profesionales);
    // Abrir modal
    $('#asociar_profesionales_area').modal('show');
    $('#id_area').val(idArea);

    // Limpiar y seleccionar profesionales
    $('#profesionales_area').val(null).trigger('change');

    if (profesionales && profesionales.length > 0) {
        $('#profesionales_area').val(profesionales).trigger('change');
    }
}
