    ...
    <div class="pcoded-content">
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h5 class="m-b-10 font-weight-bold">Escritorio comercialjajjajaja</h5>
                        </div>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ ROUTE('adm_cm.home') }}" data-toggle="tooltip" data-placement="top" title="Volver a mi escritorio"><i class="feather  icon-home"></i></a></li>
                            <li class="breadcrumb-item"><a href="#">Administración comercial123</a></li>
                        </ul>
                    </div>
                </div>
            </div>
		...
		<div class="col-sm-12">
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="card subir py-auto"style="background-color:#0cb7f2">
                        <a href="{{ ROUTE('administrador_comercial.configuracion') }}">
                            <div class="card-body text-center" style="cursor:pointer">
                                <img class="wid-20 text-center" src="{{ asset('images/iconos/panel_configuracion.svg') }}">
                    ...
                    <div class="card subir">
						...
						<a href="{{ ROUTE('adm_cm.profesionales') }}">
							<div class="card-body text-center" style="cursor:pointer">
								...
								<h5 class="mt-1 mb-0">Info profesionales Institución</h5>
							</div>
                        </a>
                    </div>
                </div>
                    ...
                    <div class="card subir">
                        <a href="{{ ROUTE('adm_cm.sueldos') }}">
                            <div class="card-body text-center" style="cursor:pointer">
                                ...
                                <h5 class="mt-1 mb-0">Info Personal del Institución</h5>
                            </div>
                        </a>
                    </div>
                </div>
