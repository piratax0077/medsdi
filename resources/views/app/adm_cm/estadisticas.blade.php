                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            @else
                            <li class="breadcrumb-item"><a href="{{ url('/') }}" data-toggle="tooltip" data-placement="top" title="Volver a mi escritorio"><i class="feather  icon-home"></i></a></li>
                            <li class="breadcrumb-item"><a href="{{ route('adm_cm.area_comercial') }}">Administración</a></li>
                            @endif
                ...
                <div class="card-header">
                    <ul class="nav nav-pills bg-white" id="finanzas" role="tablist">
                        <li class="nav-item active">
                            <a class="btn btn-outline-info btn-sm mr-1 my-1 has-ripple active" id="rendimiento_ingresos-tab" data-toggle="tab" href="#rendimiento_ingresos" role="tab" aria-controls="rendimiento_ingresos" aria-selected="false">Rendimientos e Ingresos<span></span></a>
                        </li>
                        <li class="nav-item">
    ...
    function cargarAgenda() {
        ...
        $.ajax({
            ...
            data: {
                fecha_inicio: filtros.fecha_inicio,
                fecha_fin: filtros.fecha_final,
                id_sucursal: filtros.institucion,
