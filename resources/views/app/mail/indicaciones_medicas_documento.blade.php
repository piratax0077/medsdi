...
<head>
    ...
    <title>Indicaciones de su Medico</title>
</head>
                            ...
                            <tr>
                                <td style="background-color: #f2f2f2; padding-top: 15px;" align="center">
                                    <p style="font-family: Helvetica, Arial, sans-serif; font-size: 17px; line-height: 20px; color: #424242; text-align: center;">
                                        Sr./Sra {{ $detalle['body']['NOMBRE_PACIENTE'] }}
                                    </p>
                                    <p style="font-family: Helvetica, Arial, sans-serif; font-size: 17px; line-height: 20px; color: #424242; text-align: center;">
                                        Adjunto encontrará Indicaciones enviadas por el profesional {{ $detalle['body']['NOMBRE_PROFESIONAL']}}
                                    </p>
                                    <p style="font-family: Helvetica, Arial, sans-serif; font-size: 17px; line-height: 20px; color: #424242; text-align: center;">
