			...
			<div class="col-md-12">
				<div class="card shadow border-0 pb-4 pt-3  alin-centro align-content-center">
					<div class="card-body">
						...
						<div class="row">
							<div class="col-md-6 text-center mx-auto mb-2 t-azul"><h5>Sr./Sra. {{ $nombre_cliente }}</h5></div>
						</div>
						<div class="row mt-2">
                            <div class="col-md-6 text-center mx-auto mb-2 t-azul"><h2>{{ $mensaje_resultado }}</h2></div>
						</div>
					</div>
				</div>
			</div>
