                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12 col-xxxl-12">
                                        <ul class="nav nav-tabs profile-tabs nav-fill mt-2" id="myTab" role="tablist">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link text-reset" id="recibo-caja-prof-tab" data-toggle="tab" href="#recibo-caja-prof" role="tab" aria-controls="recibo-caja-prof" aria-selected="true">Rendiciones de caja</a>
                                            </li>
                                            <li class="nav-item">
                                                                        ...
                                                                        <div class="dt-responsive table-responsive">
                                                                            <table id="" class="display table table-striped dt-responsive nowrap table-xs" style="width:100%">
                                                                                <thead>
                                                                                    <tr>
                                                                                        <th class="align-middle">Paciente</th>
                                                                                        <th class="align-middle">Monto Garantía</th>
                                                                                        <th class="align-middle">Tipo atención</th>
                                                                                        <th class="align-middle">Vencimiento</th>
                                                                                        <th class="align-middle">Días restantes</th>
                                                                                        <th class="align-middle">Estado</th>
                                                                                    </tr>
                                                                                </thead>
                                                                                <tbody>
