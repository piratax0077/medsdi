            ...
            <div class="card-body border-top iinfo_antecedentes_patologicos collapse show" id="info_antecedentes_patologicos_1">
                ...
                <form>
                    <div class="form-group row">
                        <label class="col-sm-4 col-form-label font-weight-bolder">Alérgias e
                            Intolerancias</label>
                    ...
                    <div class="form-group row">
                        <label class="col-sm-4 col-form-label font-weight-bolder">Antecedentes
                            Quirúrgicos</label>
                        <div class="col-sm-7 my-auto ml-2">
                            <ul>
                    ...
                    <div class="form-group row">
                        <label class="col-sm-4 col-form-label font-weight-bolder">Patologías
                            Crónicas</label>
                        <div class="col-sm-7 my-auto ml-2">
                            <ul>
                                <li>Diabetes</li>
                    ...
                    <div class="form-group row">
                        <label class="col-sm-4 col-form-label font-weight-bolder">Medicamentos
                            de uso Crónico</label>
                        <div class="col-sm-7 my-auto ml-2">
                            <ul>
                                <li>Aspirina</li>
                                <li>Metformina</li>
