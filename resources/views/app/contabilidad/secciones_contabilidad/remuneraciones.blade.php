...
<div class="tab-pane fade" id="pills-remuneraciones" role="tabpanel" aria-labelledby="pills-remuneraciones-tab">
                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                ...
                                <div class="row">
                                        <div class="col-md-12 mb-3">
                                        <?php
                                        include("modals_contador/registrar_remuneracion.php");
                                        include("modals_contador/registrar_remuneracion_editar.php");
                                        ?>
                                        </div>
                                </div>
                                <div class="card">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div style="overflow-x:auto;">
                                        ...
                                        <div class="col-md-12 mb-3">
                                        <?php
                                        include("modals_contador/pagar_lsociales.php");
                                        include("modals_contador/pagar_lsociales_editar.php");
                                        ?>
                                        </div>
                                </div>
                                        <table id="#" class="display table table-striped table-hover dt-responsive nowrap" style="width:99%">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div style="overflow-x:auto;">
                                        ...
                                        <div class="col-md-12 mb-3">
                                        <?php
                                        include("modals_contador/registrar_mutcajas.php");
                                        include("modals_contador/registrar_mutcajas_editar.php");
                                        ?>
                                        </div>
                                </div>
                                    <table id="#" class="display table table-striped table-hover dt-responsive nowrap" style="width:99%">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-12 mb-3">
                                        <?php
                                        include("modals_contador/finiquito.php")
                                        ?>
                                        </div>
                                    </div>
                                    <div style="overflow-x:auto;">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 mb-3">
                                            <?php
                                            include("modals_contador/finiquito_editar.php")
                                            ?>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div style="overflow-x:auto;">
                                        <table id="tab_vacaciones" class="display table table-striped table-hover dt-responsive nowrap" style="width:99%">
                                            ...
                                            <?php
                                            include("modals_contador/vac_permisos_registrar.php");
                                            include("modals_contador/vac_permisos_autorizar.php");
                                            ?>
                                        </table>
                                    </div>
                                </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-12 mb-3">
                                            <?php
                                            include("modals_contador/licencias_registrar.php");
                                            include("modals_contador/licencias_procesar.php");
                                            ?>
                                        </div>
                                    </div>
                                    <div style="overflow-x:auto;">
