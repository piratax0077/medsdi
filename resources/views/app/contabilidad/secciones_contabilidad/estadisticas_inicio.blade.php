<div class="tab-pane fade show active" id="pills-estadistica" role="tabpanel" aria-labelledby="pills-estadistica-tab">
    ...
    <div class="col-sm-12">
        <h4 class="text mt-5 mb-4" style="font-size: 1.1rem;text-align:center"> Estadísticas del Centro</h4>
		...
		<div class="row">
            ...
            <div class="col-sm-4">
                <div class="card bg-c-info order-card">
                    <div class="card-body">
                        <h6 class="text-white"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Ventas </font></font></h6>
                        <h2 class="text-white"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">1641</font></font></h2>
            ...
            <div class="col-sm-4">
                <div class="card bg-c-info order-card">
                    <div class="card-body">
                        <h6 class="text-white"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Balance Mes</font></font></h6>
                        <h2 class="text-white"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">1641</font></font></h2>
                        <p class="m-b-0"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">$ 5,032 </font></font><i class="feather icon-arrow-down m-l-10 m-r-10"></i><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">$ 1,055 </font></font><i class="feather icon-arrow-up"></i></p>
                        <i class="card-icon feather icon-radio"></i>
                    </div>
