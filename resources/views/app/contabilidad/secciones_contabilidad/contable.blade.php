<div class="tab-pane fade" id="pills-contable" role="tabpanel" aria-labelledby="pills-contable-tab">
                    ...
                    <div class="row mb-n4">
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-header bg-info">
                                    <div class="col-md-12 align-botton">
                                        <h4 class="text-white f-20 d-inline ml-4 mt-3">Libro Diario Habe</h4>
                                        <button type="button" class="btn btn-outline-light btn-sm d-inline float-right mr-4" data-toggle="modal" data-target="#registrar_venta">
                                            <i class="feather icon-plus"></i> Registrar Nuevo Gasto
                                        </button>
                                    </div>
 ...
 <?php                                        
include("modals_contador/registrar_gasto.php");
?>
