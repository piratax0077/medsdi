                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h5 class="m-b-10 font-weight-bold">Sucursales del centro médico</h5>
                        </div>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ ROUTE('adm_cm.home') }}" data-toggle="tooltip" data-placement="top" title="Volver a mi escritorio"><i class="feather       icon-home"></i></a></li>
                            <li class="breadcrumb-item"><a href="{{ ROUTE('adm_cm.surcursales') }}">Sucursales del centro médico</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-12">
                        <div class="row">
                           <div class="col-md-6 d-inline">
                                <h4 class="text-white f-20 mt-2 mb-1">Sucursales</h4>
                            </div>
                            <div class="col-md-6 d-inline">
                                <div class="float-right">
                                    <div class="btn-group mr-2">
                                        <button type="button" class="btn  btn-sm btn-outline-light" onclick="nueva_sucursal();"><i class="fa fa-plus" aria-hidden="true"></i> Agregar nueva sucursal</button>
                                        ...
                                        <div class="dropdown-menu">
                                            <button class="dropdown-item" type="button" class="btn  btn-primary" onclick="agregar_desasociar();">Desasociar o Agregar sucursal existente</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <tbody>
                            <tr>
                                <td class="align-middle text-center">
                                    <span><strong>Nombre centro médico</strong></span><br>
                                ...
                                <td class="align-middle text-center">
                                    <!--Botón Modal-->
                                    <button type="button" class="btn btn-info btn-sm btn-icon" onclick="editar_sucursal();" data-toggle="tooltip" data-placement="top" title="Configurar"><i class="feather icon-home"></i></button>
                                </td>
                                <td class="align-middle text-center">
                                    <!--Botón Modal-->
