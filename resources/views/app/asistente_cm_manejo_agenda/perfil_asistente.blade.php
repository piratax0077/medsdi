...
@section('page-script')
    ...
    <script>
        ...
        function editar_asistente_datos_personales(id) {
            ...
            let url = "{{ route('asistentecm.ma.editar_datos_personales_perfil') }}";
        ...
        function editar_asistente_datos_contacto(id) {
            ...
            let url = "{{ route('asistentecm.ma.editar_datos_contacto_perfil') }}";
        ...
        function editar_asistente_datos_residencia(id) {
            ...
            let email = $('#editar_email').val();
            let telefono_uno = $('#editar_telefono_uno').val();
            let url = "{{ route('asistentecm.ma.editar_datos_direccion_perfil') }}";
        ...
        function cargar_lista_contacto() {
            ...
            url = "{{ route('asistentecm.ma.cargar_contacto_emergencia') }}";
            $.ajax({
                    url: url,
                    type: "get",
                    data: {}
        ...
        function cargar_datos_contacto(id) {
            let id_contacto = id;
            url = "{{ route('asistentecm.ma.cargar_datos_contacto') }}";
            $.ajax({
                    url: url,
                    type: "get",
                    data: {
        ...
        function eliminar_contacto_asistente(contacto, asistente) {
            ...
            let url = "{{ route('asistentecm.ma.eliminar_contacto_asistente') }}";
        ...
        function editar_contacto_emergencia() {
            ...
            let url = "{{ route('asistentecm.ma.editar_contacto') }}";
        ...
        function buscar_contacto() {
            ...
            let url = "{{ route('asistentecm.ma.buscar_contacto') }}"
        ...
        function registrar_contacto_emergencia() {
            ...
            let url = "{{ route('asistentecm.ma.registrar_contacto_emergencia') }}";
