                        ...
                        <div class="card-body pb-0 pt-0">
                             ...
                             <div class="row mt-0">
                                ...
                                <div class="col-md-12 ">
                                    ...
                                    <ul class="nav nav-tabs profile-tabs nav-fill bg-white rounded" id="tablas_examenes" role="tablist">

                                        <li class="nav-item">

                                            <a class="nav-link active" id="" data-toggle="pill" href="#uno_nutri" role="tab" aria-controls="pills-home" aria-selected="true">Facturas</a>

                                        </li>

                                        <li class="nav-item">

                                            <a class="nav-link" id="dos_nutri_tab" data-toggle="pill" href="#dos_nutri" role="tab" aria-controls="pills-home" aria-selected="true">Análisis por item</a>

                                        </li>

                                        <li class="nav-item">

                                            <a class="nav-link" id="tres_nutri_tab" data-toggle="pill" href="#tres_nutri" role="tab" aria-controls="pills-home" aria-selected="true" onclick="dameTodosProductos()">Compras total</a>
                        ...
                        <div class="tab-pane fade show active" id="uno_nutri" role="tabpanel" aria-labelledby="uno_nutri_tab">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 mb-2 mt-3">
                                    ...
                                    <div class="btn-group float-right d-inline" role="group" aria-label="Basic example">

                                        <button class="btn btn-info btn-sm" data-toggle="modal" data-target="#modalIngresoFactura"><i class="fas fa-plus"></i> Ingresar Factura</button>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <button class="btn btn-outline-primary btn-xxs btn-block mb-2" onclick="buscarFacturasPorProveedor()"><i class="fas fa-search"></i> Buscar</button>
                                           ...
                                           <div class="row">
                                                ...
                                                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                                     ...
                                                     <div style="overflow-x:auto;">
                                                        ...
                                                        <table id="inventario_insumos" class="display table table-striped table-xs dt-responsive nowrap" style="width:100%">
                                    ...
                                    <ul class="nav nav-tabs-secciones mb-3" id="pesos" role="tablist">
                                        ...
                                        @foreach($tipos_producto as $tipo_producto)
                                            ...
                                            <li class="nav-item-secciones">
                                                ...
                                                <a class="nav-secciones text-uppercase" id="{{ $tipo_producto->nombre }}-tab" data-toggle="pill" href="#producto_{{ $tipo_producto->id }}" role="tab" aria-controls="peso_teoricoe" aria-selected="true" href="javascript:void(0)" onclick="dameProductosPorTipo({{ $tipo_producto->id }})">{{ $tipo_producto->nombre }}</a>
                                             ...
                                             <div class="col-sm-12 col-md-12 col-lg-2 col-xl-2">
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <button class="btn btn-outline-primary btn-xxs my-2 w-100" onclick="filtrarProductos(1)"><i class="fas fa-search"></i> Buscar</button>
                                            ...
                                            <div class="col-sm-12 col-md-12 col-lg-10 col-xl-10 ">
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <table class="table" id="inventario_tipo_producto_{{ $tipo_producto->id }}" class="display table table-striped  table-xs dt-responsive nowrap w-100">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                                    ...
                                                    <button class="btn btn-outline-primary btn-xxs my-2 w-100" onclick="filtrarProductos(0)"><i class="fas fa-search"></i> Buscar</button>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                                    ...
                                                    <div style="overflow-x:auto;">
                                                        ...
                                                        <table class="table" id="inventario" class="display table table-striped table-xs dt-responsive nowrap w-100">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <table class="display table table-striped table-xs dt-responsive nowrap" id="detalle_compra_producto">
