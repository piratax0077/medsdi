...
<script>
    ...
    function agregarProveedor(){
        $('#form_agregar_proveedor').removeClass('d-none').hide().fadeIn();
    }

    function cerrarProveedor(){
        $('#form_agregar_proveedor').fadeOut();
    }
    ...
    function guardarCompra(){
        ...
        if(fecha === ''){
            alert('Debe ingresar la fecha de la compra');
            return false;
        }
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if(mensaje === 'OK'){
                    ...
                    let opt = confirm('Ya existe una compra con el número de factura ingresado. ¿Desea agregar los productos a esa compra?');
                    if(opt){
                        $('#id_compra').val(response.id_compra);
                        // quitar el atributo disabled a los input dentro del div contenedor_procedimiento
                        $('#contenedor_procedimiento input').removeAttr('disabled');
    ...
    function guardarItemFactura(){
        ...
        if(codigo_interno === ''){
            alert('Debe ingresar el código interno del producto');
            return false;
        }
        ...
        if(stock_minimo === ''){
            alert('Debe ingresar el stock mínimo del producto');
            return false;
        }

        if(stock_maximo === ''){
            alert('Debe ingresar el stock máximo del producto');
            return false;
        }
        ...
        if(fecha_vencimiento === ''){
            alert('Debe ingresar la fecha de vencimiento del producto');
            return false;
        }
                ...
                <div class="row">
                    <div class="col-md-12">
                        <ul class="nav nav-pills mb-0" id="tablas_examenes" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link-wizard" id="tres_nutri_tab" data-toggle="pill" href="#tres_nutri" role="tab" aria-controls="pills-home" aria-selected="true" onclick="dameTodosProductos()">Existencia total</a>
                            </li>
