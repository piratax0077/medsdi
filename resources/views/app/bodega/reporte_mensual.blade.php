<h2>{{ $mes }} {{ $anio }}</h2>
<table class="table w-100 my-2" id="tabla_reporte_mensual_entregas">
    <thead>
        <tr>
...
<table class="table w-100 my-2" id="tabla_reporte_mensual_ingresados">
    <thead>
        <tr>
            <th scope="col">Imagen</th>
            <th scope="col">Producto</th>
...
<script>
    $(document).ready(function() {
        $('#tabla_reporte_mensual_entregas').DataTable();
        $('#tabla_reporte_mensual_ingresados').DataTable();
    });
</script>
