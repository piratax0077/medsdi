        ...
        <div class="row bg-white shadow-sm rounded mx-3 mt-4">
                                    ...
                                    @if ($solicitud_pq->tipo_cirugia == 'quirurgica')
                                        <tr>
                                            ...
                                            <td class="text-center align-middle">
                                                ...
                                                <a href="{{ ROUTE('cirugia.ingreso_paciente', $solicitud_pq->id) }}"
                                                    class="btn btn-icon btn-info" data-toggle="tooltip"
                                                    data-placement="top" title="Ingreso Paciente"><i
                                                        class="feather icon-activity"></i></a>

                                                <a href="{{ ROUTE('cirugia.protocolo_cirugia', $solicitud_pq->id) }}"
            ...
            <div class="col-md-12">
                ...
                <form id="form_solicitud_pabellon_quirurgico_dental"
                    action="{{ route('cirugia.registrar_solicitud_pabellon_quirurgico') }}" method="POST">

                    @csrf
                    <input type="hidden" name="ficha_id_quirurgico" id="ficha_id_quirurgico"
                        value=" @if ($ficha != null) {{ $ficha->id }} @endif">
                    <input type="hidden" name="paciente_quirurgico" id="paciente_quirurgico"
                        value="{{ $paciente->id }}">
                                ...
                                <div class="card-body shadow-none">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <textarea class="form-control form-control-sm" id="patologias_cronicas_pabellon" name="patologias_cronicas_pabellon"
                                                rows="1" onfocus="this.rows=3" onblur="this.rows=1;"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <textarea class="form-control form-control-sm" rows="1" onfocus="this.rows=3" onblur="this.rows=1;"
                                                name="ayudante_uno_pabellon" id="ayudante_uno_pabellon"></textarea>
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label class="floating-label-activo">Anestesistas y ayudantes de
                                                anestesia</label>
                                            <textarea class="form-control form-control-sm" rows="1" onfocus="this.rows=3" onblur="this.rows=1;"
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <textarea class="form-control form-control-sm" rows="1" onfocus="this.rows=3" onblur="this.rows=1;"
                                                ...
                                                id="equipamiento_especial_pabellon"></textarea>
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label class="floating-label-activo">Código de cirugía</label>
                                            <input type="number" class="form-control form-control-sm"
                                                name="codigo_cirugia_pabellon_1" id="codigo_cirugia_pabellon_1">
                                        </div>
                                    </div>
                                ...
                                <div class="card-body shadow-none">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-12">
                                            ...
                                            <textarea class="form-control form-control-sm" rows="2" name="comentarios_pabellon"
                                                id="comentarios_pabellon"></textarea>
                                        </div>
                                    </div>
