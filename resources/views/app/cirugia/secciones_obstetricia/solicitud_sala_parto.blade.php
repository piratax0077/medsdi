    ...
    <div class="col-md-12 py-0 px-2 shadow-none">
        ...
        <div class="row bg-white shadow-sm rounded mx-3 mt-4">
                                ...
                                @foreach ($solicitudes_pabellon_obstetrico as $solicitud_po)
                                    <tr>
                                        <td class="text-center align-middle">
                                            {{ $solicitud_po->tipo_hospitalizacion }} </td>
                                        <td class="text-center align-middle">
                                        ...
                                        <td class="text-center align-middle">
                                            ...
                                            <a href="{{ ROUTE('cirugia.ingreso_paciente_obstetrico', $solicitud_po->id) }}"
                                            ...
                                            <a href="{{ ROUTE('cirugia.protocolo_obstetrico', $solicitud_po->id) }}"
            ...
            <div class="col-md-12">
                ...
                <form id="form_solicitud_pabellon_quirurgico_parto"
                    action="{{ route('cirugia.registrar_solicitud_pabellon_parto_normal') }}" method="POST">

                    @csrf
                    {{-- <input type="hidden" name="ficha_id_quirurgico" id="ficha_id_quirurgico"
                        value=" @if ($ficha != null) {{ $ficha->id }} @endif"> --}}
                    <input type="hidden" name="paciente_parto_normal" id="paciente_parto_normal"
                        value="{{ $paciente->id }}">
                    <input type="hidden" name="tipo_cirugia" id="tipo_cirugia" value="parto_normal">
                    ...
                    <div class="row">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body shadow-none">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-4">
                                            <label class="floating-label">Matrón/a</label>
                                            <input type="text" class="form-control form-control-sm" name="matron"
                                                id="matron">
                                        </div>
                                        {{-- <div class="form-group col-md-4">
                                            <label class="floating-label">Anestesia</label>
                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-header bg-info align-middle">
                                    <h6 class="float-left d-inline">Otros comentarios</h6>
                                </div>
                                <div class="card-body shadow-none">

                                    <div class="form-row">
                                        <div class="form-group col-md-12">
                                            <label class="floating-label">Otros comentarios</label>
                                            <textarea class="form-control form-control-sm" rows="1" onfocus="this.rows=3" onblur="this.rows=1;"
