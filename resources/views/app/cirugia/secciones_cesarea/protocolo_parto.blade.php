                    ...
                    <div class="row bg-white shadow-sm rounded mx-3 mt-4">
                        <div class="col-md-12">
                            <form id="form_ingreso_paciente"
                                action="@if (isset($protocolo)) {{ route('cirugia.actualizar_protocolo_cesarea') }} @else {{ route('cirugia.registrar_protocolo_cesarea') }} @endif"
                                method="POST">
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body shadow-none">
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    @if (isset($protocolo->enfermero))
                                                        <div class="form-group col-md-4">
                                                            <label class="floating-label">Enfermero</label>
                                                            <input class="form-control form-control-sm" name="enfermero"
                                                                id="enfermero"
                                                                value="@if (isset($protocolo)) {{ $protocolo->enfermero }} @endif">
                                                        </div>
                                                    @else
                                                        <div class="form-group col-md-4">
                                                            <label class="floating-label">Enfermero</label>
                                                            <textarea class="form-control form-control-sm" rows="1" onfocus="this.rows=4" onblur="this.rows=1;" name="enfermero"
                                                                id="enfermero"></textarea>
                                                        </div>
                                                    @endif
                                            ...
                                            <div class="card-body shadow-none">
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        ...
                                                        <textarea class="form-control form-control-sm" rows="1" onfocus="this.rows=4" onblur="this.rows=1;" name="placenta"
                                                            id="placenta"></textarea>
                                                    </div>
                                                    <div class="form-group col-md-4">
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        ...
                                                        <textarea class="form-control form-control-sm" rows="1" onfocus="this.rows=4" onblur="this.rows=1;"
                                                            name="incidencias_parto" id="incidencias_parto"></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body shadow-none">
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    @if (isset($protocolo->nombre_operacion))
                                                        <div class="form-group col-md-3">
                                                            ...
                                                            <input class="form-control form-control-sm"
                                                                ...
                                                                value="@if (isset($protocolo)) {{ $protocolo->nombre_operacion }} @endif">
                                                        </div>
                                                    @else
                                                        <div class="form-group col-md-3">
                                                            <label class="floating-label">Operación</label>
                                                    ...
                                                    @if (isset($protocolo->material_hemostasia))
                                                        <div class="form-group col-md-3">
                                                            ...
                                                            <input class="form-control form-control-sm"
                                                                ...
                                                                value="@if (isset($protocolo)) {{ $protocolo->material_hemostasia }} @endif">
                                                        </div>
                                                    @else
                                                        <div class="form-group col-md-3">
                                                            <label class="floating-label">Material de hemostasia</label>
                                                    ...
                                                    @if (isset($protocolo->material_cierre))
                                                        <div class="form-group col-md-3">
                                                            ...
                                                            <input class="form-control form-control-sm"
                                                                ...
                                                                value="@if (isset($protocolo)) {{ $protocolo->material_cierre }} @endif">
                                                        </div>
                                                    @else
                                                        <div class="form-group col-md-3">
                                                            <label class="floating-label">Material de cierre</label>
                                                    ...
                                                    @if (isset($protocolo->otros_implantes))
                                                        <div class="form-group col-md-3">
                                                            ...
                                                            <input class="form-control form-control-sm"
                                                                ...
                                                                value="@if (isset($protocolo)) {{ $protocolo->otros_implantes }} @endif">
                                                        </div>
                                                    @else
                                                        <div class="form-group col-md-3">
                                                            <label class="floating-label">Otros (implantes, aseo,
                                                    ...
                                                    @if (isset($protocolo->descripcion_cirugia))
                                                        <div class="form-group col-md-12">
                                                            <input class="form-control form-control-sm"
                                                                ...
                                                                value="@if (isset($protocolo)) {{ $protocolo->descripcion_cirugia }} @endif">
                                                        </div>
                                                    @else
                                                        <div class="form-group col-md-12">
