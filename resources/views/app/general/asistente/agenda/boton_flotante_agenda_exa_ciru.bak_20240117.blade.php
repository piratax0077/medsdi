...
<div class="bs-offset-main bs-canvas-anim">
    ...
    {{-- @case(1) --}}
    <button class="btn btn-agenda btn-agenda-1 shadow-sm" style="display:none; bottom: 63%;" type="button" onclick="cargarAgendaProfesional(1, '{{ date('Y-m-d') }}');"><i class="feather icon-calendar f-22"></i> <br>Agenda <br> Consulta</button>
    {{-- @case(2) --}}
    {{--  --}}
    {{-- @case(3) --}}
    {{-- <button class="btn btn-agenda btn-agenda-3 shadow-sm" style="display:none; bottom: 37%;" type="button" onclick="cargarAgendaProfesional(3, '{{ date('Y-m-d') }}');"><i class="feather icon-calendar f-22"></i> <br>Agenda <br> Telemedicina</button> --}}
    <button class="btn btn-agenda btn-agenda-3 shadow-sm" style="display:none; bottom: 50%;" type="button" onclick="cargarAgendaProfesional(3, '{{ date('Y-m-d') }}');"><i class="feather icon-calendar f-22"></i> <br>Agenda <br> Telemedicina</button>
    {{-- @case(4) --}}
    <button class="btn btn-agenda btn-agenda-4 shadow-sm" style="display:none; bottom: 37%;" type="button" onclick="cargarAgendaProfesional(4, '{{ date('Y-m-d') }}');"><i class="feather icon-calendar f-22"></i> <br>Agenda <br> Examenes</button>
