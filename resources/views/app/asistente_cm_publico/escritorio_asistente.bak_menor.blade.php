                                            ...
                                            .done(function(data) {
                                                if (data != null) {
                                                    ...
                                                    else if(data.estado_hora == 2)//if (info.event.backgroundColor == '#94BF61')
                                                    {
                                                        ...
                                                        {
                                                            /** MENOR EDAD */
                                                            $('#modal_validacion_menor_edad').modal('show');

                                                            $('#validacion_menor_edad_id_paciente').val(data.paciente.id);
                                                            $('#validacion_menor_edad_id_paciente_user').val(data.paciente.id_usuario);
                                                            $('#validacion_menor_edad_paciente_rut').val(data.paciente.rut);
                                                            $('#validacion_menor_edad_paciente_nombre').val(data.paciente.nombres + ' ' + data.paciente.apellido_uno + ' ' + data.paciente.apellido_dos);
                                                            $('#validacion_menor_edad_paciente_edad').val(data.edad);

                                                            $('#validacion_menor_edad_id_responsable').val(data.responsable.id);
                                                            $('#validacion_menor_edad_id_responsable_user').val(data.responsable.id_usuario);
                                                            $('#validacion_menor_edad_responsable_rut').val(data.responsable.rut);
                                                            $('#validacion_menor_edad_responsable_nombre').val(data.responsable.nombres + ' ' + data.responsable.apellido_uno + ' ' + data.responsable.apellido_dos);

                                                            $('#validacion_menor_edad_id_profesional').val(data.profesional.id);
                                                            $('#validacion_menor_edad_id_profesional_id_usuario').val(data.profesional.id_usuario);
                                                            $('#validacion_menor_edad_profesional_nombre').val(data.profesional.nombre+' '+data.profesional.apellido_uno+' '+data.profesional.apellido_dos);
                                                            $('#validacion_menor_edad_profesional_rut').val( data.profesional.rut);

                                                            $('#validacion_menor_edad_hora_medica').val(info.event.id);
