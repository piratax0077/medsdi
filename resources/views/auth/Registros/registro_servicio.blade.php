...
<body>
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-sm-12 col-md-6 mx-auto py-2">
					<div class="card">
						<div class="card-to pt-2">
							<h5>Registro de servico</h5>
		                        ...
		                        <div class="tab-content">
                                        ...
                                        <form class="wizard-container" id="js-wizard-form">
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-sm-12 col-md-6">
                                                    <label class="floating-label-activo-sm">Rut del servicio</label>
                                            ...
                                            <!-- <div class="form-row">
                                                <div class="form-group col-sm-12 col-md-6">
                                                    ...
                                                    <input type="text" class="form-control form-control-sm" name="rut_responsable" id="rut_responsable">
                                                </div>
                                                <div class="form-group col-sm-12 col-md-6">
                                                    <label class="floating-label">Nombre Responsable</label>
                                                    <input type="text" class="form-control form-control-sm" name="nombre_responsable" id="nombre_responsable">
                                                </div>
                                            </div> -->
                                            <div class="form-row">
                                                <div class="form-group col-sm-12 col-md-6">
                                                    <label class="floating-label-activo-sm">Tipo de servicio</label>
                                                    <select class="form-control form-control-sm" id="id_tiposervicio" name="id_tiposervicio">
                                                        <option selected value="0">Seleccione</option>
                                                        @if (isset($tipo_servicio))
                                                            @foreach ($tipo_servicio as $t_serv)
                                                                <option value="{{ $t_serv->id }}">{{ $t_serv->nombre }}</option>
                                                            @endforeach
                                                        @endif
                                                    </select>
                                                </div>
                                    ...
                                    <div class="tab-pane" id="tab2">
                                        <form class="wizard-container" id="js-wizard-form2">
                                            <div class="form-row">
                                                <div class="col-sm-12 col-md-12 text-center mb-3">
                                                    <h5>Información del responsable del servicio</h5>
                                                </div>
                                            </div>
                                            <div class="form-group row ">
                                                <span class="alert alert-success" id="texto_verificacion" style="display: none"></span>
    ...
    <script>
        ...
        function registrar_datos()
        {
            ...
            var id_tiposervicio = $('#id_tiposervicio').val();
            ...
            // var rut = $('#rut').val();
            // var nombre = $('#nombre').val();
            // var rut_responsable = $('#rut_responsable').val();
            ...
            let url = "{{ route('home.registro_servicio') }}";
        ...
        $(document).ready(function() {
            ...
            var $validacion = $("#js-wizard-form").validate({
                ...
                messages: {
                    rut: {
                        required: "Ingrese rut institucion",
                        rut:'Revise que esté bien escrito'
                    },
                    nombre: {
                        required: "Ingrese nombre institucion",
            ...
            jQuery.validator.addMethod("id_tiposervicio", function(value, element) {
                if(value == 0)
                    return false;
                else
                     return true;
            ...
            //         var re = new RegExp(/^(\+?56)?(\s?)(2?99)(\s?)[98765432]\d{8}$/);//+565112341234
