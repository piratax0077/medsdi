...
<body>
    ...
    <script>
        ...
        function registrar_datos()
        {
            ...
            var sub_tipo_especialidad = $('#sub_tipo_especialidad').val();
            ...
            let url = "{{ route('home.registro_profesional') }}";
            ...
            $.ajax({
                    ...
                    data: {
                        ...
                        sexo_registro: sexo,
                        especialidad_registro: profesion,
                        tipo_specialidad_registro: especialidad,
                        sub_tipo_specialidad_registro: sub_tipo_especialidad,
