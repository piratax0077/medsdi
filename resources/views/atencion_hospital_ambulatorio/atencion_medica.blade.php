...
@section('head')
    @include('template.hospitalizados.include.head_urgencia')
@endsection

@section('header')
    @include('template.hospitalizados.include.header_urgencia')
@endsection
                        ...
                        <div class="col-md-12">
                            <div class="tab-content" id="at-oftalmo">
                                ...
                                <div class="tab-pane fade show active" id="atender" role="tabpanel" aria-labelledby="atender-tab">
                                    @include('general.secciones_ficha.ficha_urgencia')
                                </div>
