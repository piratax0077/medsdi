    ...
    <body>
        <div class="contenido">
            ...
            <p>Dirigido a: {{ $cuerpo['detalle_uso_personal']['dirigido'] }}</p>
            @if(isset($cuerpo['detalle_uso_personal']['cargo']))
            <p>Cargo: {{ $cuerpo['detalle_uso_personal']['cargo'] }}</p>
            @endif
            <p>{{ $cuerpo['detalle_uso_personal']['mensaje'] }}</p>
