                    ...
                    <div class="form-row">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group fill">
                                ...
                                <input type="text" name="zona_1" id="" type="text" class="form-control form-control-sm">
                            </div>
                        </div>
						<div class="col-sm-2">
                            <div class="form-group fill">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group fill">
                                ...
                                <input type="text" name="zona_2" id="zona_2" type="text" class="form-control form-control-sm">
                            </div>
                        </div>
						<div class="col-sm-2">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group fill">
                                ...
                                <input type="text" name="zona_3" id="zona_3" type="text" class="form-control form-control-sm">
                            </div>
                        </div>
						<div class="col-sm-2">
                            <div class="form-group fill">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group fill">
                                ...
                                <input type="text" name="zona_4" id="zona_4" type="text" class="form-control form-control-sm">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group fill">
                                <label class="floating-label">Patólogo o Laboratorio</label>
                                <input type="text" name="biop_patologo" id="biop_patologo" type="text" class="form-control form-control-sm">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group fill">
                                <label class="floating-label">Observaciones</label>
                                <textarea class="form-control caja-texto form-control-sm mt-1" rows="1"  onfocus="this.rows=3" onblur="this.rows=1;" name="obs_biopsia_go" id="obs_biopsia_go"></textarea>
                            </div>
                        </div>
                        <div class="col-sm-12">
