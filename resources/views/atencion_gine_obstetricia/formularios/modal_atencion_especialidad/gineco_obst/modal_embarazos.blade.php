        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row pt-2 mb-3">
                    <div class="col-md-12">
                        <h6 id="ant_6" onclick="abrir_div('modal_ant_emb');" class="text-primary" style="cursor: pointer;">Añadir nuevo antecedente <i class="fas fa-plus-circle text-primary"></i></h6>
                    </div>
                </div>
                <div class="row py-2" id="modal_ant_emb" style="display:none;">
                    <form>
                        <div class="col-md-12">
                            <div class="form-row">
                            ...
                            <div class="form-group col-sm-12 col-md-3 col-lg-3 col-xl-3">
                                <label class="floating-label-activo-sm"for="tipo_parto" >Tipo de parto</label>
                                <input type="text" class="form-control form-control-sm" name="tipo_parto" id="tipo_parto">
                            </div>
                            <div class="form-group col-sm-12 col-md-3 col-lg-3 col-xl-3">
                                <label class="floating-label-activo-sm" for="puerperio">Puerperio</label>
                                <input type="text" class="form-control form-control-sm" name="puerperio" id="puerperio">
                            </div>
                            <div class="form-group col-sm-12 col-md-3 col-lg-3 col-xl-3">
                                <label class="floating-label-activo-sm" for="recien_nacido">Recién nacido</label>
...
<script>
    $abrir_div('formulario_6').click(function() {
        $('#embarazos_modal').toggle();
    });
</script>
