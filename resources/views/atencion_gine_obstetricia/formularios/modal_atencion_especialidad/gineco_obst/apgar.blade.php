        ...
        <div class="modal-content">
            ...
            <div class="modal-body"id="mc3k">
                ...
                <div id="calc_disclaimer" <center>
                    <table style="background-color: rgb(199, 216, 200)"  summary="EBMcalc Table">
                        <tbody>
                            <tr>
                               <td><center><span style="margin: 10px">
                                <p>
                                    <u>Avisos legales y exención de responsabilidad</u>
                                </p>
                                    <p>Este es solo referencial el examen y puntuación del Apgar debe ser revisado y aplicado con los criterios médicos correspondientes y por un profesional de la salud.
                                    </p>
                                </td>
                            </tr>
                        </tbody>
