@extends('template.bienvenida.instituciones')
				...
				<div class="row align-items-center pb-2">
					<div class="col-md-6">
						<div class="page-header-title">
							<h5 class="text-white d-inline f-16 mt-1"><strong>SDI le da la Bienvenida a Institución nueva</strong></h5>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="tab-content" id="at-oftalmo">
					...
					@include('bienvenida.instituciones')
					</div>
