                ...
                <div class="row bg-white shadow-sm rounded mx-3 mt-4">
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-12 mt-3 mb-0">
                                <h6 class="f-16 text-c-blue"> <div class="page-header-title">
                                    <h5 class="m-b-10 font-weight-bold">Escritorio Configuración Institución Nueva</h5>
                                </div></h6>
                                <hr>
                            </div>
                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="card-deck">
                                    <div class="card subir">
                                        <a onclick="b_lugar();" class="btn" type="button">
                                    ...
                                    <div class="card subir">
                                        {{-- <a href="{{ ROUTE('paciente.receta') }}">--}}
                                            <a onclick="b_horario();" class="btn" type="button">
                                            <div class="card-body text-center" style="cursor:pointer">
                                                <img class="wid-60 text-center" src="{{ asset('images/iconos/reloj_1.svg') }}">
                                                <h5 class="mt-1"> Paso 2</h5><br> <h6>Configurar Horario de Atención </h6>
                                            </div>
                                        </a>
                                    </div>
                                    <div class="card subir">
                                    ...
                                    <div class="card subir">
                                        {{-- <a href="{{ ROUTE('paciente.receta') }}">--}}
                                            ...
                                            <div class="card-body text-center" style="cursor:pointer">
                                                <img class="wid-60 text-center" src="{{ asset('images/iconos/usuario_cm.svg') }}">
                                                <h5 class="mt-1"> Paso 4</h5><br> <h6>Configure el Perfíl de su Institución </h6>
                                            </div>
                                        </a>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <button class="btn btn-primary btn-sm mb-3">Acceda a su Escritorio</button>
                            </div>
                        </div>
