                                                        ...
                                                        <form>
                                                            <div class="form-row">
                                                                <div class="form-group col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                                                    ...
                                                                    <select name="motivo_cons" id="motivo_cons" data-titulo="sintoma principal" class="form-control form-control-sm" onchange="evaluar_para_carga_detalle('motivo_cons','div_det_motivo','obs_detalle_otro_sint',5)">
                                                                ...
                                                                <div class="col-md-12" id="div_det_motivo" style="display:none">
                                                                    <div class="form-group">
                                                                        <label class="floating-label-activo-sm">Describa otro signo o síntoma</label>
                                                                        <textarea class="form-control caja-texto form-control-sm" data-titulo="Obs. Sintoma" rows="1"  onfocus="this.rows=3" onblur="this.rows=1;" name="obs_detalle_otro_sint" id="obs_detalle_otro_sint"></textarea>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group col-sm-12 col-md-8 col-lg-8 col-xl-8">
                                                                    <label class="floating-label-activo-sm">Motivo de consulta</label>
                                                                    <input type="text" class="form-control form-control-sm" name="descripcion_consulta_cir_ped" id="descripcion_consulta_cir_ped">
                                                                </div>
                                                                ...
                                                                <div class="form-group col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                                                    ...
                                                                    <textarea class="form-control caja-texto form-control-sm"  rows="1"  onfocus="this.rows=3" onblur="this.rows=1;" name="antec_especialidad_gen_cig" id="antec_especialidad_gen_cig"></textarea>
                                                                </div>
                                                            </div>
                                                        </form>
                                                    </div>
                                                ...
                                                <form>
                                                    <div class="form-row">
                                                        ...
                                                        <div class="form-group col-md-4">
                                                            ...
                                                            <input type="text" class="form-control form-control-sm" data-input_igual="lic_descripcion_cie" name="descripcion_cie_esp" id="descripcion_cie_esp" value="{{ $fichaAtencion->diagnostico_ce10 }}" onchange="cargarIgual('descripcion_cie_esp,descripcion_cie_esp_trauma,descripcion_cie_esp_quem')">
                                                            <input type="hidden" class="form-control form-control-sm" data-input_igual="lic_descripcion_cie" name="id_descripcion_cie_esp" id="id_descripcion_cie_esp" value="{{ $fichaAtencion->diagnostico_ce10 }}" onchange="cargarIgual('id_descripcion_cie_esp,id_descripcion_cie_esp_trauma,id_descripcion_cie_esp_quem')">
                                                        </div>
                                                    </div>
                                                </form>
                                            </div>
                                                    ...
                                                    <div class="card-body-aten-a shadow-none">
                                                        <div class="form-row">
                                                            <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                                                <div class="form-group">
                                                                    <label class="floating-label-activo-sm">Síntoma Principal de Consulta</label>
                                                                    <select name="motivo_cons" id="motivo_cons" data-titulo="sintoma principal" class="form-control form-control-sm" onchange="evaluar_para_carga_detalle('motivo_cons','div_det_motivo','obs_detalle_otro',5)">
                                                                        <option value="0">Seleccione Síntoma</option>
                                                                        <option value="1">Dolor</option>
                                                                        <option value="2">Deformidad</option>
                                                                        <option value="3">Alteración funcional</option>
                                                                ...
                                                                <div class="form-group" id="div_det_motivo" style="display:none">
                                                                    <label class="floating-label-activo-sm">Describa Otro Signo o Síntoma</label>
                                                                    <textarea class="form-control caja-texto form-control-sm" data-titulo="Obs. Sintoma" rows="1"  onfocus="this.rows=3" onblur="this.rows=1;" name="obs_detalle_otro" id="obs_detalle_otro"></textarea>
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-12 col-md-8 col-lg-8 col-xl-8">
                                                                <div class="form-group">
                                                                    <label class="floating-label-activo-sm">Motivo de consulta</label>
                                                                    <input type="text" class="form-control form-control-sm" name="descripcion_consulta_trau_ped" id="descripcion_consulta_trau_ped">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-row">
                                                            <div class="form-group col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                                                <label class="floating-label-activo-sm">Antecedentes cirugías especialidad</label>
                                                                <textarea class="form-control caja-texto form-control-sm"  rows="1"  onfocus="this.rows=3" onblur="this.rows=1;" name="antec_especialidad_cig_tra" id="antec_especialidad_cig_tra"></textarea>
                                                            </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                                                    <ul class="nav nav-tabs-aten nav-fill mb-3" id="ev-crec_des_trauma" role="tablist">
                                                                        <li class="nav-item">
                                                                            <a class="nav-link-aten text-reset" id="crec-traumato-des-tab" data-toggle="tab" href="#crec-traumato-des" role="tab" aria-controls="crec-traumato-des" aria-selected="true">Crecimiento y desarrollo</a>
                                                                        </li>
                                                                        <li class="nav-item">
                                                                            <a class="nav-link-aten text-reset active" id="e-segment-traumato-tab" data-toggle="tab" href="#e-segment-traumato" role="tab" aria-controls="e-segment-traumato" aria-selected="false">Examen físico</a>
                                                                        </li>
                                                                        <li class="nav-item">
                                                                        ...
                                                                        <li class="nav-item">
                                                                            <a class="nav-link-aten text-reset" id="in-hosp-traumato_infantil-tab" data-toggle="tab" href="#in-hosp-traumato_infantil" role="tab" aria-control="in-hosp-traumato_infantil" aria-selected="false">Hospitalizar</a>
                                                                        </li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                                                    <div class="tab-content" id="ev-crec_des_trauma">
                                                                        ...
                                                                        <div class="tab-pane fade show" id="crec-traumato-des" role="tabpanel" aria-labelledby="crec-traumato-des-tab">
                                                                            <div class="row">
                                                                                <div class="col-sm-12 col-md-2">
                                                                                    <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                                                                      <button class="btn nav-link-aten-b active" id="et-rn-tab" data-toggle="pill" data-target="#et-rn" type="button" role="tab" aria-controls="et-rn" aria-selected="true">Recien nacido</button>
                                                                                      <button class="btn nav-link-aten-b" id="etuno-tab" data-toggle="pill" data-target="#etuno" type="button" role="tab" aria-controls="etuno" aria-selected="false">1 mes</button>
                                                                                      <button class="btn nav-link-aten-b" id="etdos-tab" data-toggle="pill" data-target="#etdos" type="button" role="tab" aria-controls="etdos" aria-selected="false">2 a 5 meses</button>
                                                                                      <button class="btn nav-link-aten-b" id="etseis-tab" data-toggle="pill" data-target="#etseis" type="button" role="tab" aria-controls="etseis" aria-selected="false">6 a 11 meses</button>
                                                                                      <button class="btn nav-link-aten-b" id="etdoce-tab" data-toggle="pill" data-target="#etdoce" type="button" role="tab" aria-controls="etdoce" aria-selected="false">12 a 23 meses</button>
                                                                                      <button class="btn nav-link-aten-b" id="etdosa-tab" data-toggle="pill" data-target="#etdosa" type="button" role="tab" aria-controls="etdosa" aria-selected="false">2 a 4 años</button>
                                                                                      <button class="btn nav-link-aten-b" id="etseisa-tab" data-toggle="pill" data-target="#etseisa" type="button" role="tab" aria-controls="etseisa" aria-selected="false">6 a 9 años</button>
                                                                                    </div>
                                                                                </div>
                                                                        ...
                                                                        <!--EXAMEN FISICO-->
                                                                        <div class="tab-pane fade show active"  id="e-segment-traumato" role="tabpanel" aria-labelledby="e-segment-traumato-tab">
                                                                            <div class="row">
                                                                                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                                                        ...
                                                                        <!--HOSPITALIZACION-->
                                                                        @php
                                                                            $seccion_tipo = 'traumato_infantil';
                                                                        @endphp
                                                                        @include('general.hospitalizacion.hospitalizar')
                                                    ...
                                                    <div class="card-body-aten-a shadow-none">
                                                        <form>
                                                            <div class="form-row">
                                                                <div class="form-group col-md-4">
                                                                    <label class="floating-label-activo-sm">Hipótesis diagnóstica</label>
                                                                    <input type="text" class="form-control form-control-sm"  data-input_igual="lic_descripcion_hipotesis,hip-diag_spec_trauma;hip-diag_spec_quem" name="hip-diag_spec_trauma" id="hip-diag_spec_trauma" onchange="cargarIgual('hip-diag_spec')" >
                                                                </div>
                                                                <div class="form-group col-md-4">
                                                                    <label class="floating-label-activo-sm">Indicaciones</label>
                                                                    <input type="text" class="form-control form-control-sm" name="ind_esp_cirugia" id="ind_esp_cirugia">
                                                                ...
                                                                <div class="form-group col-md-4">
                                                                    <label class="floating-label-activo-sm">Diagnóstico CIE-10</label>
                                                                    <input type="text" class="form-control form-control-sm" data-input_igual="lic_descripcion_cie_esp_trauma" name="descripcion_cie_esp_trauma" id="descripcion_cie_esp_trauma" value="{{ $fichaAtencion->diagnostico_ce10 }}" onchange="cargarIgual('descripcion_cie_esp_trauma')">
                                                                    <input type="hidden" class="form-control form-control-sm" data-input_igual="lic_id_descripcion_cie_esp_trauma" name="id_descripcion_cie_esp_trauma" id="id_descripcion_cie_esp_trauma" value="{{ $fichaAtencion->diagnostico_ce10 }}" onchange="cargarIgual('id_descripcion_cie_esp_trauma')">
                                                                </div>
                                                            </div>
                                                        </form>
                                                    </div>
                                                ...
                                                <div id="form-cir_control_cir_ped">
                                                    <div class="form-row">
                                                        ...
                                                        <!-- MASAS PALPABLES -->
                                                         ...
                                                         <div class="form-group col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                                            <label class="floating-label-activo-sm">Inmovilizaciones</label>
                                                            <textarea class="form-control caja-texto form-control-sm" data-titulo="masas_cda" rows="1"  onfocus="this.rows=3" onblur="this.rows=1;" name="masas_cpq_cg" id="masas_cpq_cg"></textarea>
                                                        </div>
                        ...
                        <div class="tab-pane fade show " id="atencion_quemados_gen" role="tabpanel" aria-labelledby="atencion_quemados_gen-tab">
                            <div class="row">
                                                    ...
                                                    <div class="card-body-aten-a shadow-none">
                                                        <div class="form-row">
                                                            <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                                                <div class="form-group">
                                                                    <label class="floating-label-activo-sm">Síntoma principal de consulta</label>
                                                                    <select name="motivo_quem_cons" id="motivo_quem_cons" data-titulo="sintoma principal" class="form-control form-control-sm" onchange="evaluar_para_carga_detalle('motivo_quem_cons','div_det_motivo_quem','obs_detalle_otro_quem',4)">
                                                                ...
                                                                <div class="form-group" id="div_det_motivo_quem" style="display:none">
                                                                    <label class="floating-label-activo-sm">Describa otro signo o síntoma</label>
                                                                    <textarea class="form-control caja-texto form-control-sm" data-titulo="Obs. Sintoma" rows="1"  onfocus="this.rows=3" onblur="this.rows=1;" name="obs_detalle_otro_quem" id="obs_detalle_otro_quem"></textarea>
                                                                </div>
                                                            </div>
                                                            <div class="form-group col-sm-12 col-md-8 col-lg-8 col-xl-8">
                                                                <label class="floating-label-activo-sm">Motivo de consulta</label>
                                                                <input type="text" class="form-control form-control-sm" name="descripcion_consula_cir_quem_ped" id="descripcion_consula_cir_quem_ped">
                                                            </div>
                                                        </div>
                                                        <div class="form-row">
                                                            <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                                                <div class="form-group">
                                                                    <label class="floating-label-activo-sm">Antecedentes cirugías especialidad</label>
                                                                    <textarea class="form-control caja-texto form-control-sm"  rows="1"  onfocus="this.rows=3" onblur="this.rows=1;" name="antec_especialidad_cir_quem" id="antec_especialidad_cir_quem"></textarea>
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                                                <div class="form-group">
                                                                    <label class="floating-label-activo-sm">Antecedentes generales especialidad</label>
                                                                    <textarea class="form-control caja-texto form-control-sm"  rows="1"  onfocus="this.rows=3" onblur="this.rows=1;" name="antec_especialidad_gen_cir" id="antec_especialidad_gen_cir"></textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                                                    <ul class="nav nav-tabs-aten nav-fill mb-3" id="ev-quemados" role="tablist">
                                                                        ...
                                                                        <li class="nav-item">
                                                                            <a class="nav-link-aten text-reset" id="in-hosp-quemado_infantil-tab" data-toggle="tab" href="#in-hosp-quemado_infantil" role="tab" aria-control="in-hosp-quemado_infantil" aria-selected="false">Hospitalizar</a>
                                                                        </li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="card-body-aten-a shadow-none">
                                                        <form>
                                                            <div class="form-row">
                                                                <div class="form-group col-md-4">
                                                                    <label class="floating-label-activo-sm">Hipótesis diagnóstica</label>
                                                                    <input type="text" class="form-control form-control-sm"  data-input_igual="lic_descripcion_hipotesis" name="hip-diag_spec_quem" id="hip-diag_spec_quem" onchange="cargarIgual('hip-diag_spec')" >
                                                                </div>
                                                                <div class="form-group col-md-4">
                                                                    <label class="floating-label-activo-sm">Indicaciones</label>
                                                                    <input type="text" class="form-control form-control-sm" name="ind_esp_cirugia_quem" id="ind_esp_cirugia_quem">
                                                                </div>
                                                                <div class="form-group col-md-4">
                                                                    <label class="floating-label-activo-sm">Diagnóstico CIE-10</label>
                                                                    <input type="text" class="form-control form-control-sm" data-input_igual="lic_descripcion_cie_esp_quem" name="descripcion_cie_esp_quem" id="descripcion_cie_esp_quem" value="{{ $fichaAtencion->diagnostico_ce10 }}" onchange="cargarIgual('descripcion_cie_esp_quem')">
                                                                    <input type="hidden" class="form-control form-control-sm" data-input_igual="lic_id_descripcion_cie_esp_quem" name="id_descripcion_cie_esp_quem" id="id_descripcion_cie_esp_quem" value="{{ $fichaAtencion->diagnostico_ce10 }}" onchange="cargarIgual('id_descripcion_cie_esp_quem')">
                                                                </div>
                                                            </div>
                                                        </form>
                                                    </div>
                                ...
                                <div class="col-sm-12 col-md-12">
                                    <div class="card-a">
                                        <div class="card-header-a" id="Control_cirugia">
                                            <button class="accor-closed btn pt-1 pb-0 pl-1 btn-block text-left card-act-open collapsed" type="button" data-toggle="collapse" data-target="#cirugia_general_pc" aria-expanded="false" aria-controls="cirugia_general_pc">
                                                Control post quirúrgico
                                            </button>
                                        </div>
                                        <div id="cirugia_general_pc" class="collapse" aria-labelledby="cirugia_general" data-parent="#Control_cirugia">
                                            <div class="card-body-aten-a shadow-none">
                                                <div id="form-cir_control_cir_ped">
                                                    <div class="form-row">
                                                        ...
                                                        <div class="form-group col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                                            <label class="floating-label-activo-sm">Estado general</label>
                                                            <textarea class="form-control caja-texto form-control-sm" data-titulo="Estado General" rows="1"  onfocus="this.rows=3" onblur="this.rows=1;" name="eg_cpq_quem" id="eg_cpq_quem"></textarea>
                                                        </div>

                                                        <!-- Herida Operatoria Curación -->
                                                        <div class="form-group col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                                            <label class="floating-label-activo-sm">Herida operatoria curación</label>
                                                            <textarea class="form-control caja-texto form-control-sm" data-titulo="ceg_cda" rows="1"  onfocus="this.rows=3" onblur="this.rows=1;" name="hoc_cpa_quem" id="hoc_cpa_quem"></textarea>
                                                        </div>

                                                        <!-- Masas Palpables -->
                                                        <div class="form-group col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                                            <label class="floating-label-activo-sm">Masas palpables</label>
                                                            <textarea class="form-control caja-texto form-control-sm" data-titulo="masas_cda" rows="1"  onfocus="this.rows=3" onblur="this.rows=1;" name="masas_cpq_quem" id="masas_cpq_quem"></textarea>
                                                        </div>
                                                        <div class="form-group col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                                            <label class="floating-label-activo-sm">Estado de injertos</label>
                                                            <textarea class="form-control caja-texto form-control-sm" data-titulo="masas_cda" rows="1"  onfocus="this.rows=3" onblur="this.rows=1;" name="masas_cpq_quem" id="masas_cpq_quem"></textarea>
                                                        </div>
                                                    </div>
                                                    <!-- Observaciones Estado General Paciente -->
                                                    <div class="form-row">
                                                        <div class="form-group col-md-12 col-lg-12 col-xl-12">
                                                            <label class="floating-label-activo-sm">Observaciones estado general paciente</label>
                                                            <textarea class="form-control caja-texto form-control-sm" data-titulo="Observaciones Estado general" rows="1"  onfocus="this.rows=2" onblur="this.rows=1;" name="obs_egp_cpq_quem" id="obs_egp_cpq_quem"></textarea>
                                                        </div>
                                                    </div>
...
@section('page-script-ficha-atencion')
    <script>
        $(document).ready(function() {
            ...
            $('#hip-diag_spec_trauma').keyup(function(){
                if($.trim(this.value) != ''){
                    $('.btn_agregar_medicamento').removeAttr("disabled");
                    $('.btn_medicamento_pdf').removeAttr("disabled");
                    $('.btn_agregar_examen').removeAttr("disabled");
            ...
            $('#hip-diag_spec_quem').keyup(function(){
                if($.trim(this.value) != ''){
                    $('.btn_agregar_medicamento').removeAttr("disabled");
                    $('.btn_medicamento_pdf').removeAttr("disabled");
                    $('.btn_agregar_examen').removeAttr("disabled");
            ...
            $("#descripcion_cie_esp_trauma").autocomplete({
                source: function(request, response) {
                    // Fetch data
                    $.ajax({
                        url: "{{ route('dental.getCie10') }}",
                ...
                select: function(event, ui) {
                    // Set selection
                    $('#descripcion_cie_esp_trauma').val(ui.item.label); // display the selected text
                    $('#id_descripcion_cie_esp_trauma').val(ui.item.value); // save selected id to input
                    return false;
                }
            });
            $("#descripcion_cie_esp_quem").autocomplete({
                source: function(request, response) {
                    // Fetch data
                    $.ajax({
                        url: "{{ route('dental.getCie10') }}",
                ...
                select: function(event, ui) {
                    // Set selection
                    $('#descripcion_cie_esp_quem').val(ui.item.label); // display the selected text
                    $('#id_descripcion_cie_esp_quem').val(ui.item.value); // save selected id to input
                    return false;
                }
            });
