                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-sm-12 col-md-2">
                                                ...
                                                <div class="form-group" id="div_p_07_p_ant_pat" style="display:none">
                                                    <label class="floating-label-activo-sm">Ant. heredo-fam. Pat.</label>
                                                    <textarea class="form-control form-control-sm"  data-titulo="Antec_pat" rows="1"  onfocus="this.rows=3" onblur="this.rows=1;" name="obs_p_07_p_ant_pat" id="obs_p_07_p_ant_pat"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <hr>
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="col-sm-12 col-md-4">
                                                        <div class="form-group" style="text-align:center">
                                                            <button type="button" class="btn btn-outline-primary" style="line-height:10px " onclick="abrir_modal_guardar_tipo();"><i class="me-2" data-feather="thumbs-up"></i>Guardar Nuevo Examen Tipo<span class="ripple ripple-animate" style="height: 99.2656px; width: 99.2656px; animation-duration: 0.7s; animation-timing-function: linear; background: rgb(255, 255, 255); opacity: 0.4; top: -36.7969px; left: 15.625px;"></span></button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div id="motivo_c611" class="collapse" aria-labelledby="motivo611" data-parent="#motivo611">
                                    <div class="card-body-aten shadow-none">
                                        ...
                                        <div class="form-row">
                                            <div class="col-sm-12 col-md-4">
                                                ...
                                                <div class="form-group" id="div_p611_p_edim" style="display:none">
                                                    <label class="floating-label-activo-sm">Test de Edimburgo</label>
                                                    <textarea class="form-control caja-texto form-control-sm" data-titulo="Edimburgo" rows="1"  onfocus="this.rows=3" onblur="this.rows=1;" name="obs_p611_p_edim" id="obs_p611_p_edim"></textarea>
                                                </div>
                                            </div>
                                            <div class="col-sm-12 col-md-4">
                                                <div class="form-group">
                                                    <button type="button" class="btn btn-info btn-block btn-sm" onclick="prev_acc();">Pauta Prevensión Accidentes</button>
                                                </div>
                                            </div>
                                            <div class="col-sm-12 col-md-4">
                                                <div class="form-group" id="div_p611_p_otros" >
                                                    <label class="floating-label-activo-sm">Otros</label>
                                                    <textarea class="form-control caja-texto form-control-sm"  rows="1"  onfocus="this.rows=2" onblur="this.rows=1;" name="otr_p611_p_otro" id="otr_p611_p_otro"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-row">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-4">
                                                <label class="floating-label">Otros (lesiones)</label>
                                                <textarea class="form-control form-control-sm"  rows="1" onfocus="this.rows=2" onblur="this.rows=1;" id="otros_font_611" name="otros_font_611"></textarea>
                                            </div>
                                            <div class="form-group col-md-12">
                                                <label class="floating-label">Señales de maltrato</label>
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-4">
                                                <label class="floating-label">General</label>
                                                <textarea class="form-control form-control-sm" rows="1" onfocus="this.rows=2" onblur="this.rows=1;" name="dg_gen_611" id="dg_gen_611"></textarea>
                                            </div>
                                            <div class="form-group col-md-4">
                                                <label class="floating-label">Incremento ponderal</label>
                                                <textarea class="form-control form-control-sm" rows="1" onfocus="this.rows=2" onblur="this.rows=1;" name="inc_pon_611" id="inc_pon_611"></textarea>
                                            </div>
                                            <div class="form-group col-md-4">
                                                <label class="floating-label">Lactancia</label>
                                                <textarea class="form-control form-control-sm" rows="1" onfocus="this.rows=2" onblur="this.rows=1;" name="dg_nutricional_611" id="dg_nutricional_611"></textarea>
                                            </div>
                                            <div class="form-group col-md-4">
                                                <label class="floating-label">Salud del lactante</label>
                                                <textarea class="form-control form-control-sm" rows="1" onfocus="this.rows=2" onblur="this.rows=1;" name="dg_sal_lact_611" id="dg_sal_lact_611"></textarea>
                                            </div>
                                            <div class="form-group col-md-4">
                                                <label class="floating-label">Otros</label>
                                                    <textarea class="form-control form-control-sm" rows="1" onfocus="this.rows=2" onblur="this.rows=1;" name="dg_otros_611" id="dg_otros_611"></textarea>
                                            </div>
                                            <div class="form-group col-md-4">
                                                <label class="floating-label">Salud psicosocial</label>
                                                    <textarea class="form-control form-control-sm" rows="1" onfocus="this.rows=2" onblur="this.rows=1;" name="dg_sal_sicosocial_611" id="dg_sal_sicosocial_611"></textarea>
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            <div class="col-sm-12 col-md-12">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-6">
                                                <label class="floating-label">Indicaciones</label>
                                                <textarea class="form-control form-control-sm" rows="1" onfocus="this.rows=4" onblur="this.rows=1;" name="p_611_ind" id="p_611_ind"></textarea>
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            <div class="form-group col-md-12">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-row">
                                                    <div class="form-group col-md-12">
                                                        ...
                                                        <textarea class="form-control form-control-sm"  rows="1" onfocus="this.rows=2" onblur="this.rows=1;" id="anamnesis_1223"" name="anamnesis" ></textarea>
                                                    </div>
                                                    <div class="form-group col-md-4">
                                                        <label class="floating-label">Evaluaciones indicaciones anteriores</label>
                                                        <textarea class="form-control form-control-sm"  rows="1" onfocus="this.rows=2" onblur="this.rows=1;" id="ev_anter_1223" name="ev_anter_1223" ></textarea>
                                                    </div>
                                                    <div class="form-group col-md-4">
                                                        <label class="floating-label">Dieta</label>
                                                        <textarea class="form-control form-control-sm"  rows="1" onfocus="this.rows=2" onblur="this.rows=1;" id="dieta_1223" name="dieta_1223" ></textarea>
                                                    </div>
                                                    <div class="form-group col-md-4">
                                                        <label class="floating-label">Hábitos</label>
                                                        <textarea class="form-control form-control-sm"  rows="1" onfocus="this.rows=2" onblur="this.rows=1;" id="habitos_1223" name="habitos_1223" ></textarea>
                                                    </div>
                                                    <div class="form-group col-md-4">
                                                        <label class="floating-label">Rutinas de sueño alimentación</label>
                                                        <textarea class="form-control form-control-sm"  rows="1" onfocus="this.rows=2" onblur="this.rows=1;" id="sueno_alim_1223" name="sueno_alim_1223" ></textarea>
                                                    </div>
                                                    <div class="col-sm-12 col-md-4">
                                                        <div class="form-group">
                                                            <button type="button" class="btn btn-info btn-block btn-sm" onclick="prev_acc();">Pauta Prevensión Accidentes</button>
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        ...
                                                        <textarea class="form-control form-control-sm"  rows="1" onfocus="this.rows=2" onblur="this.rows=1;" id="cuidadores_1223" name="cuidadores_1223" ></textarea>
                                                    </div>
                                                </div>
                                                <div class="form-row">
                                                    <div class="col-md-12">
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-12">
                                                        <label class="floating-label">Inspección general y relación parental</label>
                                                        <textarea class="form-control form-control-sm" rows="1" onfocus="" onblur="this.rows=1;" id="insp_1223_gral" name="insp_1223_gral" ></textarea>
                                                    </div>
                                                </div>
                                                <div class="form-row">
                                                    <div class="col-sm-12 col-md-2">
                                                        ...
                                                        <div class="form-group" id="div_p_1223_p_piel" style="display:none">
                                                            <label class="floating-label-activo-sm">Examen de Piél </label>
                                                            <textarea class="form-control form-control-sm"  data-titulo="Piel" rows="1"  onfocus="this.rows=3" onblur="this.rows=1;" name="obs_p_1223_p_piel" id="obs_p_1223_p_piel"></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-12 col-md-2">
                                                        <div class="form-group">
                                                        ...
                                                        <div class="form-group" id="div_p_1223_p_gang" style="display:none">
                                                            <label class="floating-label-activo-sm">Examen de Ganglios </label>
                                                            <textarea class="form-control form-control-sm"  data-titulo="Ganglios" rows="1"  onfocus="this.rows=3" onblur="this.rows=1;" name="obs_p_1223_p_gang" id="obs_p_1223_p_gang"></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-12 col-md-2">
                                                        <div class="form-group">
                                                        ...
                                                        <div class="form-group" id="div_p_1223_p_carpul" style="display:none">
                                                            <label class="floating-label-activo-sm">Cardio-Pulmonar</label>
                                                            <textarea class="form-control form-control-sm"  data-titulo="Torax" rows="1"  onfocus="this.rows=3" onblur="this.rows=1;" name="obs_p_1223_p_carpul" id="obs_p_1223_p_carpul"></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-12 col-md-2">
                                                        <div class="form-group">
                                                        ...
                                                        <div class="form-group" id="div_p_1223_p_abd" style="display:none">
                                                            <label class="floating-label-activo-sm">Abdomen</label>
                                                            <textarea class="form-control form-control-sm"  data-titulo="Abdomen" rows="1"  onfocus="this.rows=3" onblur="this.rows=1;" name="obs_p_1223_p_abda" id="obs_p_1223_p_abd"></textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-12 col-md-2">
                                                        ...
                                                        <div class="form-group " id="div_p_1223_p_gen" style="display:none;">
                                                            <label class="floating-label-activo-sm">Genito-Anal</label>
                                                            <textarea class="form-control form-control-sm"  data-titulo="Genitales" rows="1"  onfocus="this.rows=3" onblur="this.rows=1;" name="obs_p_1223_p_gen" id="obs_p_1223_p_gen"></textarea>
                                                        </div>
                                                    ...
                                                    <div class="col-sm-12 col-md-2">
                                                        ...
                                                        <div class="form-group" id="div_p_1223_p_reflex" style="display:none;">
                                                            <label class="floating-label-activo-sm">Reflejos</label>
                                                            <textarea class="form-control form-control-sm"  data-titulo="Reflejos" rows="1"  onfocus="this.rows=3" onblur="this.rows=1;" name="obs_p_1223_p_reflex" id="obs_p_1223_p_reflex"></textarea>
                                                        </div>
                                                    ...
                                                    <div class="col-sm-12 col-md-3">
                                                        ...
                                                        <div class="form-group" id="div_p_1223_p_tono" style="display:none;">
                                                            <label class="floating-label-activo-sm">Tono y Motilidad</label>
                                                            <textarea class="form-control form-control-sm"  data-titulo="Tono y Motilidad" rows="1"  onfocus="this.rows=3" onblur="this.rows=1;" name="obs_p_1223_p_tono" id="obs_p_1223_p_tono"></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-12 col-md-3">
                                                        <div class="form-group">
                                                        ...
                                                        <div class="form-group" id="div_p_1223_p_cad" style="display:none;">
                                                            <label class="floating-label-activo-sm">Caderas</label>
                                                            <textarea class="form-control form-control-sm"  data-titulo="Caderas" rows="1"  onfocus="this.rows=3" onblur="this.rows=1;" name="obs_p_1223_p_cad" id="obs_p_1223_p_cad"></textarea>
                                                        </div>
                                                    ...
                                                    <div class="col-sm-12 col-md-2">
                                                        ...
                                                        <div class="form-group" id="div_p_1223_p_ext" style="display:none;">
                                                            <label class="floating-label-activo-sm">Extremidades</label>
                                                            <textarea class="form-control form-control-sm"  data-titulo="Extremidades" rows="1"  onfocus="this.rows=3" onblur="this.rows=1;" name="obs_p_1223_p_ext" id="obs_p_1223_p_ext"></textarea>
                                                        </div>
                                                    ...
                                                    <div class="col-sm-12 col-md-2">
                                                        ...
                                                        <div class="form-group" id="div_1223_p_ojo" style="display:none">
                                                            <label class="floating-label-activo-sm">Ex Oftalmológico</label>
                                                            <textarea class="form-control form-control-sm"  data-titulo="Ojos" rows="1"  onfocus="this.rows=3" onblur="this.rows=1;" name="obs_p_1223_p_ojo" id="obs_p_1223_p_ojo"></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-12 col-md-2">
                                                        <div class="form-group">
                                                        ...
                                                        <div class="form-group" id="div_p_1223_p_oido" style="display:none">
                                                            <label class="floating-label-activo-sm">Ex Auditívo</label>
                                                            <textarea class="form-control form-control-sm"  data-titulo="Oidos" rows="1"  onfocus="this.rows=3" onblur="this.rows=1;" name="obs_p_1223_p_oido" id="obs_p_1223_p_oido"></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-12 col-md-12">
                                                        <div class="form-group" style="text-align:center">
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        <label class="floating-label">Otros (lesiones)</label>
                                                        <textarea class="form-control form-control-sm"  rows="1" onfocus="this.rows=2" onblur="this.rows=1;" id="otros_font_1223" name="otros_font_1223" ></textarea>
                                                    </div>
                                                    <div class="form-group col-md-12">
                                                        <label class="floating-label">Señales de maltrato</label>
                                                            <textarea class="form-control form-control-sm"  rows="1" onfocus="this.rows=2" onblur="this.rows=1;" id="maltrato_1223" name="maltrato_1223" ></textarea>
                                                    </div>
                                                </div>
                                                <div class="form-row mb-2">
                                                    <div class="col-md-12">
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-4">
                                                        <label class="floating-label">General</label>
                                                        <textarea class="form-control form-control-sm" rows="1" onfocus="this.rows=2" onblur="this.rows=1;" name="dg_1223_general" id="dg_1223_general"></textarea>
                                                    </div>
                                                    <div class="form-group col-md-4">
                                                        <label class="floating-label">Incremento ponderal</label>
                                                        <textarea class="form-control form-control-sm" rows="1" onfocus="this.rows=2" onblur="this.rows=1;" name="dg_1223_inscr_ponderal" id="dg_1223_inscr_ponderal"></textarea>
                                                    </div>
                                                    <div class="form-group col-md-4">
                                                        <label class="floating-label">Lactancia</label>
                                                        <textarea class="form-control form-control-sm" rows="1" onfocus="this.rows=2" onblur="this.rows=1;" name="dg_1223_lactancia" id="dg_1223_lactancia"></textarea>
                                                    </div>
                                                    <div class="form-group col-md-4">
                                                        <label class="floating-label">Salud del lactante</label>
                                                        <textarea class="form-control form-control-sm" rows="1" onfocus="this.rows=2" onblur="this.rows=1;" name="dg_1223_salud_lactante" id="dg_1223_salud_lactante"></textarea>
                                                    </div>
                                                    <div class="form-group col-md-4">
                                                        <label class="floating-label">Salud de la madre</label>
                                                        <textarea class="form-control form-control-sm" rows="1" onfocus="this.rows=2" onblur="this.rows=1;" name="dg_1223_salud_madre" id="dg_1223_salud_madre"></textarea>
                                                    </div>
                                                    <div class="form-group col-md-4">
                                                        <label class="floating-label">Salud psicosocial</label>
                                                        <textarea class="form-control form-control-sm" rows="1" onfocus="this.rows=2" onblur="this.rows=1;" name="dg_1223_sal_psico" id="dg_1223_sal_psico"></textarea>
                                                    </div>
                                                </div>
                                                <div class="form-row">
                                                    <div class="col-sm-12 col-md-12">
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label class="floating-label">Indicaciones</label>
                                                        <textarea class="form-control form-control-sm" rows="1" onfocus="this.rows=4" onblur="this.rows=1;" name="p_1223_ind" id="p_1223_ind"></textarea>
                                                    </div>
                                                </div>
                                                <div class="form-row">
                                                    <div class="form-group col-md-12">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-12">
                                                        <label class="floating-label">Inspección general y relación parental</label>
                                                        <textarea class="form-control form-control-sm" rows="1" onfocus="" onblur="this.rows=1;" id="insp_24_gral" name="insp_24_gral" ></textarea>
                                                    </div>
                                                </div>
                                                <div class="form-row">
                                                    <div class="col-sm-12 col-md-2">
                                                        ...
                                                        <div class="form-group" id="div_p_24_p_piel" style="display:none">
                                                            <label class="floating-label-activo-sm">Examen de Piél </label>
                                                            <textarea class="form-control form-control-sm"  data-titulo="Piel" rows="1"  onfocus="this.rows=3" onblur="this.rows=1;" name="obs_p_24_p_piel" id="obs_p_24_p_piel"></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-12 col-md-2">
                                                        <div class="form-group">
                                                        ...
                                                        <div class="form-group" id="div_p_24_p_gang" style="display:none">
                                                            <label class="floating-label-activo-sm">Examen de Ganglios </label>
                                                            <textarea class="form-control form-control-sm"  data-titulo="Ganglios" rows="1"  onfocus="this.rows=3" onblur="this.rows=1;" name="obs_p_24_p_gang" id="obs_p_24_p_gang"></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-12 col-md-2">
                                                        <div class="form-group">
                                                        ...
                                                        <div class="form-group" id="div_p_24_p_carpul" style="display:none">
                                                            <label class="floating-label-activo-sm">Cardio-Pulmonar</label>
                                                            <textarea class="form-control form-control-sm"  data-titulo="Torax" rows="1"  onfocus="this.rows=3" onblur="this.rows=1;" name="obs_p_24_p_carpul" id="obs_p_24_p_carpul"></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-12 col-md-2">
                                                        <div class="form-group">
                                                        ...
                                                        <div class="form-group" id="div_p_24_p_abd" style="display:none">
                                                            <label class="floating-label-activo-sm">Abdomen</label>
                                                            <textarea class="form-control form-control-sm"  data-titulo="Abdomen" rows="1"  onfocus="this.rows=3" onblur="this.rows=1;" name="obs_p_24_p_abda" id="obs_p_24_p_abd"></textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-12 col-md-2">
                                                        ...
                                                        <div class="form-group " id="div_p_24_p_gen" style="display:none;">
                                                            <label class="floating-label-activo-sm">Genito-Anal</label>
                                                            <textarea class="form-control form-control-sm"  data-titulo="Genitales" rows="1"  onfocus="this.rows=3" onblur="this.rows=1;" name="obs_p_24_p_gen" id="obs_p_24_p_gen"></textarea>
                                                        </div>
                                                    ...
                                                    <div class="col-sm-12 col-md-2">
                                                        ...
                                                        <div class="form-group" id="div_p_24_p_reflex" style="display:none;">
                                                            <label class="floating-label-activo-sm">Presión Arterial</label>
                                                            <textarea class="form-control form-control-sm"  data-titulo="Reflejos" rows="1"  onfocus="this.rows=3" onblur="this.rows=1;" name="obs_p_24_p_reflex" id="obs_p_24_p_reflex"></textarea>
                                                        </div>
                                                    ...
                                                    <div class="col-sm-12 col-md-3">
                                                        ...
                                                        <div class="form-group" id="div_p_24_p_tono" style="display:none;">
                                                            <label class="floating-label-activo-sm">Ex. Neurológico</label>
                                                            <textarea class="form-control form-control-sm"  data-titulo="Tono y Motilidad" rows="1"  onfocus="this.rows=3" onblur="this.rows=1;" name="obs_p_24_p_tono" id="obs_p_24_p_tono"></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-12 col-md-3">
                                                        <div class="form-group">
                                                        ...
                                                        <div class="form-group" id="div_p_24_p_cad" style="display:none;">
                                                            <label class="floating-label-activo-sm">Marcha</label>
                                                            <textarea class="form-control form-control-sm"  data-titulo="Marcha" rows="1"  onfocus="this.rows=3" onblur="this.rows=1;" name="obs_p_24_p_cad" id="obs_p_24_p_cad"></textarea>
                                                        </div>
                                                    ...
                                                    <div class="col-sm-12 col-md-2">
                                                        ...
                                                        <div class="form-group" id="div_p_24_p_ext" style="display:none;">
                                                            <label class="floating-label-activo-sm">Pié plano flexible</label>
                                                            <textarea class="form-control form-control-sm"  data-titulo="Extremidades" rows="1"  onfocus="this.rows=3" onblur="this.rows=1;" name="obs_p_24_p_ext" id="obs_p_24_p_ext"></textarea>
                                                        </div>
                                                    ...
                                                    <div class="col-sm-12 col-md-2">
                                                        ...
                                                        <div class="form-group" id="div_p_24_p_ppd" style="display:none;">
                                                            <label class="floating-label-activo-sm">Pié plano doloroso</label>
                                                            <textarea class="form-control form-control-sm"  data-titulo="ppd" rows="1"  onfocus="this.rows=3" onblur="this.rows=1;" name="obs_p_24_p_ppd" id="obs_p_24_p_ppd"></textarea>
                                                        </div>
                                                    ...
                                                    <div class="col-sm-12 col-md-2">
                                                        ...
                                                        <div class="form-group" id="div_p_24_p_gv" style="display:none;">
                                                            <label class="floating-label-activo-sm">Genu valgo</label>
                                                            <textarea class="form-control form-control-sm"  data-titulo="Genuvalgo" rows="1"  onfocus="this.rows=3" onblur="this.rows=1;" name="obs_p_24_p_gv" id="obs_p_24_p_gv"></textarea>
                                                        </div>
                                                    ...
                                                    <div class="col-sm-12 col-md-3">
                                                        ...
                                                        <div class="form-group" id="div_p_24_p_ojo" style="display:none">
                                                            <label class="floating-label-activo-sm">Ex Oftalmológico</label>
                                                            <textarea class="form-control form-control-sm"  data-titulo="Ojos" rows="1"  onfocus="this.rows=3" onblur="this.rows=1;" name="obs_p_24_p_ojo" id="obs_p_24_p_ojo"></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-12 col-md-3">
                                                        <div class="form-group">
                                                        ...
                                                        <div class="form-group" id="div_p_24_p_oido" style="display:none">
                                                            <label class="floating-label-activo-sm">Ex Auditívo</label>
                                                            <textarea class="form-control form-control-sm"  data-titulo="Oidos" rows="1"  onfocus="this.rows=3" onblur="this.rows=1;" name="obs_p_24_p_oido" id="obs_p_24_p_oido"></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-12 col-md-6">
                                                        <div class="form-group" style="text-align:center">
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        <label class="floating-label">Otros (lesiones)</label>
                                                        <textarea class="form-control form-control-sm"  rows="1" onfocus="this.rows=2" onblur="this.rows=1;" id="otros_font_24" name="otros_font_24" ></textarea>
                                                    </div>
                                                    <div class="form-group col-md-12">
                                                        <label class="floating-label">Señales de maltrato</label>
                                                            <textarea class="form-control form-control-sm"  rows="1" onfocus="this.rows=2" onblur="this.rows=1;" id="maltrato_24" name="maltrato_24" ></textarea>
                                                    </div>
                                                </div>
                                                <div class="form-row mb-2">
                                                    <div class="col-md-12">
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                        <label class="floating-label">General</label>
                                                        <textarea class="form-control form-control-sm" rows="1" onfocus="this.rows=2" onblur="this.rows=1;" name="dg_gen_24" id="dg_gen_24"></textarea>
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        <label class="floating-label">Incremento ponderal</label>
                                                        <textarea class="form-control form-control-sm" rows="1" onfocus="this.rows=2" onblur="this.rows=1;" name="inc_pon_24" id="inc_pon_24"></textarea>
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        <label class="floating-label">Otros</label>
                                                        <textarea class="form-control form-control-sm" rows="1" onfocus="this.rows=2" onblur="this.rows=1;" name="otros_24" id="otros_24"></textarea>
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        <label class="floating-label">Salud psicosocial</label>
                                                        <textarea class="form-control form-control-sm" rows="1" onfocus="this.rows=2" onblur="this.rows=1;" name="sal_sicosocial_24" id="sal_sicosocial_24"></textarea>
                                                    </div>
                                                </div>
                                                <div class="form-row">
                                                    <div class="col-sm-12 col-md-12">
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label class="floating-label">Indicaciones</label>
                                                        <textarea class="form-control form-control-sm" rows="1" onfocus="this.rows=4" onblur="this.rows=1;" name="ind_24" id="ind_24"></textarea>
                                                    </div>
                                                </div>
                                                <div class="form-row">
                                                    <div class="form-group col-md-12">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-row">
                                                    <div class="form-group col-md-4">
                                                        <label class="floating-label">Anamnesis</label>
                                                        <textarea class="form-control form-control-sm"  rows="1" onfocus="this.rows=3" onblur="this.rows=1;" id="anamnesis_69" name="anamnesis_69" ></textarea>
                                                    </div>
                                                    <div class="form-group col-md-4">
                                                        <label class="floating-label">Evaluaciones psicoafectivas</label>
                                                        <textarea class="form-control form-control-sm"  rows="1" onfocus="this.rows=3" onblur="this.rows=1;" id="ev_psicoa_69" name="ev_psicoa_69" ></textarea>
                                                    </div>
                                                    <div class="form-group col-md-4">
                                                        <label class="floating-label">Otros</label>
                                                        <textarea class="form-control form-control-sm"  rows="1" onfocus="this.rows=3" onblur="this.rows=1;" id="otros_69" name="otros_69" ></textarea>
                                                    </div>
                                                </div>
                                                <div class="form-row mb-2">
                                                    <div class="col-md-12">
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-12">
                                                        <label class="floating-label">Inspección general y relación parental</label>
                                                        <textarea class="form-control form-control-sm"  rows="1" onfocus="this.rows=2" onblur="this.rows=1;" id="insp_gral_69" name="insp_gral_69" ></textarea>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-3">
                                                        ...
                                                        <input type="number" class="form-control form-control-sm"  id="resultadoIMC_69" name="resultadoIMC_69"  >
                                                            <script>
                                                                function cimc(){
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        ...
                                                        <textarea class="form-control form-control-sm"  rows="2" onfocus="this.rows=2" onblur="this.rows=2;" id="desarr_pub_69" name="desarr_pub_69" ></textarea>
                                                    </div>
                                                    <div class="form-group col-md-4">
                                                        <label class="floating-label text-danger">Desarrollo puberal *</label>
                                                        <textarea class="form-control form-control-sm"  rows="2" onfocus="this.rows=2" onblur="this.rows=2;" id="resp_desarr_pub_69" name="resp_desarr_pub_69" placeholder="REVISAR CUESTIONARIO (Completado por Padres)" ></textarea>
                                                    </div>
                                                    <div class="form-group col-md-4">
                                                        <label class="floating-label text-danger">Ex. Genitoanal *</label>
                                                        <textarea class="form-control form-control-sm"  rows="2" onfocus="this.rows=2" onblur="this.rows=2;" id="genito_anal_69" name="genito_anal_69" ></textarea>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-12 col-md-3">
                                                        ...
                                                        <div class="form-group" id="div_p_69_p_pa" style="display:none">
                                                            <label class="floating-label-activo-sm">Presión arterial</label>
                                                            <textarea class="form-control form-control-sm"  data-titulo="Presion" rows="1"  onfocus="this.rows=3" onblur="this.rows=1;" name="obs_p_69_p_pa" id="obs_p_69_p_pa"></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-12 col-md-3">
                                                        <div class="form-group">
                                                        ...
                                                        <div class="form-group" id="div_p_69_p_tadam" style="display:none">
                                                            <label class="floating-label-activo-sm">Test de Adams</label>
                                                            <textarea class="form-control form-control-sm"  data-titulo="Adams" rows="1"  onfocus="this.rows=3" onblur="this.rows=1;" name="obs_p_69_p_tadam" id="obs_p_69_p_tadam"></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-12 col-md-3">
                                                        <div class="form-group">
                                                        ...
                                                        <div class="form-group" id="div_p_69_p_carpul" style="display:none">
                                                            <label class="floating-label-activo-sm">Cardio-Pulmonar</label>
                                                            <textarea class="form-control form-control-sm"  data-titulo="Torax" rows="1"  onfocus="this.rows=3" onblur="this.rows=1;" name="obs_p_69_p_carpul" id="obs_p_69_p_carpul"></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-12 col-md-3">
                                                        <div class="form-group">
                                                        ...
                                                        <div class="form-group" id="div_p_69_p_abd" style="display:none">
                                                            <label class="floating-label-activo-sm">Abdomen</label>
                                                            <textarea class="form-control form-control-sm"  data-titulo="Abdomen" rows="1"  onfocus="this.rows=3" onblur="this.rows=1;" name="obs_p_69_p_abda" id="obs_p_69_p_abd"></textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-12 col-md-3">
                                                        ...
                                                        <div class="form-group " id="div_p_69_p_bd" style="display:none;">
                                                            <label class="floating-label-activo-sm">Ex. Bucodental</label>
                                                            <textarea class="form-control form-control-sm"  data-titulo="Bucodental" rows="1" onfocus="this.rows=3" onfocus="this.rows=3" onblur="this.rows=1;" name="obs_p_69_p_bd" id="obs_p_69_p_bd"></textarea>
                                                        </div>
                                                    ...
                                                    <div class="col-sm-12 col-md-3">
                                                        ...
                                                        <div class="form-group" id="div_p_69_p_mar" style="display:none;">
                                                            <label class="floating-label-activo-sm">Marcha</label>
                                                            <textarea class="form-control form-control-sm"  data-titulo="Marcha" rows="1"  onfocus="this.rows=3" onblur="this.rows=1;" name="obs_p_69_p_mar" id="obs_p_69_p_mar"></textarea>
                                                        </div>
                                                    ...
                                                    <div class="col-sm-12 col-md-3">
                                                        ...
                                                        <div class="form-group" id="div_p_69_p_ppf" style="display:none;">
                                                            <label class="floating-label-activo-sm">Pié plano flexible</label>
                                                            <textarea class="form-control form-control-sm"  data-titulo="Tono y Motilidad" rows="1"  onfocus="this.rows=3" onblur="this.rows=1;" name="obs_p_69_p_ppf" id="obs_p_69_p_ppf"></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-12 col-md-3">
                                                        <div class="form-group">
                                                        ...
                                                        <div class="form-group" id="div_p_69_p_ppd" style="display:none;">
                                                            <label class="floating-label-activo-sm">Pié plano doloroso</label>
                                                            <textarea class="form-control form-control-sm"  data-titulo="Caderas" rows="1"  onfocus="this.rows=3" onblur="this.rows=1;" name="obs_p_69_p_ppd" id="obs_p_69_p_ppd"></textarea>
                                                        </div>
                                                    ...
                                                    <div class="col-sm-12 col-md-3">
                                                        ...
                                                        <div class="form-group" id="div_p_69_p_gen" style="display:none;">
                                                            <label class="floating-label-activo-sm">Genu valgo</label>
                                                            <textarea class="form-control form-control-sm"  data-titulo="genu" rows="1"  onfocus="this.rows=3" onblur="this.rows=1;" name="obs_p_69_p_gen" id="obs_p_69_p_gen"></textarea>
                                                        </div>
                                                    ...
                                                    <div class="col-sm-12 col-md-3">
                                                        ...
                                                        <div class="form-group" id="div_p_69_p_ojo" style="display:none">
                                                            <label class="floating-label-activo-sm">Ex Oftalmológico</label>
                                                            <textarea class="form-control form-control-sm"  data-titulo="Ojos" rows="1"  onfocus="this.rows=3" onblur="this.rows=1;" name="obs_p_69_p_ojo" id="obs_p_69_p_ojo"></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-12 col-md-3">
                                                        <div class="form-group">
                                                        ...
                                                        <div class="form-group" id="div_p_69_p_oido" style="display:none">
                                                            <label class="floating-label-activo-sm">Ex Auditívo</label>
                                                            <textarea class="form-control form-control-sm"  data-titulo="Oidos" rows="1"  onfocus="this.rows=3" onblur="this.rows=1;" name="obs_p_69_p_oido" id="obs_p_69_p_oido"></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-12 col-md-3">
                                                        <div class="form-group">
                                                        ...
                                                        <div class="form-group" id="div_p_69_p_mt" style="display:none">
                                                            <label class="floating-label-activo-sm">Señales de maltrato</label>
                                                            <textarea class="form-control form-control-sm"  data-titulo="Oidos" rows="1"  onfocus="this.rows=3" onblur="this.rows=1;" name="obs_p_69_p_mt" id="obs_p_69_p_mt"></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-12 col-md-3">
                                                        <div class="form-group" style="text-align:center">
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                        <label class="floating-label">General</label>
                                                        <textarea class="form-control form-control-sm" rows="1" onfocus="this.rows=2" onblur="this.rows=1;" name="dg_general_69" id="dg_general_69"></textarea>
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        <label class="floating-label">Nutricional</label>
                                                        <textarea class="form-control form-control-sm" rows="1" onfocus="this.rows=2" onblur="this.rows=1;" name="dg_nutricional_69" id="dg_nutricional_69"></textarea>
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        <label class="floating-label">Salud (General)</label>
                                                        <textarea class="form-control form-control-sm" rows="1" onfocus="this.rows=2" onblur="this.rows=1;" name="dg_sal_gnal_69"" id="dg_sal_gnal_69"></textarea>
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        <label class="floating-label">Salud psicosocial</label>
                                                        <textarea class="form-control form-control-sm" rows="1" onfocus="this.rows=2" onblur="this.rows=1;" name="dg_s_psicosocial_69" id="dg_s_psicosocial_69"></textarea>
                                                    </div>
                                                </div>
                                                <div class="form-row">
                                                    <div class="col-sm-12 col-md-12">
