@extends('template.pediatria.template_cir_pediatrica')
@section('Content')
    <!--Container Completo-->
                ...
                <div class="col-md-12">
                    <div class="tab-content" id="at-oftalmo">
                        ...
                        <div class="tab-pane fade show active" id="atender" role="tabpanel" aria-labelledby="atender-tab">
                            @include('atencion_pediatrica.secciones_especialidad.ficha_cirugia_traumato_pediatrica')
                        </div>
                        <!--Licencia-->
