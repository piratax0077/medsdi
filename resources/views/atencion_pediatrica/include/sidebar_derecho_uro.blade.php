        ...
        <div class="bs-canvas-content">
            <div class="accordion" id="accordion_gineco_obst">
                ...
                <div class="card-sidebar">
                    ...
                    include("modals_sidebar_uro/m_uro_cuidados.php");
                    include("modals_sidebar_uro/m_uro_cistoscopia.php");
                    ?>-->
                </div>
            </div>
        </div>
    ...
    <!--SIDEBAR 3 (GINECO-OBSTÉTRICOS)-->
        ...
        <?php
        include("modals_sidebar_uro/modal_exbiopsia_uro.php");
        include("modals_sidebar_uro/modal_exorina_uro.php");
        include("modals_sidebar_uro/modal_exradiologico_uro.php");
        include("modals_sidebar_uro/modal_exhormonales_uro.php");
        ?>
