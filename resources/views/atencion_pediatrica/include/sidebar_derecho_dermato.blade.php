   <!--Sidebar 3 (DERMATOLOGIA)-->
            ...
            <div class="accordion" id="accordion_gineco_obst">
                ...
                <div class="card-sidebar">
                   ...
                   <!-- <?php
                    ...
                    include("modals_sidebar_dermato/m_dermo_cuidados.php");
                    include("modals_sidebar_dermato/m_tipos_piel.php");
    ...
    <!--SIDEBAR 3 (GINECO-OBSTÉTRICOS)-->
        ...
        <?php
        include("../modals_especialidad/modal_exbiopsia_dermat.php");
        include("modals_sidebar_dermato/modal_exorina_uro.php");
        include("modals_sidebar_dermato/modal_exradiologico_uro.php");
        include("modals_sidebar_dermato/modal_exhormonales_uro.php");
        ?>
