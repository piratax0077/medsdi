			...
			<div class="modal-body">
				<form>
					...
					<div class="form-row">
						...
						<div class="form-group col-sm-6">
							<input class="form-control form-control-sm" type="text" placeholder=" Ingrese el peso en Kg." name="peso" id="peso">
						</div>
					</div>
					<div class="form-row">
						<div class="form-group col-sm-6 text-left">
						...
						<div class="col-sm-6 text-center">
							<input class="form-control form-control-sm" type="text" placeholder="Ingrese el talla en cms." name="altura" id="altura">
						</div>
					</div>
					<div class="form-row">
