...
<head>
    ...
    <title>SDI | Asistente Enfermeria</title>
    <meta name="description" content="" />
    <meta name="keywords" content="">
    <meta name="author" content="SDI | Asistente Enfermeria" />
...
<body>
    ...
    @switch($user)
        ...
        @case($user->hasRole('AsistenteEnfermeria'))
            @include('template.asistente_enfermeria.menu')
            @include('template.asistente_enfermeria.header')
        @break
