            ...
            <ul class="nav pcoded-inner-navbar ">
                <li class="nav-item pcoded-hasmenu">
                    ...
                    <ul class="pcoded-submenu">
                        ...
                        <li>
                            <a href="{{ ROUTE('asistente_adm.buscar_paciente') }}">Buscar Pacientes</a>
                        </li>
                        <li>
                            <a href="{{ ROUTE('asistente_adm.mis_profesionales') }}">Info de Profesionales</a>
                        </li>
                        <li>
                            <a href="{{ ROUTE('asistente_adm.home') }}">Recibo de Caja</a>
                        </li>
                        <li>
                            <a href="{{ ROUTE('asistente_adm.home') }}">Estadísticas del Centro Médico</a>
                        </li>
                    </ul>
                </li>
                <li class="nav-item pcoded-hasmenu">
                    ...
                    <ul class="pcoded-submenu">
                        ...
                        <li>
							<a href="{{ ROUTE('asistentecm.subcripcion') }}">Suscripción y Pagos</a>
						</li>
                    </ul>
                </li>
            </ul>
