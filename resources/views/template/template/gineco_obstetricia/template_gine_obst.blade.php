...
<html lang="es">
    <head>
        @include('atencion_gine_obstetricia.include.head_gine_obst')
    ...
    <body>
        @include('template.gineco_obstetricia.header')
        ...
        @include('atencion_gine_obstetricia.secciones_especialidad.ficha_gine_obst_tipo')
    ...
    <script src="{{ asset('js/jquery-ui/jquery-ui.min.js') }}"></script>
        ...
        <script src="{{ asset('js/atencion_ginecobstetrica.js') }}?upd={{ random_int(1111,9999) }}"></script>
        <!--Tablas y Toggle atención ginecoobstetricas-->
