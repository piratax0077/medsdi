            ...
            <ul class="nav pcoded-inner-navbar ">
                <li class="nav-item pcoded-hasmenu">
                    ...
                    <ul class="pcoded-submenu">
                        ...
                        <li>
                            <a href="{{ ROUTE('asistentecm.ma.buscar_paciente') }}">Buscar Pacientes</a>
                        </li>
                        <li>
                            <a href="{{ ROUTE('asistentecm.ma.mis_profesionales') }}">Profesionales</a>
                        </li>
                        {{-- <li>
                            <a href="{{ ROUTE('asistentecm.ma.rendir') }}">Rendir Caja</a>
                        </li>
                        <li>
                            <a href="{{ ROUTE('asistentecm.ma.historico_caja') }}">Historico de Caja</a>
                        </li> --}}
                    </ul>
                </li>
                <li class="nav-item pcoded-hasmenu">
                    ...
                    <ul class="pcoded-submenu">
                        <li>
							<a href="{{ ROUTE('asistentecm.ma.perfil') }}">Editar Perfil</a>
						</li>
