...
<body>
    ...
    <script src="{{ asset('js/debug_functions.js') }}"></script>
    ...
    <script type="text/javascript">
        ...
        function editar_profesional_datos_personales(id) {
            ...
            let numero_colegio = $('#editar_numero_colegio').val();
                    ...
                    .done(function(data) {
                        ...
                        if (data !== 'null') {
                            ...
                            if(tipo_agenda == 4)
                            {
                                ...
                                let examenes = data.procedimientos_lugar_atencion;
                                console.log(examenes);
                                $('#form_reseva_de_horas_id_procedimiento').empty();
                                $('#form_reseva_de_horas_id_procedimiento').append('<option value="">Seleccione un Examen</option>');
                                examenes.forEach(examen => {
                                    $('#form_reseva_de_horas_id_procedimiento').append(
                                        `<option value="${examen.id_procedimiento_centro}" data-cant_bloque="${examen.cantidad_bloques}">${examen.nombre}</option>`
                                    );
                                });
                            ...
                            if (data.tipo_paciente == 'SI') {
                                ...
                                $('#presupuesto_numero').append('<option value="10">Atención de urgencias</option>');
