       ...
       {{--  mensaje de exito al registrar ficha clinica  --}}
            ...
            /** FIN METODO PARA ENVIO DE INDICACIONES MEDICAS PDF */
             $(document).ready(function(){
                ...
                // $('#tabla_medicamentos_enfermera').DataTable();
                $('#tabla_tratamiento_suero_enfermera').DataTable();
                $('#tabla_inyecciones_enfermera').DataTable();
                $('#tabla_nutricion_enfermera').DataTable();
