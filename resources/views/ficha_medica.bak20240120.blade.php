                                    ...
                                    <div class="card-body-aten-a">
                                        <div class="row mt-3">
                                            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 pb-4">
                                                <ul class="nav nav-tabs-secciones mb-3 mt-3" id="myTab" role="tablist">
                                                    <li class="nav-item-secciones">
                                                        <a class="nav-secciones active text-uppercase active" id="seccion_ident_contacto-tab" data-toggle="tab" href="#seccion_ident_contacto" role="tab" aria-controls="seccion_ident_contacto" aria-selected="true">Identificacion y Contacto</a>
                                                    </li>
                                                    <li class="nav-item-secciones">
                                                        <a class="nav-secciones active text-uppercase" id="seccion_enfer_cronicas-tab" data-toggle="tab" href="#seccion_enfer_cronicas" role="tab" aria-controls="seccion_enfer_cronicas" aria-selected="false">Enfermedades Cronicas</a>
                                                    </li>
                                                    <li class="nav-item-secciones">
                                                        <a class="nav-secciones active text-uppercase" id="seccion_alergias-tab" data-toggle="tab" href="#seccion_alergias" role="tab" aria-controls="seccion_alergias" aria-selected="false">Alergias</a>
                                                    </li>
                                                    <li class="nav-item-secciones">
                                                        <a class="nav-secciones active text-uppercase" id="seccion_ultimas_cirugia-tab" data-toggle="tab" href="#seccion_ultimas_cirugia" role="tab" aria-controls="seccion_ultimas_cirugia" aria-selected="false">Ultimas Cirugias</a>
                                                    </li>
                                                    <li class="nav-item-secciones">
                                                        <a class="nav-secciones active text-uppercase" id="seccion_ultimo_tratamiento-tab" data-toggle="tab" href="#seccion_ultimo_tratamiento" role="tab" aria-controls="seccion_ultimo_tratamiento" aria-selected="false">Ultimos Tratamientos</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
