            ...
            <div class="col-md-12">
                <div class="row">
                    <div class="col-md-12 mb-0 pt-3">
                        <h6 class="f-16 text-c-blue">Atenciones previas</h6>
                        <hr>
                    </div>
                </div>
                <div class="row">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-center align-middle">
                                        <button href="#!" class="btn btn-info btn-sm"><i class="feather icon-file-text"></i> Ver Ficha</button>
                                    </td>
                                    <td class="text-center align-middle">
                                        <button href="#!" class="btn btn-success btn-sm"><i class="feather icon-folder"></i> Ver Archivos</button>
                                    </td>
                                    <td class="text-center align-middle">
                                        <button href="#!" class="btn btn-secondary btn-sm"><i class="feather icon-file-plus"></i> Ver Receta</button>
                                        </td>
                                    </tr>
                                <tr>
