<div id="modal_indicar_examen_rx" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="modal_indicar_examen_rx"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header bg-info">
                <h5 class="modal-title text-white mt-1" id="modal_indicar_examen">Indicar Examenes Imagenología</h5>
