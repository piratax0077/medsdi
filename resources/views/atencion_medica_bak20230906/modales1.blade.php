                            ...
                            <form>
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-sm-12 col-md-12">
                                        <label class="floating-label-activo-sm">Nombre</label>
                                        <input type="text" class="form-control form-control-sm"
                                            name="nombre_institucion" id="nombre_institucion">
                                    </div>
                                    <div class="form-group col-sm-12 col-md-12">
                                        <label class="floating-label-activo-sm">Dirección</label>
                            ...
                            <form>
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-sm-12 col-md-12">
                                        ...
                                        <input type="tel" class="form-control form-control-sm" name="telefono_paciente"
                            ...
                            <form>
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-sm-12 col-md-12">
                                        ...
                                        <input type="text" class="form-control form-control-sm"
                                            name="confirmacion_diagnostica_1" id="confirmacion_diagnostica_1">
                                    </div>
                                    <div class="form-group col-sm-12 col-md-12">
                                ...
                                <div class="col-sm-12 col-md-12">
                                    <div class="alert alert-success text-justify pt-3 pb-1" role="alert">
                                        <p>Declaro que con esta <span>fecha</span> y
                                            <span>hora</span>, he tomado conocimiento de que tengo derecho a acceder a
                            ...
                            <div class="tab-pane pt-4 active show" id="ident_establecimiento_eno">
                                <form>
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-sm-12 col-md-12">
                                            <label class="floating-label-activo-sm">Nombre de oficina
                                                provincial</label>
                                            <input type="text" class="form-control form-control-sm"
                                                name="nombre_oficina_provincial" id="nombre_oficina_provincial">
                                        </div>
                                        <div class="form-group col-sm-12 col-md-12">
                                            <label class="floating-label-activo-sm">Código de oficina
                                                provincial</label>
                                            <input type="number" class="form-control form-control-sm"
                                                name="codigo_oficina_provincial" id="codigo_oficina_provincial">
                                        </div>
                                        <div class="form-group col-sm-12 col-md-12">
                                            <label class="floating-label-activo-sm">Nº de ficha clínica o código de
                                                control</label>
                                            <input type="number" class="form-control form-control-sm"
                                ...
                                <form>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-sm-6 col-md-6">
                                            <label class="floating-label-activo-sm">Rut</label>
                                            <input type="person" class="form-control form-control-sm"
                                                name="rut_paciente" id="rut_paciente">
                                        </div>
                                        <div class="form-group col-sm-6 col-md-6">
                                            <label class="floating-label-activo-sm">Nombre completo</label>
                                            <input type="text" class="form-control form-control-sm"
                                                name="nombre_paciente" id="nombre_paciente">
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="form-group col-sm-6 col-md-6">
                                            ...
                                            <input type="text" class="form-control form-control-sm"
                                                name="sexo_paciente" id="sexo_paciente">
                                        </div>
                                        <div class="form-group col-sm-6 col-md-6">
                                            <label class="floating-label-activo-sm">Nacimiento</label>
                                            <input type="date" class="form-control form-control-sm"
                                                name="nacimiento_paciente" id="nacimiento_paciente">
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="form-group col-sm-6 col-md-6">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-sm-6 col-md-6">
                                            ...
                                            <input type="email" class="form-control form-control-sm"
                                                name="email_paciente" id="email_paciente">
                                        </div>
                                        <div class="form-group col-sm-6 col-md-6">
                                            <label class="floating-label-activo-sm">Teléfono</label>
                                            <input type="tel" class="form-control form-control-sm"
                                                name="telefono_paciente" id="telefono_paciente">
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="form-group col-sm-6 col-md-6">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-sm-6 col-md-6">
                                            ...
                                            <input type="text" class="form-control form-control-sm"
                                                name="ocupacion_paciente" id="ocupacion_paciente">
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="form-group col-sm-6 col-md-6">
                            ...
                            <div class="tab-pane pt-4" id="notificacion_eno">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-sm-6 col-md-6">
                                        ...
                                        <input type="text" class="form-control form-control-sm" name="nombre_apellidos"
                                            id="nombre_apellidos">
                                    </div>
                                </div>
                                <div class="form-row">
                ...
                <div class="bt-wizard" id="reembolso_gastos_medicos">
                    <ul class="nav nav-pills">
                        <li class="tab-wizard-formularios"><a href="#ident_asegurado_carga"
                                ...
                                carga</a></li>
                        <li class="tab-wizard-formularios"><a href="#ident_causa_intercitud"
                                class="nav-link-wizard rounded-0" data-toggle="tab">Causa de la solicitud</a></li>
                        <li class="tab-wizard-formularios"><a href="#ant_reembolso" class="nav-link-wizard rounded-0"
                                data-toggle="tab">Antecedentes del reembolso</a></li>
                        <li class="tab-wizard-formularios"><a href="#informe_medico" class="nav-link-wizard rounded-0"
                                data-toggle="tab">Informe médico</a></li>
                            ...
                            <form>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-sm-6 col-md-6">
                                        ...
                                        <input type="text" class="form-control form-control-sm" name="empresa_asociada"
                                            id="empresa_asociada">
                                    </div>
                                    <div class="form-group col-sm-6 col-md-6">
                                        <label class="floating-label-activo-sm">Nombre Asegurado</label>
                                        <input type="text" class="form-control form-control-sm" name="nombre_asegurado"
                                            id="nombre_asegurado">
                                    </div>
                                </div>
                                <div class="form-row">
                            ...
                            <form>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-sm-6 col-md-6">
                                        ...
                                        <input type="date" class="form-control form-control-sm" name="fecha_prestación"
                                            id="fecha_prestación">
                                    </div>
                                    <div class="form-group col-sm-6 col-md-6">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-sm-6 col-md-6">
                                        ...
                                        <input type="text" class="form-control form-control-sm" name="total_documentos"
                                            id="total_documentos">
                                    </div>
                                    <div class="form-group col-sm-6 col-md-6">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-sm-6 col-md-6">
                                        ...
                                        <input type="date" class="form-control form-control-sm" name="reclamo_anterior"
                                            id="reclamo_anterior">
                                    </div>
                                    <div class="form-group col-sm-6 col-md-6">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-sm-12 col-md-12">
                                                ...
                                                <input type="email" class="form-control form-control-sm"
                                                    ...
                                                    id="email_paciente" readonly>
                                            </div>
                                            <div class="form-group col-sm-12 col-md-12">
                                                <label class="floating-label-activo-sm">Teléfono</label>
                                                <input type="tel" class="form-control form-control-sm"
                                                    name="telefono_paciente" value="{{ $paciente->telefono_uno }}"
                                                    id="telefono_paciente" readonly>
                                            </div>
                                        </div>
                                    </form>
                                </div>
