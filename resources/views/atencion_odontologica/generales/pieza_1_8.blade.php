                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                        <div class="form-group">
                            ...
                            <select name="tipo_sonda1.8" id="tipo_sonda1.8" class="form-control form-control-sm" onchange="evaluar_para_carga_detalle('period_inst','div_period_inst','obs_period_inst',5);">
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-sm" name="obs_tipo_sonda1.8" id="obs_tipo_sonda1.8" value="{{ $pieza18->cuerpo['obs_tipo_sonda'] ?? '' }}" />
                        </div>
                    </div>
                    @endif
                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
