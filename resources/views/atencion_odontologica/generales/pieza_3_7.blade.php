                            ...
                            <form name ="grafico1" id="grafico1" action="#">
                                ...
                                <div class="form-row">
                                    <div class="col-sm-12 col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input  class="form-control form-control-xs"  type="number"  id="m37" name="m37" value="0" tabindex="1" onchange="rangoNumero('m37');"/>
                                        </div>
                                    </div>
                                ...
                                <div class="form-row mb-2">
                                    ...
                                    <div class="col-sm-12 col-md-8">
                                        <input class="form-control form-control-xs" type="number" id="ae37" name="ae37" value="0" tabindex="33"/>
                                    </div>
                                </div>
                                <div class="form-row mb-2">
                                    <div class="col-sm-12 col-md-4">
                                    ...
                                    <div class="col">
                                        <input class="form-control form-control-xs" type="number" id="mg37-a" name="mg37-a" value="0" onchange="cargar37a();getDefectos();rangoNumeroMargen('mg37-a');cargar37a();" tabindex="49"/>
                                    </div>
                                    <div class="col">
                                        <input class="form-control form-control-xs" type="number" id="mg37-b" name="mg37-b" value="0" onchange="cargar37a();getDefectos();rangoNumeroMargen('mg37-b');cargar37a();" tabindex="50"/>
                                    </div>
                                    <div class="col">
                                        <input class="form-control form-control-xs" type="number" id="mg37-c" name="mg37-c" value="0" onchange="cargar37a();getDefectos();rangoNumeroMargen('mg37-c');cargar37a();" tabindex="50"/>
                                    </div>
                                </div>
                                <div class="form-row mb-2">
                                    <div class="col-sm-12 col-md-4">
                                    ...
                                    <div class="col">
                                        <input class="form-control form-control-xs" type="number" id="ps37-a" name="ps37-a" value="0" onchange="cargar37a();getDefectos();" tabindex="97"/>
                                    </div>
                                    <div class="col">
                                        <input class="form-control form-control-xs" type="number" id="ps37-b" name="ps37-b" value="0" onchange="cargar37a();getDefectos();" tabindex="98"/>
                                    </div>
                                    <div class="col">
                                        <input class="form-control form-control-xs" type="number" id="ps37-c" name="ps37-c" value="0" onchange="cargar37a();getDefectos();" tabindex="99"/>
                                    </div>
                                </div>
                            </form>
                        </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-sm-12 col-md-8 col-lg-8 col-xl-8">
                            ...
                            <div class="form-row mb-2">
                                ...
                                <div class="col">
                                    <input class="form-control form-control-xs" type="number" id="ps37b-a" name="ps37b-a" value="0" onchange="cargar37b();getDefectos();" tabindex="145"/>
                                </div>
                                <div class="col">
                                    <input class="form-control form-control-xs" type="number" id="ps37b-b" name="ps37b-a" value="0" onchange="cargar37b();getDefectos();" tabindex="146"/>
                                </div>
                                <div class="col">
                                    <input class="form-control form-control-xs" type="number" id="ps37b-c" name="ps37b-a" value="0" onchange="cargar37b();getDefectos();" tabindex="147"//>
                                </div>
                            </div>
                             <div class="form-row mb-2">
                                <div class="col-sm-12 col-md-4">
                                ...
                                <div class="col">
                                    <input class="form-control form-control-xs" type="number" id="mg37b-a" name="mg37b-a" value="0" onchange="cargar37b();getDefectos();rangoNumeroMargen('mg37b-a');cargar37b();" tabindex="193"/>
                                </div>
                                <div class="col">
                                    <input class="form-control form-control-xs" type="number" id="mg37b-b" name="mg37b-b" value="0" onchange="cargar37b();getDefectos();rangoNumeroMargen('mg37b-b');cargar37b();" tabindex="194"/>
                                </div>
                                <div class="col">
                                    <input class="form-control form-control-xs" type="number" id="mg37b-c" name="mg37b-c" value="0" onchange="cargar37b();getDefectos();rangoNumeroMargen('mg37b-c');cargar37b();" tabindex="195"/>
                                </div>
                            </div>
                             <div class="form-row mb-2">
                                    <div class="col-sm-12 col-md-4">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="form-group" id="obs_pieza3.7">
                        ...
                        <textarea class="form-control caja-texto form-control-sm" data-titulo="Obs Pieza 3.7" data-seccion="Eval_periimplantar"  rows="1"  onfocus="this.rows=3" onblur="this.rows=1;" name="det_op_bruxismo" id="det_op_bruxismo" placeholder="Describa observaciones"></textarea>
                    </div>
                </div>
            </div>
        </div>
...
<div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 text-center">
    <div id="obs_pieza3.7">
            <button type="button" class="btn btn-info text-center"><i class="feather icon-save"></i>  Guardar evaluación 3.7</button>
    </div>
</div>
