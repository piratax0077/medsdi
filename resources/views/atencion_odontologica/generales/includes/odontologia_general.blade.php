                    ...
                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                        <div class="tab-content" id="odogeneral">
                            ...
                            <div class="tab-pane fade show " id="examen_general" role="tabpanel" aria-labelledby="examen_general_tab">
                                <div class="row">
                                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 mt-4 mb-2">
                                        <h6 class="t-aten d-inline">Dolor</h6>
                                        <button type="button" class="btn btn-icon btn-primary btn-sm d-inline float-md-right mt-n2 mx-1"><i class="feather icon-save"></i></button>
                                        <button type="button" class="btn btn-info btn-sm  d-inline float-md-right mt-n2 ml-1"><i class="fas fa-plus"></i> Añadir pieza</button>
                                    </div>
                                </div>
                                <div class="form-row" id="h_dental">
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control form-control-sm"  rows="1"  onfocus="this.rows=3" onblur="this.rows=1;" name="ex_grl_hp" id="ex_grl_hp"></textarea>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="card-informacion">
                                            <div class="card-body">
                                                <div class="form-row align-items-center">
                                                    <div class="col-auto">
                                                        <div class="form-group">
                                                            <label class="floating-label-activo-sm">Pieza N°djpk</label>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                        <div id="nueva_pieza_dental_odontodolor">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-4 col-md-4 mb-3">
                                        <button type="button" class="btn btn-primary-light-c btn-sm" onclick="mostrar_nueva_pieza_dental({{ $count }})"><i class="fas fa-plus"></i> Añadir nueva pieza</button>
                                        <button type="button" class="btn btn-icon btn-info-light-c btn-sm" onclick="guardar_pieza_dental_dolor({{ $count }})" ><i class="feather icon-save"></i></button>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="tab-pane fade show" id="ex_oral" role="tabpanel" aria-labelledby="ex_oral_tab">
                                <div class="form-row">
                                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 mt-3">
                                        <h6 class="tit-gen">Examen Oral</h6>
                                    </div>
                                    ...
                                    <div class="col-sm-12 col-md-12 col-lg-10 col-xl-10">
                                        <div class="tab-content" id="v-pills-tabContent">
                                            ...
                                            <div class="tab-pane fade show" id="radiologia_endo" role="tabpanel" aria-labelledby="radiologia_endo_tab">
                                                <div class="form-row">
                                                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 ">
                                                        <h6 class="sub-aten d-inline"> Exámen radiológico</h6>
                                                                ...
                                                                <div class="card">
                                                                                            ...
                                                                                            @foreach ($examen->decoded_imagenes as $imagen)
                                                                                                @if (is_array($imagen) && isset($imagen['paths_imagenes']) && is_array($imagen['paths_imagenes']))
                                                                                                    ...
                                                                                                    <div>
                                                                                                        ...
                                                                                                        <button type="button" class="btn btn-outline-danger btn-sm my-2" onclick="eliminar_rx({{ $imagen['id']}})"><i class="fas fa-times"></i></button>
                                                                                                    </div>

                                                                                                    @endforeach
                                                                                                @else
                                                                                                <div class="alert alert-danger" role="alert">
                                                                                                    <i class="fas fa-times-circle"></i> Formato de imagen no válido.
                                                                                                </div>
                                                                                                @endif
                                                                                            @endforeach
                                                                                        @else
                                                                                            <div class="alert alert-warning" role="alert">
                                                                                                <i class="fas fa-exclamation-triangle"></i> No hay imágenes disponibles para este examen.
                                                                                            </div>
                                                                                        @endif
                                                                                    </div>
                                                                                </div>
                                                                    ...
                                                                    <div class="card-footer">
                                                                        <div class="form-row align-items-center">
                                                                            ...
                                                                            <div class="col-auto">
                                                                                <div class="form-group">
                                                                                <button type="button" class="btn btn-icon btn-warning-light-c" onclick="editar_pieza_dental_rx({{ $examen->id }})"><i class="feather icon-edit"></i></button>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-auto">
                                                                                <div class="form-group">
                                                                                <button type="button" class="btn btn-icon btn-danger-light-c" onclick="eliminar_pieza_dental_rx({{ $examen->id }})"><i class="feather icon-x"></i></button>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                            ...
                                            <div class="tab-pane fade show" id="imagenes_dent" role="tabpanel" aria-labelledby="imagenes_dent_tab">
                                                <div class="row">
                                                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                                        <h6 class="sub-aten d-inline">Imágenes</h6>
                                                        <button type="button" class="btn btn-info btn-sm  d-inline float-md-right mt-n2 mb-2"><i class="fas fa-plus"></i> Añadir nuevas imágenes</button>
                                                    </div>
                                                </div>
                                                                ...
                                                                <div class="form-row mb-1">
                                                                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                                                        <div class="form-row">
                                                                                    ...
                                                                                    <div class="card-body">
                                                                                        ...
                                                                                        <div class="form-row" id="contenedor_piezas_ex_oral">
                                                                                            @if (!empty($imagen->paths_imagenes) && is_array($imagen->paths_imagenes))
                                                                                                @php
                                                                                                    $imagenesPre = array_filter($imagen->paths_imagenes, function($img) {
                                                                                                        return isset($img['momento']) && $img['momento'] === 'Pre';
                                                                                                    });
                                                                                                @endphp

                                                                                                @if (count($imagenesPre) > 0)
                                                                                                    @foreach ($imagenesPre as $path)
                                                                                                        <div>
                                                                            ...
                                                                            <div class="col-sm-4 mt-2">
                                                                                <div class="card">
                                                                                    <div class="card-header text-center" id="img">
                                                                                        <h6>Imagenes Post</h6>
                                                                                    </div>
                                                                                    <div class="card-body">
                                                                                        <!-- Contenedor de Imágenes -->
                                                    ...
                                                    <div class="mb-3">
                                                        <div class="form-row align-items-center">
                                                            <div class="col-auto">
                                                                <div class="form-group">
                                                                    <label class="floating-label-activo-sm">Pieza N°</label>
                                                                    <input type="text" class="form-control form-control-sm d-inline" name="n_pieza_ex_pp{{ $counter }}" id="n_pieza_ex_pp{{ $counter }}" value="{{ $examen->numero_pieza }}">
                                                                </div>
                                                            </div>
                                                            <div class="col-auto">
                                                                <div class="form-group">
                                                                    <button type="button" class="btn btn-icon btn-danger-light-c d-inline" onclick="eliminar_pieza_dental_pieza({{ $examen->id }},'gral')">X</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-row">
                            ...
                            <div class="tab-pane fade show" id="plan_endo" role="tabpanel" aria-labelledby="plan_endo-tab">
                                <div id="contenedor_pieza_plan_gral">
                                    <div id="pieza_dental" class="form-row">
                                        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 mt-4 mb-3">
                                            <h6 class="t-aten d-inline">Planificación de tratamiento</h6>
                                            <button type="button" class="btn btn-info btn-sm  d-inline float-md-right mt-n2"><i class="fas fa-plus"></i> Añadir a presupuesto</button>
                                        </div>
                                        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                            <div class="tab-content" id="v-pills-tabContent">
                                                <div class="tab-pane fade show active" id="faringe" role="tabpanel" aria-labelledby="faringe-tab">
                                                        ...
                                                        <button type="button" class="btn btn-outline-primary btn-sm my-3" onclick="cargar_a_presupuesto('gral')"><i class="fas fa-plus"></i> Cargar a presupuesto</button>
