                            ...
                            <form name ="grafico1" id="grafico1" action="#">
                                ...
                                <div class="form-row">
                                    <div class="col-sm-12 col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input  class="form-control form-control-xs"  type="number"  id="m38" name="m38" value="0" tabindex="1" onchange="rangoNumero('m38');"/>
                                        </div>
                                    </div>
                                ...
                                <div class="form-row mb-2">
                                    ...
                                    <div class="col-sm-12 col-md-8">
                                        <input class="form-control form-control-xs" type="number" id="ae38" name="ae38" value="0" tabindex="33"/>
                                    </div>
                                </div>
                                <div class="form-row mb-2">
                                    <div class="col-sm-12 col-md-4">
                                    ...
                                    <div class="col">
                                        <input class="form-control form-control-xs" type="number" id="mg38-a" name="mg38-a" value="0" onchange="cargar38a();getDefectos();rangoNumeroMargen('mg38-a');cargar38a();" tabindex="49"/>
                                    </div>
                                    <div class="col">
                                        <input class="form-control form-control-xs" type="number" id="mg38-b" name="mg38-b" value="0" onchange="cargar38a();getDefectos();rangoNumeroMargen('mg38-b');cargar38a();" tabindex="50"/>
                                    </div>
                                    <div class="col">
                                        <input class="form-control form-control-xs" type="number" id="mg38-c" name="mg38-c" value="0" onchange="cargar38a();getDefectos();rangoNumeroMargen('mg38-c');cargar38a();" tabindex="50"/>
                                    </div>
                                </div>
                                <div class="form-row mb-2">
                                    <div class="col-sm-12 col-md-4">
                                    ...
                                    <div class="col">
                                        <input class="form-control form-control-xs" type="number" id="ps38-a" name="ps38-a" value="0" onchange="cargar38a();getDefectos();" tabindex="97"/>
                                    </div>
                                    <div class="col">
                                        <input class="form-control form-control-xs" type="number" id="ps38-b" name="ps38-b" value="0" onchange="cargar38a();getDefectos();" tabindex="98"/>
                                    </div>
                                    <div class="col">
                                        <input class="form-control form-control-xs" type="number" id="ps38-c" name="ps38-c" value="0" onchange="cargar38a();getDefectos();" tabindex="99"/>
                                    </div>
                                </div>
                            </form>
                        </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-sm-12 col-md-8 col-lg-8 col-xl-8">
                            ...
                            <div class="form-row mb-2">
                                ...
                                <div class="col">
                                    <input class="form-control form-control-xs" type="number" id="ps38b-a" name="ps38b-a" value="0" onchange="cargar38b();getDefectos();" tabindex="145"/>
                                </div>
                                <div class="col">
                                    <input class="form-control form-control-xs" type="number" id="ps38b-b" name="ps38b-a" value="0" onchange="cargar38b();getDefectos();" tabindex="146"/>
                                </div>
                                <div class="col">
                                    <input class="form-control form-control-xs" type="number" id="ps38b-c" name="ps38b-a" value="0" onchange="cargar38b();getDefectos();" tabindex="147"//>
                                </div>
                            </div>
                             <div class="form-row mb-2">
                                <div class="col-sm-12 col-md-4">
                                ...
                                <div class="col">
                                    <input class="form-control form-control-xs" type="number" id="mg38b-a" name="mg38b-a" value="0" onchange="cargar38b();getDefectos();rangoNumeroMargen('mg38b-a');cargar38b();" tabindex="193"/>
                                </div>
                                <div class="col">
                                    <input class="form-control form-control-xs" type="number" id="mg38b-b" name="mg38b-b" value="0" onchange="cargar38b();getDefectos();rangoNumeroMargen('mg38b-b');cargar38b();" tabindex="194"/>
                                </div>
                                <div class="col">
                                    <input class="form-control form-control-xs" type="number" id="mg38b-c" name="mg38b-c" value="0" onchange="cargar38b();getDefectos();rangoNumeroMargen('mg38b-c');cargar38b();" tabindex="195"/>
                                </div>
                            </div>
                             <div class="form-row mb-2">
                                    <div class="col-sm-12 col-md-4">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="form-group" id="obs_pieza3.8">
                        ...
                        <textarea class="form-control caja-texto form-control-sm" data-titulo="Obs Pieza 3.8" data-seccion="Eval_periimplantar"  rows="1"  onfocus="this.rows=3" onblur="this.rows=1;" name="det_op_bruxismo" id="det_op_bruxismo" placeholder="Describa observaciones"></textarea>
                    </div>
                </div>
            </div>
        </div>
...
<div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 text-center">
    <div id="obs_pieza2.8">
            <button type="button" class="btn btn-info text-center"><i class="feather icon-save"></i>  Guardar evaluación 3.8</button>
    </div>
</div>
