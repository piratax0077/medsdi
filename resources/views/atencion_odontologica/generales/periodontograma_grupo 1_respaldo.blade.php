                ...
                <div class="col-md-12">
                    <div class="row">
                        ...
                        <div id="#" style="width: 100%">>
                            ...
                            <table id="tabla-superior" class="tabla" style="width: 100%">
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <table id="tabla-5">
                                            <form name ="grafico5" id="grafico5" action="#">
                                                <tr>
                                                    <td class="titulo">Nota</td>
                                                    <td class="borde"><input class="notas" type="text" id="n18" name="n18" tabindex="257"/></td>
                                                    <td class="borde"><input class="notas" type="text" id="n17" name="n17" tabindex="258" /></td>
                                                    <td class="borde"><input class="notas" type="text" id="n16" name="n16" tabindex="259" /></td>
                                                    <td class="borde"><input class="notas" type="text" id="n15" name="n15" tabindex="260" /></td>
                                                    <td class="borde"><input class="notas" type="text" id="n14" name="n14" tabindex="261" /></td>
                                                    <td class="borde"><input class="notas" type="text" id="n13" name="n13" tabindex="262" /></td>
                                                    <td class="borde"><input class="notas" type="text" id="n12" name="n12" tabindex="263" /></td>
                                                    <td class="borde"><input class="notas" type="text" id="n11" name="n11" tabindex="264" /></td>
                                                </tr>
                                                <tr>
                                                    <td class="titulo">Furca</td>
