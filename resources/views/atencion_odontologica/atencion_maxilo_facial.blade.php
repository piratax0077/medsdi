@extends('template.dental.template_maxilo_fac')
...
@section('Content')
    ...
    <div class="pcoded-main-container">
                    ...
                    <div class="row align-items-center pb-2">
                        <div class="col-md-6">
                            <div class="page-header-title">
                                <h5 class="text-white d-inline f-16 mt-1"><strong>ATENCIÓN MAXILO-FACIAL</strong></h5>
                ...
                <div class="col-md-12">
                    <div class="tab-content" id="at-od_impl">
                        ...
                        <div class="tab-pane fade show active" id="atender" role="tabpanel" aria-labelledby="atender-tab">
                            @include('atencion_odontologica.secciones_especialidad.ficha_maxilo_fac')
                        </div>
                        <!--Licencia-->
                        <!--Licencia-->
        ...
        @include("atencion_odontologica.include.sidebar_derecho_od_maxilo_fac"){{-- modales y data de sidebar especialidad --}}
