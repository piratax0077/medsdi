...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	<head>
        ...
        <style>
            ...
            #i21b,#i22b,#i23b,#i24b,#i25b,#i26b,#i27b,#i28b{
                background: url('{{ asset('images/dental/periodontograma/img/periodontograma-oblicuas.png') }}') repeat-x center;
                width: 100%;
                height:18px;
            }
            ...
            #i48,#i47,#i46,#i45,#i44,#i43,#i42,#i41{
                background: url('{{ asset('images/dental/periodontograma/img/periodontograma-oblicuas.png') }}') repeat-x center;
                width: 100%;
                height:18px;
            }
            #diente48-a{
                background: url('{{ asset('images/dental/periodontograma/img/tabla5/periodontograma-dientes-abajo-48.png') }}');
                width:66px;
                background-position: 0 -4px;
                background-repeat: no-repeat;
            }
            #diente47-a{
                background: url('{{ asset('images/dental/periodontograma/img/tabla5/periodontograma-dientes-abajo-47.png') }}');
                width:61px;
                background-position: 0 4px;
                background-repeat: no-repeat;
            }
            #diente46-a{
                background: url('{{ asset('images/dental/periodontograma/img/tabla5/periodontograma-dientes-abajo-46.png') }}');
                width:66px;
                background-position: 0 -1px;
                background-repeat: no-repeat;
            }
            #diente45-a{
                background: url('{{ asset('images/dental/periodontograma/img/tabla5/periodontograma-dientes-abajo-45.png') }}');
                width:44px;
                background-position: 0 1px;
                background-repeat: no-repeat;
            }
            #diente44-a{
                background: url('{{ asset('images/dental/periodontograma/img/tabla5/periodontograma-dientes-abajo-44.png') }}');
                width:42px;
                background-position: 0px 3px;
                background-repeat: no-repeat;
            }
            #diente43-a{
                background: url('{{ asset('images/dental/periodontograma/img/tabla5/periodontograma-dientes-abajo-43.png') }}');
                width:42px;
                background-position: 0 7px;
                background-repeat: no-repeat;
            }
            #diente42-a{
                background: url('{{ asset('images/dental/periodontograma/img/tabla5/periodontograma-dientes-abajo-42.png') }}');
                width:35px;
                background-position: 0px 3px;
                background-repeat: no-repeat;
            }
            #diente41-a{
                background: url('{{ asset('images/dental/periodontograma/img/tabla5/periodontograma-dientes-abajo-41.png') }}');
                width:36px;
                background-position: 0 1px;
                background-repeat: no-repeat;
            }
            ...
            #diente31-a{
                background: url('{{ asset('images/dental/periodontograma/img/tabla6/periodontograma-dientes-abajo-31.png') }}');
                width:37px;
                background-position: 0 1px;
                background-repeat: no-repeat;
            }
            #diente32-a{
                background: url('{{ asset('images/dental/periodontograma/img/tabla6/periodontograma-dientes-abajo-32.png') }}');
                width:37px;
                background-position: 0 3px;
                background-repeat: no-repeat;
            }
            #diente33-a{
                background: url('{{ asset('images/dental/periodontograma/img/tabla6/periodontograma-dientes-abajo-33.png') }}');
                width:41px;
                background-position: 0 7px;
                background-repeat: no-repeat;
            }
            #diente34-a{
                background: url('{{ asset('images/dental/periodontograma/img/tabla6/periodontograma-dientes-abajo-34.png') }}');
                width:42px;
                background-position: 0 5px;
                background-repeat: no-repeat;
            }
            #diente35-a{
                background: url('{{ asset('images/dental/periodontograma/img/tabla6/periodontograma-dientes-abajo-35.png') }}');
                width:44px;
                background-position: 0 1px;
                background-repeat: no-repeat;
            }
            #diente36-a{
                background: url('{{ asset('images/dental/periodontograma/img/tabla6/periodontograma-dientes-abajo-36.png') }}');
                width:66px;
                background-position: top;
                background-repeat: no-repeat;
            }
            #diente37-a{
                background: url('{{ asset('images/dental/periodontograma/img/tabla6/periodontograma-dientes-abajo-37.png') }}');
                width:62px;
                background-position: 0px -4px;
                background-repeat: no-repeat;
            }
            #diente38-a{
                background: url('{{ asset('images/dental/periodontograma/img/tabla6/periodontograma-dientes-abajo-38.png') }}');
                width:66px;
                background-position: 0 -3px;
                background-repeat: no-repeat;
            }
            #i48b,#i47b,#i46b,#i45b,#i44b,#i43b,#i42b,#i41b{
                background: url('{{ asset('images/dental/periodontograma/img/periodontograma-oblicuas.png') }}') repeat-x center;
                width: 100%;
                height:18px;
            }
            ...
            #i31b,#i32b,#i33b,#i34b,#i35b,#i36b,#i37b,#i38b{
                background: url('{{ asset('images/dental/periodontograma/img/periodontograma-oblicuas.png') }}') repeat-x center;
                width: 100%;
                height:18px;
            }
...
<body>
	<div id="contenido">
		<div style="display:none">
			...
			<img src="{{ asset('images/dental/periodontograma/img/tabla5/implantes/periodontograma-dientes-abajo-tornillo-48.png') }}"/>
			<img src="{{ asset('images/dental/periodontograma/img/tabla5/implantes/periodontograma-dientes-abajo-tornillo-47.png') }}"/>
			<img src="{{ asset('images/dental/periodontograma/img/tabla5/implantes/periodontograma-dientes-abajo-tornillo-46.png') }}"/>
			<img src="{{ asset('images/dental/periodontograma/img/tabla5/implantes/periodontograma-dientes-abajo-tornillo-45.png') }}"/>
			<img src="{{ asset('images/dental/periodontograma/img/tabla5/implantes/periodontograma-dientes-abajo-tornillo-44.png') }}"/>
			<img src="{{ asset('images/dental/periodontograma/img/tabla5/implantes/periodontograma-dientes-abajo-tornillo-43.png') }}"/>
			<img src="{{ asset('images/dental/periodontograma/img/tabla5/implantes/periodontograma-dientes-abajo-tornillo-42.png') }}"/>
			<img src="{{ asset('images/dental/periodontograma/img/tabla5/implantes/periodontograma-dientes-abajo-tornillo-41.png') }}"/>
			<img src="{{ asset('images/dental/periodontograma/img/tabla5/tachados/periodontograma-dientes-abajo-tachados-48.png') }}"/>
			<img src="{{ asset('images/dental/periodontograma/img/tabla5/tachados/periodontograma-dientes-abajo-tachados-47.png') }}"/>
			<img src="{{ asset('images/dental/periodontograma/img/tabla5/tachados/periodontograma-dientes-abajo-tachados-46.png') }}"/>
			<img src="{{ asset('images/dental/periodontograma/img/tabla5/tachados/periodontograma-dientes-abajo-tachados-45.png') }}"/>
			<img src="{{ asset('images/dental/periodontograma/img/tabla5/tachados/periodontograma-dientes-abajo-tachados-44.png') }}"/>
			<img src="{{ asset('images/dental/periodontograma/img/tabla5/tachados/periodontograma-dientes-abajo-tachados-43.png') }}"/>
			<img src="{{ asset('images/dental/periodontograma/img/tabla5/tachados/periodontograma-dientes-abajo-tachados-42.png') }}"/>
			<img src="{{ asset('images/dental/periodontograma/img/tabla5/tachados/periodontograma-dientes-abajo-tachados-41.png') }}"/>

			<img src="{{ asset('images/dental/periodontograma/img/tabla6/implantes/periodontograma-dientes-abajo-tornillo-38.png') }}"/>
			<img src="{{ asset('images/dental/periodontograma/img/tabla6/implantes/periodontograma-dientes-abajo-tornillo-37.png') }}"/>
			<img src="{{ asset('images/dental/periodontograma/img/tabla6/implantes/periodontograma-dientes-abajo-tornillo-36.png') }}"/>
			<img src="{{ asset('images/dental/periodontograma/img/tabla6/implantes/periodontograma-dientes-abajo-tornillo-35.png') }}"/>
			<img src="{{ asset('images/dental/periodontograma/img/tabla6/implantes/periodontograma-dientes-abajo-tornillo-34.png') }}"/>
			<img src="{{ asset('images/dental/periodontograma/img/tabla6/implantes/periodontograma-dientes-abajo-tornillo-33.png') }}"/>
			<img src="{{ asset('images/dental/periodontograma/img/tabla6/implantes/periodontograma-dientes-abajo-tornillo-32.png') }}"/>
			<img src="{{ asset('images/dental/periodontograma/img/tabla6/implantes/periodontograma-dientes-abajo-tornillo-31.png') }}"/>
			<img src="{{ asset('images/dental/periodontograma/img/tabla6/tachados/periodontograma-dientes-abajo-tachados-38.png') }}"/>
			<img src="{{ asset('images/dental/periodontograma/img/tabla6/tachados/periodontograma-dientes-abajo-tachados-37.png') }}"/>
			<img src="{{ asset('images/dental/periodontograma/img/tabla6/tachados/periodontograma-dientes-abajo-tachados-36.png') }}"/>
			<img src="{{ asset('images/dental/periodontograma/img/tabla6/tachados/periodontograma-dientes-abajo-tachados-35.png') }}"/>
			<img src="{{ asset('images/dental/periodontograma/img/tabla6/tachados/periodontograma-dientes-abajo-tachados-34.png') }}"/>
			<img src="{{ asset('images/dental/periodontograma/img/tabla6/tachados/periodontograma-dientes-abajo-tachados-33.png') }}"/>
			<img src="{{ asset('images/dental/periodontograma/img/tabla6/tachados/periodontograma-dientes-abajo-tachados-32.png') }}"/>
			<img src="{{ asset('images/dental/periodontograma/img/tabla6/tachados/periodontograma-dientes-abajo-tachados-31.png') }}"/>
			...
			<img src="{{ asset('images/dental/periodontograma/img/tabla7/implantes/periodontograma-dientes-abajo-tornillo-44b.png') }}"/>
			...
			<img src="{{ asset('images/dental/periodontograma/img/tabla7/tachados/periodontograma-dientes-abajo-tachados-44b.png') }}"/>
			...
			<img src="{{ asset('images/dental/periodontograma/img/tabla8/implantes/periodontograma-dientes-abajo-tornillo-35b.png') }}"/>
			...
			<img src="{{ asset('images/dental/periodontograma/img/tabla8/tachados/periodontograma-dientes-abajo-tachados-35b.png') }}"/>
		...
		<div id="wrapper">
			<table id="superior">
				<tr>
					<td style="padding:5px;width:50%;">SUPERIOR</td>
					<td style="padding:5px;width:50%;text-align:center;"><input type="button" style="width:120px;"value="Guardar Datos" onclick="guardardatos();"></td>
				</tr>
			</table>
			<table id="tabla-superior">
				<tr>
						...
						<table id="tabla-1">
							<form name ="grafico1" id="grafico1" action="#">
								...
								<tr>
									...
									<td class="borde"><input type="text" id="m18" name="m18" value="0" tabindex="1" onchange="rangoNumero('m18');"/></td>
									<td class="borde"><input type="text" id="m17" name="m17" value="0" tabindex="2" onchange="rangoNumero('m17')"/></td>
									<td class="borde"><input type="text" id="m16" name="m16" value="0" tabindex="3" onchange="rangoNumero('m16')"/></td>
									<td class="borde"><input type="text" id="m15" name="m15" value="0" tabindex="4" onchange="rangoNumero('m15')"/></td>
									<td class="borde"><input type="text" id="m14" name="m14" value="0" tabindex="5" onchange="rangoNumero('m14')"/></td>
									<td class="borde"><input type="text" id="m13" name="m13" value="0" tabindex="6" onchange="rangoNumero('m13')"/></td>
									<td class="borde"><input type="text" id="m12" name="m12" value="0" tabindex="7" onchange="rangoNumero('m12')"/></td>
									<td class="borde"><input type="text" id="m11" name="m11" value="0" tabindex="8" onchange="rangoNumero('m11')"/></td>
								</tr>
								<tr>
								...
								<tr>
									<td class="titulo">Sangrado / Supuraci&oacute;n</td>
								...
								<tr>
									<td class="titulo">N.I.C.</td>
									<td class="borde"><input type="text" id="ae18" name="ae18" value="" onchange="anchuraValor()" tabindex="33"/></td>
									<td class="borde"><input type="text" id="ae17" name="ae17" value="" onchange="anchuraValor()" tabindex="34"/></td>
									<td class="borde"><input type="text" id="ae16" name="ae16" value="" onchange="anchuraValor()" tabindex="35"/></td>
									<td class="borde"><input type="text" id="ae15" name="ae15" value="" onchange="anchuraValor()" tabindex="36"/></td>
									<td class="borde"><input type="text" id="ae14" name="ae14" value="" onchange="anchuraValor()" tabindex="37"/></td>
									<td class="borde"><input type="text" id="ae13" name="ae13" value="" onchange="anchuraValor()" tabindex="38"/></td>
									<td class="borde"><input type="text" id="ae12" name="ae12" value="" onchange="anchuraValor()" tabindex="39"/></td>
									<td class="borde"><input type="text" id="ae11" name="ae11" value="" onchange="anchuraValor()" tabindex="40"/></td>
								</tr>
								<tr>
									<td class="titulo">LAC  MG</td>
									<td class="borde"><input type="text" id="mg18-a" name="mg18-a" value="0" onchange="cargar18a();getDefectos();rangoNumeroMargen('mg18-a');cargar18a();" tabindex="49"/><input type="text" id="mg18-b" name="mg18-b" value="0" onchange="cargar18a();getDefectos();rangoNumeroMargen('mg18-b');cargar18a();" tabindex="50"/><input type="text" id="mg18-c" name="mg18-c" value="0" onchange="cargar18a();getDefectos();rangoNumeroMargen('mg18-c');cargar18a();" tabindex="51"/></td>
									<td class="borde"><input type="text" id="mg17-a" name="mg17-a" value="0" onchange="cargar17a();getDefectos();rangoNumeroMargen('mg17-a');cargar17a();" tabindex="52"/><input type="text" id="mg17-b" name="mg17-b" value="0" onchange="cargar17a();getDefectos();rangoNumeroMargen('mg17-b');cargar17a();" tabindex="53"/><input type="text" id="mg17-c" name="mg17-c" value="0" onchange="cargar17a();getDefectos();rangoNumeroMargen('mg17-c');cargar17a();" tabindex="54"/></td>
									<td class="borde"><input type="text" id="mg16-a" name="mg16-a" value="0" onchange="cargar16a();getDefectos();rangoNumeroMargen('mg16-a');cargar16a();" tabindex="55"/><input type="text" id="mg16-b" name="mg16-b" value="0" onchange="cargar16a();getDefectos();rangoNumeroMargen('mg16-b');cargar16a();" tabindex="56"/><input type="text" id="mg16-c" name="mg16-c" value="0" onchange="cargar16a();getDefectos();rangoNumeroMargen('mg16-c');cargar16a();" tabindex="57"/></td>
									<td class="borde"><input type="text" id="mg15-a" name="mg15-a" value="0" onchange="cargar15a();getDefectos();rangoNumeroMargen('mg15-a');cargar15a();" tabindex="58"/><input type="text" id="mg15-b" name="mg15-b" value="0" onchange="cargar15a();getDefectos();rangoNumeroMargen('mg15-b');cargar15a();" tabindex="59"/><input type="text" id="mg15-c" name="mg15-c" value="0" onchange="cargar15a();getDefectos();rangoNumeroMargen('mg15-c');cargar15a();" tabindex="60"/></td>
									<td class="borde"><input type="text" id="mg14-a" name="mg14-a" value="0" onchange="cargar14a();getDefectos();rangoNumeroMargen('mg14-a');cargar14a();" tabindex="61"/><input type="text" id="mg14-b" name="mg14-b" value="0" onchange="cargar14a();getDefectos();rangoNumeroMargen('mg14-b');cargar14a();" tabindex="62"/><input type="text" id="mg14-c" name="mg14-c" value="0" onchange="cargar14a();getDefectos();rangoNumeroMargen('mg14-c');cargar14a();" tabindex="63"/></td>
									<td class="borde"><input type="text" id="mg13-a" name="mg13-a" value="0" onchange="cargar13a();getDefectos();rangoNumeroMargen('mg13-a');cargar13a();" tabindex="64"/><input type="text" id="mg13-b" name="mg13-b" value="0" onchange="cargar13a();getDefectos();rangoNumeroMargen('mg13-b');cargar13a();" tabindex="65"/><input type="text" id="mg13-c" name="mg13-c" value="0" onchange="cargar13a();getDefectos();rangoNumeroMargen('mg13-c');cargar13a();" tabindex="66"/></td>
									<td class="borde"><input type="text" id="mg12-a" name="mg12-a" value="0" onchange="cargar12a();getDefectos();rangoNumeroMargen('mg12-a');cargar12a();" tabindex="67"/><input type="text" id="mg12-b" name="mg12-b" value="0" onchange="cargar12a();getDefectos();rangoNumeroMargen('mg12-b');cargar12a();" tabindex="68"/><input type="text" id="mg12-c" name="mg12-c" value="0" onchange="cargar12a();getDefectos();rangoNumeroMargen('mg12-c');cargar12a();" tabindex="69"/></td>
									<td class="borde"><input type="text" id="mg11-a" name="mg11-a" value="0" onchange="cargar11a();getDefectos();rangoNumeroMargen('mg11-a');cargar11a();" tabindex="70"/><input type="text" id="mg11-b" name="mg11-b" value="0" onchange="cargar11a();getDefectos();rangoNumeroMargen('mg11-b');cargar11a();" tabindex="71"/><input type="text" id="mg11-c" name="mg11-c" value="0" onchange="cargar11a();getDefectos();rangoNumeroMargen('mg11-c');cargar11a();" tabindex="72"/></td>
								</tr>
								<tr>
									<td class="titulo">Profundidad de sondaje</td>
									<td class="borde"><input type="text" id="ps18-a" name="ps18-a" value="0" onchange="cargar18a();getDefectos();" tabindex="97"/><input type="text" id="ps18-b" name="ps18-b" value="0" onchange="cargar18a();getDefectos();" tabindex="98"/><input type="text" id="ps18-c" name="ps18-c" value="0" onchange="cargar18a();getDefectos();" tabindex="99"/></td>
									<td class="borde"><input type="text" id="ps17-a" name="ps17-a" value="0" onchange="cargar17a();getDefectos();" tabindex="100"/><input type="text" id="ps17-b" name="ps17-b" value="0" onchange="cargar17a();getDefectos();" tabindex="101"/><input type="text" id="ps17-c" name="ps17-c" value="0" onchange="cargar17a();getDefectos();" tabindex="102"/></td>
									<td class="borde"><input type="text" id="ps16-a" name="ps16-a" value="0" onchange="cargar16a();getDefectos();" tabindex="103"/><input type="text" id="ps16-b" name="ps16-b" value="0" onchange="cargar16a();getDefectos();" tabindex="104"/><input type="text" id="ps16-c" name="ps16-c" value="0" onchange="cargar16a();getDefectos();" tabindex="105"/></td>
									<td class="borde"><input type="text" id="ps15-a" name="ps15-a" value="0" onchange="cargar15a();getDefectos();" tabindex="106"/><input type="text" id="ps15-b" name="ps15-b" value="0" onchange="cargar15a();getDefectos();" tabindex="107"/><input type="text" id="ps15-c" name="ps15-c" value="0" onchange="cargar15a();getDefectos();" tabindex="108"/></td>
									<td class="borde"><input type="text" id="ps14-a" name="ps14-a" value="0" onchange="cargar14a();getDefectos();" tabindex="109"/><input type="text" id="ps14-b" name="ps14-b" value="0" onchange="cargar14a();getDefectos();" tabindex="110"/><input type="text" id="ps14-c" name="ps14-c" value="0" onchange="cargar14a();getDefectos();" tabindex="111"/></td>
									<td class="borde"><input type="text" id="ps13-a" name="ps13-a" value="0" onchange="cargar13a();getDefectos();" tabindex="112"/><input type="text" id="ps13-b" name="ps13-b" value="0" onchange="cargar13a();getDefectos();" tabindex="113"/><input type="text" id="ps13-c" name="ps13-c" value="0" onchange="cargar13a();getDefectos();" tabindex="114"/></td>
									<td class="borde"><input type="text" id="ps12-a" name="ps12-a" value="0" onchange="cargar12a();getDefectos();" tabindex="115"/><input type="text" id="ps12-b" name="ps12-b" value="0" onchange="cargar12a();getDefectos();" tabindex="116"/><input type="text" id="ps12-c" name="ps12-c" value="0" onchange="cargar12a();getDefectos();" tabindex="117"/></td>
									<td class="borde"><input type="text" id="ps11-a" name="ps11-a" value="0" onchange="cargar11a();getDefectos();" tabindex="118"/><input type="text" id="ps11-b" name="ps11-b" value="0" onchange="cargar11a();getDefectos();" tabindex="119"/><input type="text" id="ps11-c" name="ps11-c" value="0" onchange="cargar11a();getDefectos();" tabindex="120"/></td>
								</tr>
								<tr>
									<td class="titulo" style="color:#565A5D">Vestibular</td>
									<td class="noborde">
										<div id="lineas-gr"></div>
										<div id="visualization18a" style="width: 40px; height: 160px;position:absolute;margin:0 0 0 8px;"></div>
										<div id="diente18-a"><div id="furca18"></div></div>
									</td>
									<td class="noborde">
										<div id="visualization17a" style="width: 40px; height: 160px;position:absolute;margin:0 0 0 8px;"></div>
										<div id="diente17-a"><div id="furca17"></div></div>
									</td>
									<td class="noborde">
										<div id="visualization16a" style="width: 55px; height: 160px;position:absolute;margin:0 0 0 3px;"></div>
										<div id="diente16-a"><div id="furca16"></div></div>
									</td>
									<td class="noborde">
										<div id="visualization15a" style="width: 28px; height: 160px;position:absolute;margin:0 0 0 8px;"></div>
										<div id="diente15-a"></div>
									</td>
									<td class="noborde">
										<div id="visualization14a" style="width: 28px; height: 160px;position:absolute;margin:0 0 0 8px;"></div>
										<div id="diente14-a"></div>
									</td>
									<td class="noborde">
										<div id="visualization13a" style="width: 28px; height: 160px;position:absolute;margin:0 0 0 5px;"></div>
										<div id="diente13-a"></div>
									</td>
									<td class="noborde">
										<div id="visualization12a" style="width: 27px; height: 160px;position:absolute;margin:0 0 0 7px;"></div>
										<div id="diente12-a"></div>
									</td>
									<td class="noborde">
										<div id="visualization11a" style="width: 33px; height: 160px;position:absolute;margin:0 0 0 13px;"></div>
					...
					<td>
						<table id="tabla-2">
							<form name ="grafico2" id="grafico2" action="#">
								<tr>
								...
								<tr>
									<td class="borde"><input type="text" id="m21" name="m21" value="0" tabindex="9"  onchange="rangoNumero('m21')"/></td>
									<td class="borde"><input type="text" id="m22" name="m22" value="0" tabindex="10"  onchange="rangoNumero('m22')"/></td>
									<td class="borde"><input type="text" id="m23" name="m23" value="0" tabindex="11"  onchange="rangoNumero('m23')"/></td>
									<td class="borde"><input type="text" id="m24" name="m24" value="0" tabindex="12"  onchange="rangoNumero('m25')"/></td>
									<td class="borde"><input type="text" id="m25" name="m25" value="0" tabindex="13"  onchange="rangoNumero('m26')"/></td>
									<td class="borde"><input type="text" id="m26" name="m26" value="0" tabindex="14"  onchange="rangoNumero('m27')"/></td>
									<td class="borde"><input type="text" id="m27" name="m27" value="0" tabindex="15"  onchange="rangoNumero('m28')"/></td>
									<td class="borde"><input type="text" id="m28" name="m28" value="0" tabindex="16"  onchange="rangoNumero('m29')"/></td>
								</tr>
								<tr>
								...
								<tr>
									<td class="borde"><input type="text" id="ae21" name="ae21" value="" onchange="anchuraValor()" tabindex="41"/></td>
									<td class="borde"><input type="text" id="ae22" name="ae22" value="" onchange="anchuraValor()" tabindex="42"/></td>
									<td class="borde"><input type="text" id="ae23" name="ae23" value="" onchange="anchuraValor()" tabindex="43"/></td>
									<td class="borde"><input type="text" id="ae24" name="ae24" value="" onchange="anchuraValor()" tabindex="44"/></td>
									<td class="borde"><input type="text" id="ae25" name="ae25" value="" onchange="anchuraValor()" tabindex="45"/></td>
									<td class="borde"><input type="text" id="ae26" name="ae26" value="" onchange="anchuraValor()" tabindex="46"/></td>
									<td class="borde"><input type="text" id="ae27" name="ae27" value="" onchange="anchuraValor()" tabindex="47"/></td>
									<td class="borde"><input type="text" id="ae28" name="ae28" value="" onchange="anchuraValor()" tabindex="48"/></td>
								</tr>
								<tr>
									<td class="borde"><input type="text" id="mg21-a" name="mg21-a" value="0" onchange="cargar21a();getDefectos();rangoNumeroMargen('mg21-a');cargar21a();" tabindex="73"/><input type="text" id="mg21-b" name="mg21-b" value="0" onchange="cargar21a();getDefectos();rangoNumeroMargen('mg21-b');cargar21a();" tabindex="74"/><input type="text" id="mg21-c" name="mg21-c" value="0" onchange="cargar21a();getDefectos();rangoNumeroMargen('mg21-c');cargar21a();" tabindex="75"/></td>
									<td class="borde"><input type="text" id="mg22-a" name="mg22-a" value="0" onchange="cargar22a();getDefectos();rangoNumeroMargen('mg22-a');cargar22a();" tabindex="76"/><input type="text" id="mg22-b" name="mg22-b" value="0" onchange="cargar22a();getDefectos();rangoNumeroMargen('mg22-b');cargar22a();" tabindex="77"/><input type="text" id="mg22-c" name="mg22-c" value="0" onchange="cargar22a();getDefectos();rangoNumeroMargen('mg22-c');cargar22a();" tabindex="78"/></td>
									<td class="borde"><input type="text" id="mg23-a" name="mg23-a" value="0" onchange="cargar23a();getDefectos();rangoNumeroMargen('mg23-a');cargar23a();" tabindex="79"/><input type="text" id="mg23-b" name="mg23-b" value="0" onchange="cargar23a();getDefectos();rangoNumeroMargen('mg23-b');cargar23a();" tabindex="80"/><input type="text" id="mg23-c" name="mg23-c" value="0" onchange="cargar23a();getDefectos();rangoNumeroMargen('mg23-c');cargar23a();" tabindex="81"/></td>
									<td class="borde"><input type="text" id="mg24-a" name="mg24-a" value="0" onchange="cargar24a();getDefectos();rangoNumeroMargen('mg24-a');cargar24a();" tabindex="82"/><input type="text" id="mg24-b" name="mg24-b" value="0" onchange="cargar24a();getDefectos();rangoNumeroMargen('mg24-b');cargar24a();" tabindex="83"/><input type="text" id="mg24-c" name="mg24-c" value="0" onchange="cargar24a();getDefectos();rangoNumeroMargen('mg24-c');cargar24a();" tabindex="84"/></td>
									<td class="borde"><input type="text" id="mg25-a" name="mg25-a" value="0" onchange="cargar25a();getDefectos();rangoNumeroMargen('mg25-a');cargar25a();" tabindex="85"/><input type="text" id="mg25-b" name="mg25-b" value="0" onchange="cargar25a();getDefectos();rangoNumeroMargen('mg25-b');cargar25a();" tabindex="86"/><input type="text" id="mg25-c" name="mg25-c" value="0" onchange="cargar25a();getDefectos();rangoNumeroMargen('mg25-c');cargar25a();" tabindex="87"/></td>
									<td class="borde"><input type="text" id="mg26-a" name="mg26-a" value="0" onchange="cargar26a();getDefectos();rangoNumeroMargen('mg26-a');cargar26a();" tabindex="88"/><input type="text" id="mg26-b" name="mg26-b" value="0" onchange="cargar26a();getDefectos();rangoNumeroMargen('mg26-b');cargar26a();" tabindex="89"/><input type="text" id="mg26-c" name="mg26-c" value="0" onchange="cargar26a();getDefectos();rangoNumeroMargen('mg26-c');cargar26a();" tabindex="90"/></td>
									<td class="borde"><input type="text" id="mg27-a" name="mg27-a" value="0" onchange="cargar27a();getDefectos();rangoNumeroMargen('mg27-a');cargar27a();" tabindex="91"/><input type="text" id="mg27-b" name="mg27-b" value="0" onchange="cargar27a();getDefectos();rangoNumeroMargen('mg27-b');cargar27a();" tabindex="92"/><input type="text" id="mg27-c" name="mg27-c" value="0" onchange="cargar27a();getDefectos();rangoNumeroMargen('mg27-c');cargar27a();" tabindex="93"/></td>
									<td class="borde"><input type="text" id="mg28-a" name="mg28-a" value="0" onchange="cargar28a();getDefectos();rangoNumeroMargen('mg28-a');cargar28a();" tabindex="94"/><input type="text" id="mg28-b" name="mg28-b" value="0" onchange="cargar28a();getDefectos();rangoNumeroMargen('mg28-b');cargar28a();" tabindex="95"/><input type="text" id="mg28-c" name="mg28-c" value="0" onchange="cargar28a();getDefectos();rangoNumeroMargen('mg28-c');cargar28a();" tabindex="96"/></td>
								</tr>
								<tr>
									<td class="borde"><input type="text" id="ps21-a" name="ps21-a" value="0" onchange="cargar21a();getDefectos();" tabindex="121"/><input type="text" id="ps21-b" name="ps21-b" value="0" onchange="cargar21a();getDefectos();" tabindex="122"/><input type="text" id="ps21-c" name="ps21-c" value="0" onchange="cargar21a();getDefectos();" tabindex="123"/></td>
									<td class="borde"><input type="text" id="ps22-a" name="ps22-a" value="0" onchange="cargar22a();getDefectos();" tabindex="124"/><input type="text" id="ps22-b" name="ps22-b" value="0" onchange="cargar22a();getDefectos();" tabindex="125"/><input type="text" id="ps22-c" name="ps22-c" value="0" onchange="cargar22a();getDefectos();" tabindex="126"/></td>
									<td class="borde"><input type="text" id="ps23-a" name="ps23-a" value="0" onchange="cargar23a();getDefectos();" tabindex="127"/><input type="text" id="ps23-b" name="ps23-b" value="0" onchange="cargar23a();getDefectos();" tabindex="128"/><input type="text" id="ps23-c" name="ps23-c" value="0" onchange="cargar23a();getDefectos();" tabindex="129"/></td>
									<td class="borde"><input type="text" id="ps24-a" name="ps24-a" value="0" onchange="cargar24a();getDefectos();" tabindex="130"/><input type="text" id="ps24-b" name="ps24-b" value="0" onchange="cargar24a();getDefectos();" tabindex="131"/><input type="text" id="ps24-c" name="ps24-c" value="0" onchange="cargar24a();getDefectos();" tabindex="132"/></td>
									<td class="borde"><input type="text" id="ps25-a" name="ps25-a" value="0" onchange="cargar25a();getDefectos();" tabindex="133"/><input type="text" id="ps25-b" name="ps25-b" value="0" onchange="cargar25a();getDefectos();" tabindex="134"/><input type="text" id="ps25-c" name="ps25-c" value="0" onchange="cargar25a();getDefectos();" tabindex="135"/></td>
									<td class="borde"><input type="text" id="ps26-a" name="ps26-a" value="0" onchange="cargar26a();getDefectos();" tabindex="136"/><input type="text" id="ps26-b" name="ps26-b" value="0" onchange="cargar26a();getDefectos();" tabindex="137"/><input type="text" id="ps26-c" name="ps26-c" value="0" onchange="cargar26a();getDefectos();" tabindex="138"/></td>
									<td class="borde"><input type="text" id="ps27-a" name="ps27-a" value="0" onchange="cargar27a();getDefectos();" tabindex="139"/><input type="text" id="ps27-b" name="ps27-b" value="0" onchange="cargar27a();getDefectos();" tabindex="140"/><input type="text" id="ps27-c" name="ps27-c" value="0" onchange="cargar27a();getDefectos();" tabindex="141"/></td>
									<td class="borde"><input type="text" id="ps28-a" name="ps28-a" value="0" onchange="cargar28a();getDefectos();" tabindex="142"/><input type="text" id="ps28-b" name="ps28-b" value="0" onchange="cargar28a();getDefectos();" tabindex="143"/><input type="text" id="ps28-c" name="ps28-c" value="0" onchange="cargar28a();getDefectos();" tabindex="144"/></td>
								</tr>
								<tr>
									<td class="noborde"><div id="lineas-gr"></div>
										<div id="visualization21a" style="width: 33px; height: 160px;position:absolute;margin:0 0 0 7px;"></div>
										<div id="diente21-a"></div>
									</td>
									<td class="noborde">
										<div id="visualization22a" style="width: 27px; height: 160px;position:absolute;margin:0 0 0 5px;"></div>
										<div id="diente22-a"></div>
									</td>
									<td class="noborde">
										<div id="visualization23a" style="width: 28px; height: 160px;position:absolute;margin:0 0 0 11px;"></div>
										<div id="diente23-a"></div>
									</td>
									<td class="noborde">
										<div id="visualization24a" style="width: 28px; height: 160px;position:absolute;margin:0 0 0 8px;"></div>
										<div id="diente24-a"></div>
									</td>
									<td class="noborde">
										<div id="visualization25a" style="width: 28px; height: 160px;position:absolute;margin:0 0 0 8px;"></div>
										<div id="diente25-a"></div>
									</td>
									<td class="noborde">
										<div id="visualization26a" style="width: 55px; height: 160px;position:absolute;margin:0 0 0 3px;"></div>
										<div id="diente26-a"><div id="furca26"></div></div>
									</td>
									<td class="noborde">
										<div id="visualization27a" style="width: 40px; height: 160px;position:absolute;margin:0 0 0 8px;"></div>
										<div id="diente27-a"><div id="furca27"></div></div>
									</td>
									<td class="noborde">
										<div id="visualization28a" style="width: 40px; height: 160px;position:absolute;margin:0 0 0 8px;"></div>
				...
				<tr>
							...
							<form name ="grafico3" id="grafico3" action="#">
								<tr>
									...
									<td class="noborde"><div id="lineas-gr-inf"></div>
										<div id="visualization18b" style="width: 40px; height: 160px;position:absolute;margin:0 0 0 4px;"></div>
										<div id="diente18b-a"><div id="furca18-a"></div><div id="furca18-b"></div></div>
									</td>
									<td class="noborde">
										<div id="visualization17b" style="width: 40px; height: 160px;position:absolute;margin:0 0 0 7px;"></div>
										<div id="diente17b-a"><div id="furca17-a"></div><div id="furca17-b"></div></div>
									</td>
									<td class="noborde">
										<div id="visualization16b" style="width: 48px; height: 160px;position:absolute;margin:0 0 0 5px;"></div>
										<div id="diente16b-a"><div id="furca16-a"></div><div id="furca16-b"></div></div>
									</td>
									<td class="noborde">
										<div id="visualization15b" style="width: 28px; height: 160px;position:absolute;margin:0 0 0 6px;"></div>
										<div id="diente15b-a"></div>
									</td>
									<td class="noborde">
										<div id="visualization14b" style="width: 28px; height: 160px;position:absolute;margin:0 0 0 9px;"></div>
										<div id="diente14b-a"><div id="furca14-a"></div><div id="furca14-b"></div></div>
									</td>
									<td class="noborde">
										<div id="visualization13b" style="width: 28px; height: 160px;position:absolute;margin:0 0 0 9px;"></div>
										<div id="diente13b-a"></div>
									</td>
									<td class="noborde">
										<div id="visualization12b" style="width: 26px; height: 160px;position:absolute;margin:0 0 0 9px;"></div>
										<div id="diente12b-a"></div>
									</td>
									<td class="noborde">
										<div id="visualization11b" style="width: 33px; height: 160px;position:absolute;margin:0 0 0 4px;"></div>
										<div id="diente11b-a"></div>
									</td>
								</tr>
								<tr>
									<td class="titulo">Profundidad de sondaje</td>
									<td class="borde"><input type="text" id="ps18b-a" name="ps18b-a" value="0" onchange="cargar18b();getDefectos();" tabindex="145"/><input type="text" id="ps18b-b" name="ps18b-b" value="0" onchange="cargar18b();getDefectos();" tabindex="146"/><input type="text" id="ps18b-c" name="ps18b-c" value="0" onchange="cargar18b();getDefectos();" tabindex="147"/></td>
									<td class="borde"><input type="text" id="ps17b-a" name="ps17b-a" value="0" onchange="cargar17b();getDefectos();" tabindex="148"/><input type="text" id="ps17b-b" name="ps17b-b" value="0" onchange="cargar17b();getDefectos();" tabindex="149"/><input type="text" id="ps17b-c" name="ps17b-c" value="0" onchange="cargar17b();getDefectos();" tabindex="150"/></td>
									<td class="borde"><input type="text" id="ps16b-a" name="ps16b-a" value="0" onchange="cargar16b();getDefectos();" tabindex="151"/><input type="text" id="ps16b-b" name="ps16b-b" value="0" onchange="cargar16b();getDefectos();" tabindex="152"/><input type="text" id="ps16b-c" name="ps16b-c" value="0" onchange="cargar16b();getDefectos();" tabindex="153"/></td>
									<td class="borde"><input type="text" id="ps15b-a" name="ps15b-a" value="0" onchange="cargar15b();getDefectos();" tabindex="154"/><input type="text" id="ps15b-b" name="ps15b-b" value="0" onchange="cargar15b();getDefectos();" tabindex="155"/><input type="text" id="ps15b-c" name="ps15b-c" value="0" onchange="cargar15b();getDefectos();" tabindex="156"/></td>
									<td class="borde"><input type="text" id="ps14b-a" name="ps14b-a" value="0" onchange="cargar14b();getDefectos();" tabindex="157"/><input type="text" id="ps14b-b" name="ps14b-b" value="0" onchange="cargar14b();getDefectos();" tabindex="158"/><input type="text" id="ps14b-c" name="ps14b-c" value="0" onchange="cargar14b();getDefectos();" tabindex="159"/></td>
									<td class="borde"><input type="text" id="ps13b-a" name="ps13b-a" value="0" onchange="cargar13b();getDefectos();" tabindex="160"/><input type="text" id="ps13b-b" name="ps13b-b" value="0" onchange="cargar13b();getDefectos();" tabindex="161"/><input type="text" id="ps13b-c" name="ps13b-c" value="0" onchange="cargar13b();getDefectos();" tabindex="162"/></td>
									<td class="borde"><input type="text" id="ps12b-a" name="ps12b-a" value="0" onchange="cargar12b();getDefectos();" tabindex="163"/><input type="text" id="ps12b-b" name="ps12b-b" value="0" onchange="cargar12b();getDefectos();" tabindex="164"/><input type="text" id="ps12b-c" name="ps12b-c" value="0" onchange="cargar12b();getDefectos();" tabindex="165"/></td>
									<td class="borde"><input type="text" id="ps11b-a" name="ps11b-a" value="0" onchange="cargar11b();getDefectos();" tabindex="166"/><input type="text" id="ps11b-b" name="ps11b-b" value="0" onchange="cargar11b();getDefectos();" tabindex="167"/><input type="text" id="ps11b-c" name="ps11b-c" value="0" onchange="cargar11b();getDefectos();" tabindex="168"/></td>
								</tr>
								<tr>
									<td class="titulo">N.I.C</td>
					...
					<td>
						<table id="tabla-4">
							<form name ="grafico4" id="grafico4" action="#">
								<tr>
									<td class="noborde">
										<div id="lineas-gr-inf"></div>
										<div id="visualization21b" style="width: 40px; height: 160px;position:absolute;margin:0 0 0 8px;"></div>
										<div id="diente21b-a"></div>
									</td>
									<td class="noborde">
										<div id="visualization22b" style="width: 40px; height: 160px;position:absolute;margin:0 0 0 4px;"></div>
										<div id="diente22b-a"></div>
									</td>
									<td class="noborde">
										<div id="visualization23b" style="width: 40px; height: 160px;position:absolute;margin:0 0 0 1px;"></div>
										<div id="diente23b-a"></div>
									</td>
									<td class="noborde">
										<div id="visualization24b" style="width: 40px; height: 160px;position:absolute;margin:0 0 0 3px;"></div>
										<div id="diente24b-a">
										<div id="furca24-a"></div><div id="furca24-b"></div></div>
									</td>
									<td class="noborde">
										<div id="visualization25b" style="width: 40px; height: 160px;position:absolute;margin:0 0 0 4px;"></div>
										<div id="diente25b-a"></div>
									</td>
									<td class="noborde">
										<div id="visualization26b" style="width: 48px; height: 160px;position:absolute;margin:0 0 0 11px;"></div>
										<div id="diente26b-a"><div id="furca26-a"></div><div id="furca26-b"></div></div>
									</td>
									<td class="noborde">
										<div id="visualization27b" style="width: 40px; height: 160px;position:absolute;margin:0 0 0 11px;"></div>
										<div id="diente27b-a"><div id="furca27-a"></div><div id="furca27-b"></div></div>
									</td>
									<td class="noborde">
										<div id="visualization28b" style="width: 40px; height: 160px;position:absolute;margin:0 0 0 8px;"></div>
										<div id="diente28b-a"><div id="furca28-a"></div><div id="furca28-b"></div></div>
									</td>
								</tr>
								<tr>
									<td class="borde"><input type="text" id="ps21b-a" name="ps21b-a" value="0" onchange="cargar21b();getDefectos();" tabindex="169"/><input type="text" id="ps21b-b" name="ps21b-b" value="0" onchange="cargar21b();getDefectos();" tabindex="170"/><input type="text" id="ps21b-c" name="ps21b-c" value="0" onchange="cargar21b();getDefectos();" tabindex="171"/></td>
									<td class="borde"><input type="text" id="ps22b-a" name="ps22b-a" value="0" onchange="cargar22b();getDefectos();" tabindex="172"/><input type="text" id="ps22b-b" name="ps22b-b" value="0" onchange="cargar22b();getDefectos();" tabindex="173"/><input type="text" id="ps22b-c" name="ps22b-c" value="0" onchange="cargar22b();getDefectos();" tabindex="174"/></td>
									<td class="borde"><input type="text" id="ps23b-a" name="ps23b-a" value="0" onchange="cargar23b();getDefectos();" tabindex="175"/><input type="text" id="ps23b-b" name="ps23b-b" value="0" onchange="cargar23b();getDefectos();" tabindex="176"/><input type="text" id="ps23b-c" name="ps23b-c" value="0" onchange="cargar23b();getDefectos();" tabindex="177"/></td>
									<td class="borde"><input type="text" id="ps24b-a" name="ps24b-a" value="0" onchange="cargar24b();getDefectos();" tabindex="178"/><input type="text" id="ps24b-b" name="ps24b-b" value="0" onchange="cargar24b();getDefectos();" tabindex="179"/><input type="text" id="ps24b-c" name="ps24b-c" value="0" onchange="cargar24b();getDefectos();" tabindex="180"/></td>
									<td class="borde"><input type="text" id="ps25b-a" name="ps25b-a" value="0" onchange="cargar25b();getDefectos();" tabindex="181"/><input type="text" id="ps25b-b" name="ps25b-b" value="0" onchange="cargar25b();getDefectos();" tabindex="182"/><input type="text" id="ps25b-c" name="ps25b-c" value="0" onchange="cargar25b();getDefectos();" tabindex="183"/></td>
									<td class="borde"><input type="text" id="ps26b-a" name="ps26b-a" value="0" onchange="cargar26b();getDefectos();" tabindex="184"/><input type="text" id="ps26b-b" name="ps26b-b" value="0" onchange="cargar26b();getDefectos();" tabindex="185"/><input type="text" id="ps26b-c" name="ps26b-c" value="0" onchange="cargar26b();getDefectos();" tabindex="186"/></td>
									<td class="borde"><input type="text" id="ps27b-a" name="ps27b-a" value="0" onchange="cargar27b();getDefectos();" tabindex="187"/><input type="text" id="ps27b-b" name="ps27b-b" value="0" onchange="cargar27b();getDefectos();" tabindex="188"/><input type="text" id="ps27b-c" name="ps27b-c" value="0" onchange="cargar27b();getDefectos();" tabindex="189"/></td>
									<td class="borde"><input type="text" id="ps28b-a" name="ps28b-a" value="0" onchange="cargar28b();getDefectos();" tabindex="190"/><input type="text" id="ps28b-b" name="ps28b-b" value="0" onchange="cargar28b();getDefectos();" tabindex="191"/><input type="text" id="ps28b-c" name="ps28b-c" value="0" onchange="cargar28b();getDefectos();" tabindex="192"/></td>
								</tr>
								<tr>
			...
			<table id="inferior">
				<tr>
					<td style="padding:5px;width:50%;">INFERIOR</td>
					<td style="padding:5px;width:50%;text-align:center;"><input type="button" style="width:120px;"value="Guardar Datos" onclick="guardardatos();"></td>
				</tr>
			</table>
			<table id="tabla-superior">
				<tr>
					<td>
						<table id="tabla-5">
							<form name ="grafico5" id="grafico5" action="#">
								...
								<tr>
									<td class="titulo">Profundidad de sondaje</td>
									<td class="borde"><input type="text" id="ps48-a" name="ps48-a" value="0" onchange="cargar48a();getDefectos();" tabindex="345"/><input type="text" id="ps48-b" name="ps48-b" value="0" onchange="cargar48a();getDefectos();" tabindex="346"/><input type="text" id="ps48-c" name="ps48-c" value="0" onchange="cargar48a();getDefectos();" tabindex="347"/></td>
									<td class="borde"><input type="text" id="ps47-a" name="ps47-a" value="0" onchange="cargar47a();getDefectos();" tabindex="348"/><input type="text" id="ps47-b" name="ps47-b" value="0" onchange="cargar47a();getDefectos();" tabindex="349"/><input type="text" id="ps47-c" name="ps47-c" value="0" onchange="cargar47a();getDefectos();" tabindex="350"/></td>
									<td class="borde"><input type="text" id="ps46-a" name="ps46-a" value="0" onchange="cargar46a();getDefectos();" tabindex="351"/><input type="text" id="ps46-b" name="ps46-b" value="0" onchange="cargar46a();getDefectos();" tabindex="352"/><input type="text" id="ps46-c" name="ps46-c" value="0" onchange="cargar46a();getDefectos();" tabindex="353"/></td>
									<td class="borde"><input type="text" id="ps45-a" name="ps45-a" value="0" onchange="cargar45a();getDefectos();" tabindex="354"/><input type="text" id="ps45-b" name="ps45-b" value="0" onchange="cargar45a();getDefectos();" tabindex="355"/><input type="text" id="ps45-c" name="ps45-c" value="0" onchange="cargar45a();getDefectos();" tabindex="356"/></td>
									<td class="borde"><input type="text" id="ps44-a" name="ps44-a" value="0" onchange="cargar44a();getDefectos();" tabindex="357"/><input type="text" id="ps44-b" name="ps44-b" value="0" onchange="cargar44a();getDefectos();" tabindex="358"/><input type="text" id="ps44-c" name="ps44-c" value="0" onchange="cargar44a();getDefectos();" tabindex="357"/></td>
									<td class="borde"><input type="text" id="ps43-a" name="ps43-a" value="0" onchange="cargar43a();getDefectos();" tabindex="400"/><input type="text" id="ps43-b" name="ps43-b" value="0" onchange="cargar43a();getDefectos();" tabindex="401"/><input type="text" id="ps43-c" name="ps43-c" value="0" onchange="cargar43a();getDefectos();" tabindex="402"/></td>
									<td class="borde"><input type="text" id="ps42-a" name="ps42-a" value="0" onchange="cargar42a();getDefectos();" tabindex="403"/><input type="text" id="ps42-b" name="ps42-b" value="0" onchange="cargar42a();getDefectos();" tabindex="404"/><input type="text" id="ps42-c" name="ps42-c" value="0" onchange="cargar42a();getDefectos();" tabindex="405"/></td>
									<td class="borde"><input type="text" id="ps41-a" name="ps41-a" value="0" onchange="cargar41a();getDefectos();" tabindex="406"/><input type="text" id="ps41-b" name="ps41-b" value="0" onchange="cargar41a();getDefectos();" tabindex="407"/><input type="text" id="ps41-c" name="ps41-c" value="0" onchange="cargar41a();getDefectos();" tabindex="408"/></td>
								</tr>
								<tr>
									<td class="titulo" style="color:#565A5D">Lingual</td>
									<td class="noborde">
									<div id="lineas-gr"></div>
									<div id="visualization48a" style="width: 48px; height: 160px;position:absolute;margin:0 0 0 7px;"></div>
									<div id="diente48-a"><div id="furca48"></div></div></td>
									<td class="noborde">
									<div id="visualization47a" style="width: 43px; height: 160px;position:absolute;margin:0 0 0 8px;"></div>
									<div id="diente47-a"><div id="furca47"></div></div></td>
									<td class="noborde">
									<div id="visualization46a" style="width: 44px; height: 160px;position:absolute;margin:0 0 0 12px;"></div>
									<div id="diente46-a"><div id="furca46"></div></div></td>
									<td class="noborde">
									<div id="visualization45a" style="width: 23px; height: 160px;position:absolute;margin:0 0 0 8px;"></div>
									<div id="diente45-a"></div></td>
									<td class="noborde">
									<div id="visualization44a" style="width: 25px; height: 160px;position:absolute;margin:0 0 0 8px;"></div>
									<div id="diente44-a"></div></td>
									<td class="noborde">
									<div id="visualization43a" style="width: 23px; height: 160px;position:absolute;margin:0 0 0 8px;"></div>
									<div id="diente43-a"></div></td>
									<td class="noborde">
									<div id="visualization42a" style="width: 17px; height: 160px;position:absolute;margin:0 0 0 8px;"></div>
									<div id="diente42-a"></div></td>
									<td class="noborde">
									<div id="visualization41a" style="width: 18px; height: 160px;position:absolute;margin:0 0 0 8px;"></div>
					...
					<td>
						<table id="tabla-6">
							<form name ="grafico6" id="grafico6" action="#">
								<tr>
								...
								<tr>
									<td class="borde"><input type="text" id="ps31-a" name="ps31-a" value="0" onchange="cargar31a();getDefectos();" tabindex="409"/><input type="text" id="ps31-b" name="ps31-b" value="0" onchange="cargar31a();getDefectos();" tabindex="410"/><input type="text" id="ps31-c" name="ps31-c" value="0" onchange="cargar31a();getDefectos();" tabindex="411"/></td>
									<td class="borde"><input type="text" id="ps32-a" name="ps32-a" value="0" onchange="cargar32a();getDefectos();" tabindex="412"/><input type="text" id="ps32-b" name="ps32-b" value="0" onchange="cargar32a();getDefectos();" tabindex="413"/><input type="text" id="ps32-c" name="ps32-c" value="0" onchange="cargar32a();getDefectos();" tabindex="414"/></td>
									<td class="borde"><input type="text" id="ps33-a" name="ps33-a" value="0" onchange="cargar33a();getDefectos();" tabindex="415"/><input type="text" id="ps33-b" name="ps33-b" value="0" onchange="cargar33a();getDefectos();" tabindex="416"/><input type="text" id="ps33-c" name="ps33-c" value="0" onchange="cargar33a();getDefectos();" tabindex="417"/></td>
									<td class="borde"><input type="text" id="ps34-a" name="ps34-a" value="0" onchange="cargar34a();getDefectos();" tabindex="418"/><input type="text" id="ps34-b" name="ps34-b" value="0" onchange="cargar34a();getDefectos();" tabindex="419"/><input type="text" id="ps34-c" name="ps34-c" value="0" onchange="cargar34a();getDefectos();" tabindex="420"/></td>
									<td class="borde"><input type="text" id="ps35-a" name="ps35-a" value="0" onchange="cargar35a();getDefectos();" tabindex="421"/><input type="text" id="ps35-b" name="ps35-b" value="0" onchange="cargar35a();getDefectos();" tabindex="422"/><input type="text" id="ps35-c" name="ps35-c" value="0" onchange="cargar35a();getDefectos();" tabindex="423"/></td>
									<td class="borde"><input type="text" id="ps36-a" name="ps36-a" value="0" onchange="cargar36a();getDefectos();" tabindex="424"/><input type="text" id="ps36-b" name="ps36-b" value="0" onchange="cargar36a();getDefectos();" tabindex="425"/><input type="text" id="ps36-c" name="ps36-c" value="0" onchange="cargar36a();getDefectos();" tabindex="426"/></td>
									<td class="borde"><input type="text" id="ps37-a" name="ps37-a" value="0" onchange="cargar37a();getDefectos();" tabindex="427"/><input type="text" id="ps37-b" name="ps37-b" value="0" onchange="cargar37a();getDefectos();" tabindex="428"/><input type="text" id="ps37-c" name="ps37-c" value="0" onchange="cargar37a();getDefectos();" tabindex="429"/></td>
									<td class="borde"><input type="text" id="ps38-a" name="ps38-a" value="0" onchange="cargar38a();getDefectos();" tabindex="430"/><input type="text" id="ps38-b" name="ps38-b" value="0" onchange="cargar38a();getDefectos();" tabindex="431"/><input type="text" id="ps38-c" name="ps38-c" value="0" onchange="cargar38a();getDefectos();" tabindex="432"/></td>
								</tr>
								<tr>
									<td class="noborde">
										<div id="lineas-gr"></div>
										<div id="visualization31a" style="width: 23px; height: 160px;position:absolute;margin:0 0 0 8px;"></div>
										<div id="diente31-a"></div>
									</td>
									<td class="noborde">
										<div id="visualization32a" style="width: 22px; height: 160px;position:absolute;margin:0 0 0 9px;"></div>
										<div id="diente32-a"></div>
									</td>
									<td class="noborde">
										<div id="visualization33a" style="width: 25px; height: 160px;position:absolute;margin:0 0 0 8px;"></div>
										<div id="diente33-a"></div>
									</td>
									<td class="noborde">
										<div id="visualization34a" style="width: 22px; height: 160px;position:absolute;margin:0 0 0 11px;"></div>
										<div id="diente34-a"></div>
									</td>
									<td class="noborde">
										<div id="visualization35a" style="width: 25px; height: 160px;position:absolute;margin:0 0 0 10px;"></div>
										<div id="diente35-a"></div>
									</td>
									<td class="noborde">
										<div id="visualization36a" style="width: 50px; height: 160px;position:absolute;margin:0 0 0 8px;"></div>
										<div id="diente36-a"><div id="furca36"></div></div>
									</td>
									<td class="noborde">
										<div id="visualization37a" style="width: 47px; height: 160px;position:absolute;margin:0 0 0 8px;"></div>
										<div id="diente37-a"><div id="furca37"></div></div>
									</td>
									<td class="noborde">
										<div id="visualization38a" style="width: 47px; height: 160px;position:absolute;margin:0 0 0 10px;"></div>
				...
				<tr>
					<td>
						<table id="tabla-7">
							<form name ="grafico7" id="grafico7" action="#">
								<tr>
									<td class="titulo" style="color:#565A5D">Vestibular</td>
									<td class="noborde">
										<div id="lineas-gr-inf"></div>
										<div id="visualization48b" style="width: 48px; height: 160px;position:absolute;margin:0 0 0 5px;"></div>
										<div id="diente48b-a"><div id="furca48b"></div></div>
									</td>
									<td class="noborde">
										<div id="visualization47b" style="width: 43px; height: 160px;position:absolute;margin:0 0 0 10px;"></div>
										<div id="diente47b-a"><div id="furca47b"></div></div>
									</td>
									<td class="noborde">
										<div id="visualization46b" style="width: 44px; height: 160px;position:absolute;margin:0 0 0 13px;"></div>
										<div id="diente46b-a"><div id="furca46b"></div></div>
									</td>
									<td class="noborde">
										<div id="visualization45b" style="width: 23px; height: 160px;position:absolute;margin:0 0 0 13px;"></div>
										<div id="diente45b-a"></div>
									</td>
									<td class="noborde">
										<div id="visualization44b" style="width: 25px; height: 160px;position:absolute;margin:0 0 0 10px;"></div>
										<div id="diente44b-a"></div>
									</td>
									<td class="noborde">
										<div id="visualization43b" style="width: 23px; height: 160px;position:absolute;margin:0 0 0 10px;"></div>
										<div id="diente43b-a"></div>
									</td>
									<td class="noborde">
										<div id="visualization42b" style="width: 17px; height: 160px;position:absolute;margin:0 0 0 11px;"></div>
										<div id="diente42b-a"></div>
									</td>
									<td class="noborde">
										<div id="visualization41b" style="width: 18x; height: 160px;position:absolute;margin:0 0 0 8px;"></div>
										<div id="diente41b-a"></div>
									</td>
								</tr>
								<tr>
									<td class="titulo">Profundidad de sondaje</td>
									<td class="borde"><input type="text" id="ps48b-a" name="ps48b-a" value="0" onchange="cargar48b();getDefectos();" tabindex="433"/><input type="text" id="ps48b-b" name="ps48b-b" value="0" onchange="cargar48b();getDefectos();" tabindex="434"/><input type="text" id="ps48b-c" name="ps48b-c" value="0" onchange="cargar48b();getDefectos();" tabindex="435"/></td>
									<td class="borde"><input type="text" id="ps47b-a" name="ps47b-a" value="0" onchange="cargar47b();getDefectos();" tabindex="436"/><input type="text" id="ps47b-b" name="ps47b-b" value="0" onchange="cargar47b();getDefectos();" tabindex="437"/><input type="text" id="ps47b-c" name="ps47b-c" value="0" onchange="cargar47b();getDefectos();" tabindex="438"/></td>
									<td class="borde"><input type="text" id="ps46b-a" name="ps46b-a" value="0" onchange="cargar46b();getDefectos();" tabindex="439"/><input type="text" id="ps46b-b" name="ps46b-b" value="0" onchange="cargar46b();getDefectos();" tabindex="440"/><input type="text" id="ps46b-c" name="ps46b-c" value="0" onchange="cargar46b();getDefectos();" tabindex="441"/></td>
									<td class="borde"><input type="text" id="ps45b-a" name="ps45b-a" value="0" onchange="cargar45b();getDefectos();" tabindex="442"/><input type="text" id="ps45b-b" name="ps45b-b" value="0" onchange="cargar45b();getDefectos();" tabindex="443"/><input type="text" id="ps45b-c" name="ps45b-c" value="0" onchange="cargar45b();getDefectos();" tabindex="444"/></td>
									<td class="borde"><input type="text" id="ps44b-a" name="ps44b-a" value="0" onchange="cargar44b();getDefectos();" tabindex="445"/><input type="text" id="ps44b-b" name="ps44b-b" value="0" onchange="cargar44b();getDefectos();" tabindex="446"/><input type="text" id="ps44b-c" name="ps44b-c" value="0" onchange="cargar44b();getDefectos();" tabindex="447"/></td>
									<td class="borde"><input type="text" id="ps43b-a" name="ps43b-a" value="0" onchange="cargar43b();getDefectos();" tabindex="448"/><input type="text" id="ps43b-b" name="ps43b-b" value="0" onchange="cargar43b();getDefectos();" tabindex="449"/><input type="text" id="ps43b-c" name="ps43b-c" value="0" onchange="cargar43b();getDefectos();" tabindex="450"/></td>
									<td class="borde"><input type="text" id="ps42b-a" name="ps42b-a" value="0" onchange="cargar42b();getDefectos();" tabindex="451"/><input type="text" id="ps42b-b" name="ps42b-b" value="0" onchange="cargar42b();getDefectos();" tabindex="452"/><input type="text" id="ps42b-c" name="ps42b-c" value="0" onchange="cargar42b();getDefectos();" tabindex="453"/></td>
									<td class="borde"><input type="text" id="ps41b-a" name="ps41b-a" value="0" onchange="cargar41b();getDefectos();" tabindex="454"/><input type="text" id="ps41b-b" name="ps41b-b" value="0" onchange="cargar41b();getDefectos();" tabindex="455"/><input type="text" id="ps41b-c" name="ps41b-c" value="0" onchange="cargar41b();getDefectos();" tabindex="456"/></td>
								</tr>
								<tr>
									<td class="titulo">N.I.C.</td>
								...
								<tr>
									<td class="titulo">Anchura enc&iacute;a</td>
					...
					<td>
						<table id="tabla-8">
							<form name ="grafico8" id="grafico8" action="#">
								<tr>
									<td class="noborde">
										<div id="lineas-gr-inf"></div>
									...
									<td class="noborde">
										...
										<div id="diente36b-a"><div id="furca36b"></div></div>
									</td>
									<td class="noborde">
								...
								<tr>
									<td class="borde"><input type="text" id="ps31b-a" name="ps31b-a" value="0" onchange="cargar31b();getDefectos();" tabindex="457"/><input type="text" id="ps31b-b" name="ps31b-b" value="0" onchange="cargar31b();getDefectos();" tabindex="458"/><input type="text" id="ps31b-c" name="ps31b-c" value="0" onchange="cargar31b();getDefectos();" tabindex="459"/></td>
									<td class="borde"><input type="text" id="ps32b-a" name="ps32b-a" value="0" onchange="cargar32b();getDefectos();" tabindex="460"/><input type="text" id="ps32b-b" name="ps32b-b" value="0" onchange="cargar32b();getDefectos();" tabindex="461"/><input type="text" id="ps32b-c" name="ps32b-c" value="0" onchange="cargar32b();getDefectos();" tabindex="462"/></td>
									<td class="borde"><input type="text" id="ps33b-a" name="ps33b-a" value="0" onchange="cargar33b();getDefectos();" tabindex="463"/><input type="text" id="ps33b-b" name="ps33b-b" value="0" onchange="cargar33b();getDefectos();" tabindex="464"/><input type="text" id="ps33b-c" name="ps33b-c" value="0" onchange="cargar33b();getDefectos();" tabindex="465"/></td>
									<td class="borde"><input type="text" id="ps34b-a" name="ps34b-a" value="0" onchange="cargar34b();getDefectos();" tabindex="466"/><input type="text" id="ps34b-b" name="ps34b-b" value="0" onchange="cargar34b();getDefectos();" tabindex="467"/><input type="text" id="ps34b-c" name="ps34b-c" value="0" onchange="cargar34b();getDefectos();" tabindex="468"/></td>
									<td class="borde"><input type="text" id="ps35b-a" name="ps35b-a" value="0" onchange="cargar35b();getDefectos();" tabindex="469"/><input type="text" id="ps35b-b" name="ps35b-b" value="0" onchange="cargar35b();getDefectos();" tabindex="470"/><input type="text" id="ps35b-c" name="ps35b-c" value="0" onchange="cargar35b();getDefectos();" tabindex="471"/></td>
									<td class="borde"><input type="text" id="ps36b-a" name="ps36b-a" value="0" onchange="cargar36b();getDefectos();" tabindex="472"/><input type="text" id="ps36b-b" name="ps36b-b" value="0" onchange="cargar36b();getDefectos();" tabindex="473"/><input type="text" id="ps36b-c" name="ps36b-c" value="0" onchange="cargar36b();getDefectos();" tabindex="474"/></td>
									<td class="borde"><input type="text" id="ps37b-a" name="ps37b-a" value="0" onchange="cargar37b();getDefectos();" tabindex="475"/><input type="text" id="ps37b-b" name="ps37b-b" value="0" onchange="cargar37b();getDefectos();" tabindex="476"/><input type="text" id="ps37b-c" name="ps37b-c" value="0" onchange="cargar37b();getDefectos();" tabindex="477"/></td>
									<td class="borde"><input type="text" id="ps38b-a" name="ps38b-a" value="0" onchange="cargar38b();getDefectos();" tabindex="478"/><input type="text" id="ps38b-b" name="ps38b-b" value="0" onchange="cargar38b();getDefectos();" tabindex="479"/><input type="text" id="ps38b-c" name="ps38b-c" value="0" onchange="cargar38b();getDefectos();" tabindex="480"/></td>
								</tr>
								<tr>
                        ...
                        <div id="tabla-resultados">
							<table>
								<tr>
									...
									<td>Media de nivel de inserci&oacute;n= <div id="suma5">0</div>mm</td>
...
<script>
	...
	guardardatos = function() {
		...
		datos2 = getElementsByAttribute(document.getElementById("tabla-2"), "*", "id");
		//alert(datos2.length);
		for (var i=0; i<datos2.length; i++) {
			var nombre = datos2[i].id;
			var valor = datos2[i].value;
			var estilo = datos2[i].style.background;
			if (datos2[i].id != undefined) {
				var cajas = [];
				cajas[0]=nombre;
				if (arrstyle.includes(nombre)){
					cajas[1]=estilo;
		...
		datos6 = getElementsByAttribute(document.getElementById("tabla-6"), "*", "id");
		for (var i=0; i<datos6.length; i++) {
			var nombre = datos6[i].id;
			var valor = datos6[i].value;
			var estilo = datos6[i].style.background;
			if (datos6[i].id != undefined) {
				var cajas = [];
				cajas[0]=nombre;
				if (arrstyle.includes(nombre)){
					cajas[1]=estilo;
		...
		datos8 = getElementsByAttribute(document.getElementById("tabla-8"), "*", "id");
		for (var i=0; i<datos8.length; i++) {
			var nombre = datos8[i].id;
			var valor = datos8[i].value;
			var estilo = datos8[i].style.background;
			if (datos8[i].id != undefined) {
				var cajas = [];
				cajas[0]=nombre;
				if (arrstyle.includes(nombre)){
					cajas[1]=estilo;
