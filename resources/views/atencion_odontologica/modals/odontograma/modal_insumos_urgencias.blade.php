        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        <label for="tipoInsumo_urg" class="floating-label-activo-sm">Tipo de Insumo</label>
                        <select name="tipoInsumo_urg" id="tipoInsumo_urg" class="form-control form-control-sm" onchange="dame_marcas_implantes_urgencias(this)">
                    ...
                    <div class="col-md-4" id="insumos_select">
                        <div class="form-group">
                        <label for="nombreInsumo_urg" class="floating-label-activo-sm" id="titulo_tipo_insumo">Insumos</label>
                        <select name="nombreInsumo_urg" data-titulo="Ex_cuello" data-seccion="Cuello" id="nombreInsumo_urg" class="form-control form-control-sm">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <input type="number" name="cantidad_urg" id="cantidad_urg" class="form-control form-control-sm">
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                            <label for="" class="floating-label-activo-sm">Valor</label>
                            <input type="number" name="precio_urg" id="precio_urg" class="form-control form-control-sm">
                        </div>
                    </div>
                    <div class="col-md-2">
                    <div class="form-group">
