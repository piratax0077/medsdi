    <!--Sidebar 3 (dental_endodon)-->
    <div class="position-fixed w-100 h-100"></div>
    <div id="formularios_endodoncia" class="bs-canvas bs-canvas-anim bs-canvas-right position-fixed bg-light h-100 shadow-lg" data-width="370px" data-offset="true">
