<div class="row">
    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
        <div class="form-row">
            ...
            <div class="col-sm-12">
                <div class="form-group">
                    <button type="button" class="btn btn-outline-danger btn-sm btn-icon" onclick="ocultar_grupo_dental_post_impl()">X</button>
                    <button type="button" class="btn btn-icon btn-primary-light-c" onclick="guardar_grupo_dental_post_impl({{ $counter }})"><i class="fas fa-save"></i></button>
                </div>
            </div>
        </div>
