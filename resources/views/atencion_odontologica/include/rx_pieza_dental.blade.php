    ...
    <div class="form-row">
        <div class="col-sm-12 col-md-2 col-lg-2 col-xl-2">
            <div class="form-group">
                ...
                <input class="form-control form-control-sm" type="text" name="rx_numero_pieza{{ $counter }}" id="rx_numero_pieza{{ $counter }}">
            </div>
        </div>
    ...
    <div class="form-row" id="contenedor_piezas_ex_oral">
        ...
        <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
            <div class="form-group">
                ...
                <textarea class="form-control caja-texto form-control-sm" rows="1"  data-tipo="general" onfocus="this.rows=2" onblur="this.rows=1;" name="obs_ex_oral{{ $counter }}" id="obs_ex_oral{{ $counter }}"></textarea>
            </div>
        </div>
    </div>
