...
<div class="form-row">
            ...
            <div class="card-footer">
                ...
                <div class="form-row">
                    <div class="col-sm-12 mt-2">
                        ...
                        <button type="button" class="btn btn-icon btn-danger-light-c" onclick="eliminar_pieza_dental_imagenes_impl({{ $imagen->id }})">X</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-sm-4 mt-2" >
        <div class="form-group fill">
            <input type="check" name="biopsia_check_implantologia" id="biopsia_check_implantologia" value="">
            <div class="switch switch-success d-inline m-r-10">
                <input type="checkbox" onchange="biopsia_check_implantologia({{ $count }})" id="biopsia_check_implantologia" name="biopsia_check_implantologia" value="" >
            ...
            <div class="form-group fill">
                ...
                <textarea class="form-control form-control-sm" rows="1" onfocus="this.rows=2" onblur="this.rows=1;" name="im_biop_zona" id="im_biop_zona"></textarea>
            </div>
            <div class="form-group fill">
                <label id="" name="" class="floating-label-activo-sm">Observaciones y Resultado</label>
                <textarea class="form-control form-control-sm" rows="1" onfocus="this.rows=3" onblur="this.rows=1;" name="im_obs_result_biopsia" id="im_obs_result_biopsia"></textarea>
            </div>
            <hr>
