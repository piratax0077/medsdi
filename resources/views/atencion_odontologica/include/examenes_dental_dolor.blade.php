        ...
        <div class="form-row">
            ...
            <div class="col-sm-12 col-md-2 col-lg-2 col-xl-2">
                <div class="form-group">
                    ...
                    <select name="tipo_dolor{{ $counter }}" id="tipo_dolor{{ $counter }}" class="form-control form-control-sm" onchange="evaluar_para_carga_detalle('tipo_dolor{{ $counter }}','div_tipo_dolor{{ $counter }}','obs_tipo_dolor{{ $counter }}',3);">
                ...
                <div class="form-group" id="div_tipo_dolor{{ $counter }}" style="display:none;">
                    <label class="floating-label-activo-sm">Tipo de dolor</label>
                    <textarea class="form-control form-control-sm"   rows="1"  onfocus="this.rows=3" onblur="this.rows=1;" name="obs_tipo_dolor{{ $counter }}" id="obs_tipo_dolor{{ $counter }}"></textarea>
                </div>
            </div>
            <div class="col-sm-12 col-md-2 col-lg-2 col-xl-2">
                <div class="form-group">
            ...
            <div class="col-sm-12 col-md-2 col-lg-2 col-xl-2">
                <div class="form-group">
                    ...
                    <select name="provocacion_dolor" data-titulo="General_endodoncia" data-seccion="General_endodoncia"  id="provocacion_dolor{{ $counter }}" class="form-control form-control-sm" onchange="evaluar_para_carga_detalle('provocacion_dolor{{ $counter }}','div_provocacion_dolor{{ $counter }}','obs_provocacion_dolor{{ $counter }}',5);">
        ...
        <div class="form-row">
            <div class="col-sm-12 col-md-3 col-lg-3 col-xl-3">
                <div class="form-group">
                    ...
                    <select name="cdo_duele{{ $counter }}"  id="cdo_duele{{ $counter }}" class="form-control form-control-sm" onchange="evaluar_para_carga_detalle('cdo_duele{{ $counter }}','div_cdo_duele{{ $counter }}','obs_cdo_duele{{ $counter }}',3);">
                ...
                <div class="form-group" id="div_cdo_duele{{ $counter }}" style="display:none;">
                    <label class="floating-label-activo-sm">Cuando duele</label>
                    <textarea class="form-control form-control-sm"   rows="1"  onfocus="this.rows=3" onblur="this.rows=1;" name="obs_cdo_duele{{ $counter }}" id="obs_cdo_duele{{ $counter }}"></textarea>
                </div>
            </div>
            <div class="col-sm-12 col-md-3 col-lg-3 col-xl-3">
                <div class="form-group">
                    <label class="floating-label-activo-sm">Tpo Evolución</label>
                    <select name="tpo_evolucion{{ $counter }}"  id="tpo_evolucion{{ $counter }}" class="form-control form-control-sm" onchange="evaluar_para_carga_detalle('tpo_evolucion{{ $counter }}','div_tpo_evolucion{{ $counter }}','obs_tpo_evolucion{{ $counter }}',3);">
                ...
                <div class="form-group" id="div_tpo_evolucion{{ $counter }}" style="display:none;">
                    <label class="floating-label-activo-sm">Tpo Evolución</label>
                    <textarea class="form-control form-control-sm"  rows="1"  onfocus="this.rows=3" onblur="this.rows=1;" name="obs_tpo_evolucion{{ $counter }}" id="obs_tpo_evolucion{{ $counter }}"></textarea>
                </div>
            </div>
            <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                <div class="form-group">
                    <label class="floating-label-activo-sm">Efecto Analgésicos</label>
                    <textarea class="form-control form-control-sm"  rows="1"  onfocus="this.rows=3" onblur="this.rows=1;" name="obs_anal_dolor{{ $counter }}" id="obs_anal_dolor{{ $counter }}"></textarea>
                </div>
            </div>
            <div class="col-sm-12 col-md-2 col-lg-2 col-xl-2">
