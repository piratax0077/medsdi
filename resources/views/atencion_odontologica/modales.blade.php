    ...
    <div class="col-sm-12">
        <div class="boton-formularios">
            ...
            <div class="redes">
                ...
                @endif  --}}
                    @if($profesional->Especialidad()->first()->nombre == 'TECNICO ODONTOLOGICO (TONS)' )
                    <a id="boton_3" class="fas fa-bezier-curve fa-2x" data-toggle="canvas" data-target="#tons" aria-expanded="false" aria-controls="bs-canvas-right" title="Formularios Enfermera Universitaria" data-placement="left"></a>
                    @endif
                    @if($profesional->TipoEspecialidad()->first())
                    @if($profesional->TipoEspecialidad()->first()->nombre == 'ODONTOPEDIATRÍA' )
                        <a id="boton_3" class="fas fa-child fa-2x" data-toggle="canvas" data-target="#formularios_odontopediatria" aria-expanded="false" aria-controls="bs-canvas-right" title="Formularios Odonto-pediatria" data-placement="left"></a>
                    @endif
                    {{--  @if($profesional->TipoEspecialidad()->first()->nombre == 'Implantología' )
                        <a id="boton_3" class="fas fa-child fa-2x" data-toggle="canvas" data-target="#formularios_implantologia" aria-expanded="false" aria-controls="bs-canvas-right" title="Formularios Pediatria" data-placement="left"></a>
                    @endif  --}}
                    @if($profesional->TipoEspecialidad()->first()->nombre == 'IMPLANTOLOGÍA' )
                        <a id="boton_3" class="fab fas fa-tooth fa-2x" data-toggle="canvas" data-target="#formularios_implantologia" aria-expanded="false" aria-controls="bs-canvas-right" title="Formularios Implantología" data-placement="left"></a>
                    @endif

                    @if($profesional->TipoEspecialidad()->first()->nombre == 'PERIODÓNCIA' )
                        <a id="boton_3" class="fas fa-bezier-curve fa-2x" data-toggle="canvas" data-target="#formularios_periodoncia" aria-expanded="false" aria-controls="bs-canvas-right" title="Formularios Periodoncia" data-placement="left"></a>
                    @endif
                    @if($profesional->TipoEspecialidad()->first()->nombre == 'ORTODÓNCIA' )
                    <a id="boton_3" class="fas fa-code-branch fa-2x" data-toggle="canvas" data-target="#formularios_ortodoncia" aria-expanded="false" aria-controls="bs-canvas-right" title="Formularios Ortodóncia" data-placement="left"></a>
                    @endif
                    ...
                    @endif
                    @if($profesional->TipoEspecialidad()->first()->nombre == 'ENDODÓNCIA' )
                        <a id="boton_3" class="fas fa-bezier-curve fa-2x" data-toggle="canvas" data-target="#formularios_endodoncia" aria-expanded="false" aria-controls="bs-canvas-right" title="Formularios Endodóncia" data-placement="left"></a>
                    @endif
                    @if($profesional->TipoEspecialidad()->first()->nombre == 'REHABILITADOR ORAL' )
                        <a id="boton_3" class="fas fa-child fa-2x" data-toggle="canvas" data-target="#formularios_odonto_protesis" aria-expanded="false" aria-controls="bs-canvas-right" title="Formularios Rehabilitación" data-placement="left"></a>
                    @endif
                    @if($profesional->TipoEspecialidad()->first()->nombre == 'ESPECIALIDAD EN TTM' )
                    <a id="boton_3" class="fas fa-child fa-2x" data-toggle="canvas" data-target="#formularios_ttm" aria-expanded="false" aria-controls="bs-canvas-right" title="Formularios Trans-Temporomandibulares" data-placement="left"></a>
                    @endif
                    @if($profesional->TipoEspecialidad()->first()->nombre == 'CIRUGÍA MAXILOFACIAL' )
                    <a id="boton_3" class="fas fa-child fa-2x" data-toggle="canvas" data-target="#formularios_maxilo_facial" aria-expanded="false" aria-controls="bs-canvas-right" title="Formularios Cirug{ia Maxilo-facial}" data-placement="left"></a>
                    @endif
                @endif
            </div>
            <div class="btn-mas">
