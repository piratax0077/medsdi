<!--Sidebar 3 (cirugia pediatrica)-->
<div class="position-fixed w-100 h-100"></div>
<div id="formularios_cir_pediatria" class="bs-canvas bs-canvas-anim bs-canvas-right position-fixed bg-light h-100 shadow-lg" data-width="370px" data-offset="true">
    <header class="bs-canvas-header p-3 bg-info overflow-auto">
        ...
        <h5 class="d-inline-block text-light mb-0 float-right">Formularios Especialidad Cirugía Pediátrica</h5>
    </header>
