                                            ...
                                            <div class="card">
                                                ...
                                                <div id="exam_esp_c" class="collapse" aria-labelledby="exam_esp" data-parent="#exam_esp">
                                                    <div class="card-body-aten shadow-none">
                                                        ...
                                                        <div class="form-row" id="form-gineco_obst">
                                                            <div class="col-sm-12 col-md-12 col-lg-12">
                                                                <h5 class="text-c-blue mb-2">FICHA DE ATENCIÓN OBSTÉTRICA</h5>
                                                            </div>
                                                            <div class="col-sm-12 col-md-12 col-lg-12">
                                                                <h6 class="mb-3">Antecedentes generales</h6>
                                                            </div>
                                                            <div class="col-sm-12 col-md-12 col-lg-12">
                                                                <div class="form-group">
                                                            ...
                                                            <div class="col-sm-12 col-md-12 col-lg-12">
                                                                <h6 class="mb-2">Antecedentes obstétricos</h6>
                                                            </div>
                                                            <div class="col-sm-12 col-md-3 col-lg-3">
                                                                <button type="button" class="btn btn-outline-primary btn-sm btn-block mb-2" onclick="embarazos();"></i>Embarazos Anteriores</button>
                                                            </div>
                                                            <div class="col-sm-12 col-md-3 col-lg-3">
                                                                <button type="button" class="btn btn-outline-primary btn-sm btn-block mb-2" onclick="riesgo_emb();"></i>Factores de Riesgo</button>
                                                            </div>
                                                            <div class="col-sm-12 col-md-3 col-lg-3">
                                                        ...
                                                        <div class="form-row">
                                                            <div class="col-sm-12 col-md-12 col-lg-12">
                                                                <h5 class="text-c-blue mb-3">EXAMEN GINECOLÓGICO</h5>
                                                            </div>
                                                            <div class="col-sm-12 col-md-6 col-lg-6">
                                                                 <div class="form-group">
                                                            ...
                                                            <div class="col-sm-12 col-md-6 col-lg-6">
                                                                <button type="button" class="btn btn-outline-primary btn-block btn-sm mb-2"  onclick="ex_pap();">PAP</button>
                                                            </div>
                                                            <div class="col-sm-12 col-md-6 col-lg-6">
                                                        ...
                                                        <div class="form-row">
                                                            <div class="col-sm-12 col-md-12 col-lg-12">
                                                                <h5 class="text-c-blue mb-2">MAMAS</h5>
                                                            </div>
                                                            <div class="col-sm-12 col-md-3 col-lg-3">
                                                                <button type="button" class="btn btn-outline-primary btn-block btn-sm mt-2" onclick="ex_mamas();">Ex. mamas</button>
                                                            </div>
                                                            <div class="col-sm-12 col-md-9 col-lg-9">
                                                                <textarea class="form-control caja-texto form-control-sm mt-1" rows="1"  onfocus="this.rows=6" onblur="this.rows=1;" name="ex_mamas_obs" id="ex_mamas_obs"></textarea>
                                                            </div>
                                                        </div>
                                                        <hr>
                                                        <!--OTROS-->
                                                        <div class="form-row">
                                                            <div class="form-group col-md-12">
                                                                ...
                                                                <textarea class="form-control caja-texto form-control-sm" data-titulo="Observaciones Examen Auditívo" rows="1"  onfocus="this.rows=4" onblur="this.rows=1;" name="obs_ex_oidos" id="obs_ex_oidos"></textarea>
                                                            </div>
                                                            ...
                                                            <div class="form-group col-md-3 align-middle">
                                                                <button type="button" class="btn btn-outline-primary btn-sm btn-block" onclick="abrir_modal_guardar_tipo();"><i class="fas fa-save"></i> Guardar nueva ficha tipo</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-sm-12 col-md-12">
                                            <div class="card">
                                                <div class="card-header" id="signosvit-otros">
                                                    <button class="accor-open btn pt-1 pb-0 pl-1 btn-block text-left card-act-open collapsed" type="button" data-toggle="collapse" data-target="#signosvit-otros-c" aria-expanded="false" aria-controls="signosvit-otros-c">
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="exam_esp_c" class="collapse" aria-labelledby="exam_esp" data-parent="#exam_esp">
                                                    <div class="card-body-aten shadow-none">
                                                        ...
                                                        <div class="form-row">
                                                            <div class="col-sm-12 col-md-12 col-lg-12">
                                                                <h5 class="text-c-blue mb-2">EXAMEN GINECOLÓGICO</h5>
                                                            </div>
                                                            <div class="col-sm-12 col-md-4 col-lg-4">
                                                                <div class="form-group">
                                                                    <button type="button" class="btn btn-outline-primary btn-block btn-sm" onclick="eco_obst();">Ecografía</button>
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-12 col-md-4 col-lg-4">
                                                                <div class="form-group">
                                                        ...
                                                        <div class="form-row">
                                                            ...
                                                            <div class="col-sm-12 col-md-4 col-lg-4">
                                                                <button type="button" class="btn btn-outline-primary btn-block btn-sm" onclick="ex_mamas()">Ex. mamas</button>
                                                            </div>
                                                            <div class="col-sm-12 col-md-8 col-lg-8">
                                                                <div class="form-group">
                                                                    <textarea class="form-control caja-texto form-control-sm" rows="1"  onfocus="this.rows=6" onblur="this.rows=1;" name="ex_mamas_1" id="ex_mamas_1"></textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <hr>
                        ...
                        <div class="tab-pane fade " id="atencion-obst" role="tabpanel" aria-labelledby="atencion-obst-tab">
                            <div class="row bg-white shadow-sm rounded mx-1">
                                <div class="col-md-12">
                                    ...
                                    <!--Formulario: Paciente Menor de edad-->
                                    <div class="row">
                                        <div class="col-sm-12 col-md-12">
                                            <div class="card">
                                                <div class="card-header" id="menor-obt">
                                                    <button class="accor-closed btn pt-1 pb-0 pl-1 btn-block text-left card-act-open collapsed" type="button" data-toggle="collapse" data-target="#menor-obt-c" aria-expanded="false" aria-controls="menor-obt-c">
                                                       Paciente menor de edad
                                                    </button>
                                                </div>
                                                <div id="menor-obt-c" class="collapse" aria-labelledby="menor-obt" data-parent="#menor-obt">
                                                    <div class="card-body-aten shadow-none">
                                                        <form>
                                    ...
                                    <!--Formulario: Motivo de consulta-->
                                     <div class="row">
                                        <div class="col-sm-12 col-md-12">
                                            <div class="card">
                                                <div class="card-header" id="motivo-c-obt">
                                                    <button class="accor-closed btn pt-1 pb-0 pl-1 btn-block text-left card-act-open collapsed" type="button" data-toggle="collapse" data-target="#motivo-c-obt-c" aria-expanded="false" aria-controls="motivo-c-obt-c">
                                                        Motivo de consulta
                                                    </button>
                                                </div>
                                                <div id="motivo-c-obt-c" class="collapse" aria-labelledby="motivo-c-obt" data-parent="#motivo-c-obt">
                                                    <div class="card-body-aten shadow-none">
                                                        <form>
                                                            <div class="form-row">
                                    ...
                                    <!--Formulario: Antecedentes obstétricos-->
                                     <div class="row">
                                        <div class="col-sm-12 col-md-12">
                                            <div class="card">
                                                <div class="card-header" id="ant-o-obt">
                                                    <button class="accor-closed btn pt-1 pb-0 pl-1 btn-block text-left card-act-open collapsed" type="button" data-toggle="collapse" data-target="#ant-o-obt-c" aria-expanded="false" aria-controls="ant-o-obt-c">
                                                        Antecedentes obstétricos
                                                    </button>
                                                </div>
                                                <div id="ant-o-obt-c" class="collapse" aria-labelledby="ant-o-obt" data-parent="#ant-o-obt">
                                                    <div class="card-body-aten shadow-none">
                                                        <form>
                                                            <div class="form-row">
                                                                <div class="col-sm-12 col-md-3 col-lg-3">
                                                                    <button type="button" class="btn btn-outline-primary btn-sm btn-block mb-3" onclick="embarazos();"></i>Embarazos Anteriores</button>
                                                                </div>
                                                                <div class="col-sm-12 col-md-3 col-lg-3">
                                                                    <button type="button" class="btn btn-outline-primary btn-sm btn-block mb-3" onclick="riesgo_emb();"></i>Factores de Riesgo</button>
                                                                </div>
                                                                <div class="col-sm-12 col-md-3 col-lg-3">
                                                                    <button type="button" class="btn btn-outline-primary btn-sm btn-block mb-3" onclick="mamas_ant();"></i>Mamas</button>
                                                                </div>
                                                                <div class="col-sm-12 col-md-3 col-lg-3">
                                                                    <button type="button" class="btn btn-outline-primary btn-sm btn-block mb-3" onclick="hormonas();"></i>Ex. Hormonales</button>
                                                                </div>
                                                            </div>
                                                        </form>
                                                    </div>
                                    ...
                                    <!--Formulario: exámen ginecológico-->
                                    <div class="row">
                                        <div class="col-sm-12 col-md-12">
                                            <div class="card">
                                                <div class="card-header" id="ex-ginec">
                                                    <button class="accor-closed btn pt-1 pb-0 pl-1 btn-block text-left card-act-open collapsed" type="button" data-toggle="collapse" data-target="#ex-ginec-c" aria-expanded="false" aria-controls="mex-ginec-c">
                                                        Exámen ginecológico
                                                    </button>
                                                </div>
                                                <div id="ex-ginec-c" class="collapse" aria-labelledby="ex-ginec" data-parent="#ex-ginec">
                                                    <div class="card-body-aten shadow-none">
                                                        <form>
                                                            <div class="form-row">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 col-md-12">
                                            <div class="card">
                                                <div class="card-header" id="mamas-obt">
                                                    <button class="accor-closed btn pt-1 pb-0 pl-1 btn-block text-left card-act-open collapsed" type="button" data-toggle="collapse" data-target="#mamas-obt-c" aria-expanded="false" aria-controls="mamas-obt-c">
                                                        Mamas
                                                    </button>
                                                </div>
                                                <div id="mamas-obt-c" class="collapse" aria-labelledby="mamas-obt" data-parent="#mamas-obt">
                                                    <div class="card-body-aten shadow-none">
                                                        <form>
                                                            <div class="form-row">
                                                                <div class="form-group col-sm-12 col-md-4 col-lg-4">
                                    ...
                                    <!--Formulario: Diagnóstico-->
                                     <div class="row">
                                        <div class="col-sm-12 col-md-12">
                                            <div class="card">
                                                <div class="card-header" id="diagnostico-obt">
                                                    <button class="accor-closed btn pt-1 pb-0 pl-1 btn-block text-left card-act-open collapsed" type="button" data-toggle="collapse" data-target="#diagnostico-obt-c" aria-expanded="false" aria-controls="diagnostico-obt-c">
                                                        Diagnóstico
                                                    </button>
                                                </div>
                                                <div id="diagnostico-obt-c" class="collapse" aria-labelledby="diagnostico-obt" data-parent="#diagnostico-obt">
                                                    <div class="card-body-aten shadow-none">
                                                        <div class="form-row">
                                                            <div class="form-group col-md-4">
                                                                <label class="floating-label-activo-sm">Hipótesis diagnóstica</label>
...
@include('atencion_pediatrica.formularios.modal_atencion_especialidad.gineco_obst.modal_embarazos')
