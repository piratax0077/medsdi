                            ...
                            <div class="row bg-white shadow-none rounded mx-1">
                                <div class="col-md-12">
                                    ...
                                    <div class="row">-->
                                        ...
                                        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                            <div class="card">
                                                <div class="card-header" id="oral">
                                                    <button class="accor-closed btn card-act-open pt-1 pb-0 pl-1 btn-block text-left collapsed" type="button" data-toggle="collapse" data-target="#oral_c" aria-expanded="false" aria-controls="oral_c">
                                                        Oral
                                                    </button>
                                                </div>
                                                <div id="oral_c" class="collapse" aria-labelledby="oral" data-parent="#oral">
                                                    <div class="card">
                                                        <div class="card-body-aten shadow-none">
                                                            <table id="res-config" class="display table table-striped table-xs dt-responsive nowrap table-bordered" style="width:100%">
                                                                <thead>
                                                                    <tr>
                                                                        <th>Medicamento</th>
                                                                        <th>Hora</th>
                                                                ...
                                                                <tbody>
                                                                    <tr class="align-middle">
                                                                        ...
                                                                        <td><textarea class="form-control form-control-sm caja-texto " rows="1" onfocus="this.rows=4" onblur="this.rows=1;" name="otros_ant" id="otros_ant"></textarea></td>
                                                                    </tr>
                                                                    <tr class="align-middle">
                                                                        <td><input type="text" class="form-control form-control-sm"></td>
                                                                        <td><input type="time" class="form-control form-control-sm"></td>
                                        ...
                                        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                            <div class="card">
                                                <div class="card-header" id="sueros_iny">
                                                    <button class="accor-closed btn card-act-open pt-1 pb-0 pl-1 btn-block text-left collapsed" type="button" data-toggle="collapse" data-target="#sueros_iny_c" aria-expanded="false" aria-controls="sueros_iny_c">
                                                        Sueros e inyectables
                                                    </button>
                                                </div>
                                                <div id="sueros_iny_c" class="collapse" aria-labelledby="sueros_iny" data-parent="#sueros_iny">
                                                    <div class="card">
                                                        <div class="card-body-aten shadow-none">
                                                            <table id="res-config" class="display table table-striped table-xs dt-responsive nowrap table-bordered" style="width:100%">
                                                                <thead>
                                                                ...
                                                                <tbody>
                                                                    <tr class="align-middle">
                                                                        ...
                                                                        <td><input type="time" class="form-control form-control-sm" id="" name=""></td>
                                                                        <td><input type="text" class="form-control form-control-sm" id="" name=""></td>
                                                                        <td><input type="time" class="form-control form-control-sm" id="" name=""></td>
                                                                    </tr>
                                                                    <tr class="align-middle">
                                                            ...
                                                            <div class="form-row">
                                                                <div class="form-group col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                                                    ...
                                                                    <textarea class="form-control caja-texto form-control-sm" data-titulo="Otros tratamientos parenterales" rows="1"  onfocus="this.rows=4" onblur="this.rows=1;" name="" id=""></textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
