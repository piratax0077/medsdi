            ...
            <div class="redes">
                ...
                @if($profesional->Especialidad()->first())
                    ...
                    @if($profesional->TipoEspecialidad()->first()->nombre == 'ENFERMERÍA CONTROL NIÑO SANO')
                        <a id="boton_3" class="fas fa-bezier-curve fa-2x" data-toggle="canvas" data-target="#formularios_pediatria" aria-expanded="false" aria-controls="bs-canvas-right" title="Formularios Enfermera Universitaria" data-placement="left"></a>
                    @endif
                    @if($profesional->TipoEspecialidad()->first()->nombre == 'TERÁPIA OCUPACIONAL ADULTOS')
                        <a id="boton_3" class="fas fa-child fa-2x" data-toggle="canvas" data-target="#formularios_terapia_ocup" aria-expanded="false" aria-controls="bs-canvas-right" title="Formularios Terápia Ocupacional" data-placement="left"></a>
                    @endif
                @endif
            </div>
            <div class="btn-mas">
