					        ...
					        <div class="tab-pane fade show active" id="nec_energ" role="tabpanel" aria-labelledby="nec_energ_tab">
								<form>
									<div class="form-row">
										<div class="col-sm-4 mt-2">
											<div class="form-group fill">
												<H6 class="form_fono">Para Peso Teórico</h6>
											</div>
										</div>
									</div>
									<div class="form-row">
									...
									<div class="form-row">
										<div class="col-sm-4 mt-2">
											<div class="form-group fill">
												<H6 class="form_fono">Para Peso Actuál</h6>
											</div>
										</div>
									</div>
									<div class="form-row">
								...
								<form>
									...
									<div class="form-row">
										<div class="col-sm-4 mt-3">
											<div class="form-group fill">
												<H6 class="form_fono">Consumo Actuál</h6>
											</div>
										</div>
										...
										<div class="col-sm-2 mt-3">
											<div class="form-group fill">
												<label id="" name="" class="floating-label-activo-sm">H de Carbomo(gr)</label>
												<input type="text" class="form-control form-control-sm" name="" id="">
											</div>
										</div>
										<div class="col-sm-2 mt-3">
											<div class="form-group fill">
												<label id="" name="" class="floating-label-activo-sm">Proteínas(gr)</label>
												<input type="text" class="form-control form-control-sm" name="" id="">
											</div>
										</div>
										<div class="col-sm-2 mt-3">
											<div class="form-group fill">
												<label id="" name="" class="floating-label-activo-sm">Lípidos(gr)</label>
												<input type="text" class="form-control form-control-sm" name="" id="">
											</div>
										</div>
									</div>
									<div class="form-row">
										<div class="col-sm-12 mt-3">
											<div class="form-group fill">
												<H6 class="form_fono">Distribución energética del consumo actual:.</h6>
											</div>
										</div>
									</div>
									...
									<div class="form-row">
										<div class="col-sm-4 mt-2">
											<div class="form-group fill">
												<H6 class="form_fono">Consumo Actuál y % Adecuación</h6>
											</div>
										</div>
									</div>
