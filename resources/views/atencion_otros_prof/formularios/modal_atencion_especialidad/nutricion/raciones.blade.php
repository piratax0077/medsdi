            ...
            <div class="modal-body">
                <div class="form-row">
                    <div class="col-sm-12 mt-2">
                        <embed src="{{ asset('images/nutri/raciones.png') }}" type="application/pdf"  width="100%" height="340px">
                    </div>
                </div>
                <div class="form-row">
                    <div class="col-sm-4 mt-2">
                        <div class="form-group fill">
                            <H6 class="form_fono"> Recomendación</H6>
                        </div>
                    </div>
                    <div class="col-sm-8 mt-4">
                        <div class="form-group fill">
                            <label id="" name="" class="floating-label-activo-sm">Observaciones</label>
                            <textarea class="form-control form-control-sm" rows="1" onfocus="this.rows=4" onblur="this.rows=1;" name="observaciones_raciones" id="observaciones_raciones"></textarea>
                        </div>
                    </div>
                </div>
            </div>
