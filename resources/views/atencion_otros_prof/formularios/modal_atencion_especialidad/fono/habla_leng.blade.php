                        ...
                        <div class="tab-content" id="ev-ofa">
                            ...
                            <div class="tab-pane fade show" id="dif_voc" role="tabpanel" aria-labelledby="dif_voc-tab">
                                <form>
                                    <div id="difonos" class="form-row">
                                        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                            <h6 class="tit-gen"> DÍFONOS VOCÁLICOS</h6>
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="col-sm-12 col-md-6 col-lg-3 col-xl-3">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6">
                                            <div class="form-group">
                                                <label class="floating-label-activo-sm">Otros y Comentarios</label>
                            ...
                            <div class="tab-pane fade show" id="dif_consonanticos" role="tabpanel" aria-labelledby="dif_consonanticos-tab">
                                <form>
                                    <div id="cara" class="form-row">
                                        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                            <h6 class="tit-gen"> DÍFONOS CONSONÁNTICOS</h6>
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="col-sm-12 col-md-6 col-lg-3 col-xl-3">
                                    ...
                                    <div class="form-row">
                                        <div class="col-sm-12 col-md-12 col-lg-4 col-xl-4">
                                            ...
                                            <div class="form-group" id="div_disl_pre" style="display:none">
                                                <label id="" name="" class="floating-label-activo-sm">Obs Presencia de Dislalia</label>
                                        ...
                                        <div class="col-sm-12 col-md-12 col-lg-4 col-xl-4">
                                            ...
                                            <div class="form-group" id="div_disl_cau" style="display:none">
                                                <label id="" name="" class="floating-label-activo-sm">Causa de Dislalia</label>
                                        ...
                                        <div class="col-sm-12 col-md-12 col-lg-4 col-xl-4">
                                            ...
                                            <div class="form-group" id="div_disl_tpo" style="display:none">
                                                <label id="" name="" class="floating-label-activo-sm">Tipo de Dislalia</label>
                                    ...
                                    <div class="form-row">
                                        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                            <div class="form-group" id="div_ofa_vest_boc">
                                                <label id="" name="" class="floating-label-activo-sm">Obs. Examen de Dislalias</label>
                            ...
                            <div class="tab-pane fade show" id="ex_hl_coment" role="tabpanel" aria-labelledby="ex_hl_coment-tab">
                                <div class="form-row">
                                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                        <h6 class="tit-gen">COMENTARIOS DEL EXAMEN</h6>
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                        <div class="form-group">
                                            <label class="floating-label-activo-sm">Comentarios e informe</label>
                                            <textarea class="form-control form-control-sm" data-titulo="Obs Examen del Labio Superior" data-seccion="OFA LABIO INFERIOR" rows="4" onfocus="this.rows=12" onblur="this.rows=4;" name="ofa_lab_obs" id="ofa_lab_obs"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
