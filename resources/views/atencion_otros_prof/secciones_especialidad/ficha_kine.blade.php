            ...
            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                            <div class="card-a">
                                <div class="card-header-a" id="locomotor">
                                    <button class="accor-open btn pt-1 pb-0 pl-1 btn-block text-left collapsed" type="button" data-toggle="collapse" data-target="#locomotor_c" aria-expanded="false" aria-controls="locomotor_c">
                                        Evaluación examen Locomotor
                                    </button>
                                </div>
                                                    ...
                                                    <div class="tab-content" id="ev-kine">
                                                                                        ...
                                                                                        <div class="tab-pane fade show active" id="col_total" role="tabpanel" aria-labelledby="col_total-tab">
                                                                                            <div class="col-sm-12 col-md-12">
                                                                                                ...
                                                                                                <div class="form-row">
                                                                                                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                                                                                        <div class="form-group">
                                                                                                            <label class="floating-label-activo-sm" for="obs_exp_columna_total">Observaciones Examen Columna Total</label>
                                                                                                ...
                                                                                                <div class="form-row">
                                                                                                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                                                                                        <div class="form-group">
                                                                                                            <label class="floating-label-activo-sm" for="resultado_examenes_ct">Resultado Examenes</label>
                                                                                        ...
                                                                                        <div class="tab-pane fade show" id="col_cerv" role="tabpanel" aria-labelledby="col_cerv-tab">
                                                                                            <div class="col-sm-12 col-md-12">
                                                                                                ...
                                                                                                <div class="form-row">
                                                                                                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                                                                                        <div class="form-group">
                                                                                                            <label class="floating-label-activo-sm" for="obs_ex_col_cerv">Observaciones Columna Cervical</label>
                                                                                                ...
                                                                                                <div class="form-row">
                                                                                                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                                                                                        <div class="form-group">
                                                                                                            <label class="floating-label-activo-sm" for="resultado_examenes_cc">Resultado Examenes</label>
                                                                                        ...
                                                                                        <div class="tab-pane fade" id="dor_lumbar" role="tabpanel" aria-labelledby="dor_lumbar-tab">
                                                                                            <div class="col-sm-12 col-md-12">
                                                                                                ...
                                                                                                <div class="form-row">
                                                                                                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                                                                                        <div class="form-group">
                                                                                                            <label class="floating-label-activo-sm"  for="resultado_examenes_dl">Resultado Examenes</label>
                                                                                        ...
                                                                                        <div class="tab-pane fade" id="sacr_coxis" role="tabpanel" aria-labelledby="sacr_coxis-tab">
                                                                                            <div class="col-sm-12 col-md-12">
                                                                                                ...
                                                                                                <div class="form-row">
                                                                                                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                                                                                        <div class="form-group">
                                                                                                            <label class="floating-label-activo-sm"  for="obs_ex_sacrocoxis">Observaciones Examen Sacrocoxis</label>
                                                                                                ...
                                                                                                <div class="form-row">
                                                                                                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                                                                                        <div class="form-group">
                                                                                                            <label class="floating-label-activo-sm" for="resultado_examenes_sc">Resultado Examenes</label>
                                                        ...
                                                        <div class="tab-pane fade show" id="tend_periart" role="tabpanel" aria-labelledby="tend_periart-tab">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6 mb-7">
                                                                    <div class="form-group">
                                                                        <button type="button" class="btn btn-outline-primary btn-sm btn-agregar-grupo-tendones float-right "><i class="fas fa-save"></i> +  Añadir Otro Grupo</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <hr>
                                                    ...
                                                    <div class="tab-content" id="ev-kine_neuro">
                                                        ...
                                                        <div class="tab-pane fade show" id="fun-cog" role="tabpanel" aria-labelledby="fun-cog-tab">
                                                            <form>
                                                                <div class="form-row">
                                                                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                                                        <h6 class="text-c-blue mb-3">FUNCIONES COGNITIVAS SUPERIORES</h6>
                                                                    </div>
                                                                    <div class="form-group col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                                        ...
                                                        <div class="tab-pane fade show" id="cap-visual" role="tabpanel" aria-labelledby="cap-visual-tab">
                                                            <form>
                                                                <div class="form-row">
                                                                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                                                        <h6 class="text-c-blue mb-3">APRECIACIÓN CAPACIDAD VISUAL</h6>
                                                                    </div>
                                                                </div>
                                                                <div class="form-row">
                                                                    <div class="form-group col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                                        ...
                                                        <div class="tab-pane fade show" id="viso-esp" role="tabpanel" aria-labelledby="viso-esp-tab">
                                                            <form>
                                                                <div class="form-row">
                                                                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                                                        <h6 class="text-c-blue mb-3">PERCEPCIÓN VISO-ESPACIAL</h6>
                                                                    </div>
                                                                </div>
                                                                <div class="form-row">
                                                                    <div class="form-group col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                                        ...
                                                        <div class="tab-pane fade show" id="f_eval" role="tabpanel" aria-labelledby="f_eval-tab">
                                                            <form>
                                                                <div class="form-row">
                                                                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                                                        <h6 class="text-c-blue mb-3">FORMULARIOS DE EVALUACIÓN</h6>
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                                                    ...
                                                                    <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                                                        <button type="button" class="btn btn-primary-light-c btn-block btn-sm mt-1" onclick="postura();"><i class="feather icon-plus"></i> Examen motor Postura y Marcha</button>
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                                                    ...
                                                                    <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                                                        <button type="button" class="btn btn-primary-light-c btn-block btn-sm mt-1" onclick="sensibilidad();"><i class="feather icon-plus"></i> Examen Sensitivo</button>
                                                                    </div>
                                                                    <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                                                        <button type="button" class="btn btn-primary-light-c btn-block btn-sm mt-1" onclick="func_global();"><i class="feather icon-plus"></i> Funcionalidad Global</button>
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                                                        <button type="button" class="btn btn-primary-light-c btn-block btn-sm mt-1" onclick="metria();"><i class="feather icon-plus"></i> Metría</button>
                                                                    </div>
                                                                    <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                                                ...
                                                                <div class="form-row">
                                                                    ...
                                                                    <div class="form-group col-sm-12 col-md-2 col-lg-2col-xl-2 ">
                                                                        <button type="button" class="btn btn-primary-light-c btn-block btn-sm mt-1" onclick="postura();"><i class="feather icon-plus"></i> Ver Modal</button>
                                                                    </div>
                                                                </div>
                                                                <div class="form-row">
                                                                    <div class="form-group col-sm-12 col-md-10 col-lg-10 col-xl-10">
                                                    ...
                                                    <div class="tab-content" id="ev-torax-resp">
                                                            ...
                                                            <form>
                                                                ...
                                                                <div class="form-row">
                                                                    <div class="form-group col-md-4 col-lg-4 col-xl-4">
                                                                        <label class="floating-label" for="palp_pd">Puntos Dolorosos</label>
                                                                    ...
                                                                    <div class="form-group col-md-4 col-lg-4 col-xl-4">
                                                                        <label class="floating-label" for="palp_vv">Vibración Vocal</label>
                                                                    ...
                                                                    <div class="form-group col-md-4 col-lg-4 col-xl-4">
                                                                        <label class="floating-label" for="palp_exp">Expansibilidad</label>
                                                                    ...
                                                                    <div class="form-group col-md-6 col-lg-6 col-xl-6">
                                                                        <label class="floating-label" for="palp_elast">Elasticidad</label>
                                                                    ...
                                                                    <div class="form-group col-md-6 col-lg-6 col-xl-6">
                                                                        <label class="floating-label" for="palp_frem">Frémitos</label>
                                                                    ...
                                                                    <div class="form-group col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                                                        <label class="floating-label" for="palp_desc">Descripción Examen</label>
                                                        ...
                                                        <div class="tab-pane fade show" id="percusion" role="tabpanel" aria-labelledby="percusion-tab">
                                                            <form>
                                                                ...
                                                                <div class="form-row">
                                                                    <div class="form-group col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                                                        <label class="floating-label" for="perc_descrip">Descripción</label>
                                                        ...
                                                        <div class="tab-pane fade show" id="evaluacion" role="tabpanel" aria-labelledby="evaluacion-tab">
                                                            <form>
                                                                ...
                                                                <div class="form-row">
                                                                    ...
                                                                    <div class="form-group col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                                                        <label class="floating-label-activo-sm" for="resp_comen" >Comentarios</label>
                                                                    ...
                                                                    <div class="form-group col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                                                        <label class="floating-label-activo-sm" for="ex_resp_descrip" >Descripción</label>
                                                                    ...
                                                                    <div class="form-group col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                                                        <label class="floating-label-activo-sm"for="resp_desc_obj" >Descripción</label>
                ...
                <div class="tab-pane fade show" id="controles" role="tabpanel" aria-labelledby="controles-tab">
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-3 col-lg-3 col-xl-3 float-right text-right mt-3 mb-0 d-inline font-weight-bold f-16">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                            <button type="button" class="btn btn-outline-primary btn-sm btn-agregar-tratamiento" ><i class="fas fa-save"></i> + + Añadir tratamiento</button>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                        	<div class="dropdown">
        									  ...
        									  <div class="dropdown-menu">
        									    ...
        									    <a class="dropdown-item" onclick="postura();">+ Examen motor postura</a>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="text-center align-middle">
                                                            <button href="#!" class="btn btn-info-light btn-xs"><i class="feather icon-file-text"></i> Ver control</button>
                                                        </td>
                                                        <td class="text-center align-middle">
                                                            <button href="#!" class="btn btn-warning-light btn-xs"><i class="feather icon-folder"></i> Ver archivo</button>
                                                        </td>
                                                        <td class="text-center align-middle">
                                                            <button href="#!" class="btn btn-purple-light btn-xs"><i class="feather icon-file-plus"></i> Ver informe</button>
                                                        </td>
                                                    </tr>
                                                    <tr>
