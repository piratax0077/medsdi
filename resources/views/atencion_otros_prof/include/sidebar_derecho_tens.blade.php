...
<div id="formularios_tens" class="bs-canvas bs-canvas-anim bs-canvas-right position-fixed bg-light h-100 shadow-lg" data-width="370px" data-offset="true">
    <header class="bs-canvas-header p-3 bg-info overflow-auto">
        ...
        <h5 class="d-inline-block text-light mb-0 float-right">Formularios Técnico Enfermería</h5>
    </header>
    <div class="bs-canvas-content">
        <div class="accordion" id="accordion_ped">
             {{-- <div class="card-sidebar">
                ...
                <div id="collapse_solicitud_examenes" class="collapse" aria-labelledby="heading_solicitud_examenes" data-parent="#accordion_ped">
