                        ...
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-md-12 mt-3 mb-0">
                                    <h6 class="f-16 text-c-blue">Ficha de atención ORL</h6>
                                    <hr>
                                </div>
                            </div>
                            <div class="row">
                                            ...
                                            <form>
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-3">
                                                        ...
                                                        <input type="text" class="form-control form-control-sm" name="rut_acompañante" id="rut_acompañante">
                                                    </div>
                                                    <div class="form-group col-md-3">
                                                    ...
                                                    <div class="form-group col-md-3">
                                                        ...
                                                        <input type="text" class="form-control form-control-sm" name="apell_acompañante" id="apell_acompañante">
                                                    </div>
                                                    ...
                                                    <div class="form-group col-md-3">
                                                        ...
                                                        <input type="text" class="form-control form-control-sm" name="tel_acompañante" id="tel_acompañante">
                                                    </div>
                                                    <div class="form-group col-md-3">
                                                        <label class="floating-label">Email</label>
                                                        <input type="text" class="form-control form-control-sm" name="email_acompañante" id="email_acompañante">
                                                    </div>
                                                    <div class="form-group col-md-3">
                                                    ...
                                                    <div class="form-group col-md-3">
                                                        <button type="button" class="btn btn-success btn-block btn-sm" onclick="autorizacion_exam();"><i class="fa fa-plus"></i> Autoriza el examen</button>
                                ...
                                <div class="form-group col-md-3">
                                 ...
                                 <div class="form-group col-md-3">
                                     <button type="button" class="btn btn-success btn-block btn-sm mt-1" onclick="i_audif();"><i class="fa fa-plus"></i> Receta de Audífono</button>
                                </div>
                                <div class="form-group col-md-3">
                                ...
                                <div class="form-group col-md-3">
                                    <button type="button" class="btn btn-success btn-block btn-sm mt-1" onclick="i_examen_esporl();"><i class="fa fa-plus"></i> Indicar examen Especialidad</button>
                                </div>
                            </div>
