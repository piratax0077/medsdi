        ...
        <div class="row bg-white shadow-sm rounded mx-3 mt-4">
            <div class="col-md-12">
                <div class="row">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12 col-md-12 col-lg-12" style="margin-left: 16px">
                            <script>
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12" style="margin-left: 16px">
                    ...
                    <div class="col-sm-12 col-md-12">
                        <form action="{{ route('fichaAtencion.registrar_ficha_orl') }}" method="POST">
                            ...
                            @csrf
                            <div class="tab-content" id="ingreso_hosp">
                                <!--INFO. INGRESO-->
                                    ...
                                    <form>
                                        <div class="form-row mb-2">
                                            ...
                                            <div class="form-group col-sm-12 col-md-12 col-lg-12">
                                                <label class="floating-label-activo-sm">Indicaciones de ingreso Generales</label>
                                            ...
                                            <div class="form-group col-sm-12 col-md-12 col-lg-12">
                                                <label class="floating-label-activo-sm">Indicaciones de ingreso Medicamentos</label>
                                                <textarea class="form-control caja-texto form-control-sm" rows="1" onfocus="this.rows=4" onblur="this.rows=1;"name="ind_ingreso" id="ind_ingreso"></textarea>
                                            </div>
                                            <div class="form-group col-sm-12 col-md-12 col-lg-12">
                                                <label class="floating-label-activo-sm">Indicaciones de preparaciòn especial</label>
                                                <textarea class="form-control caja-texto form-control-sm" rows="1" onfocus="this.rows=4" onblur="this.rows=1;"name="ind_ingreso" id="ind_ingreso"></textarea>
                                            </div>
                                        </div>
                                    </form>
                                        ...
                                        <div class="form-row mb-2">
                                            ...
                                            <div class="form-group col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                                ...
                                                <input type="text" class="form-control form-control-sm"
                                                    name="organo_op" id="organo_op">
                                            </div>
                                            <div class="form-group col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                                <label class="floating-label-activo-sm">Tipo de cirugía
                                                    <i>(nombre)</i></label>
                                                <input type="text" class="form-control form-control-sm" name="tipo_op"
                                                    id="tipo_op">
                                            </div>
                                            <div class="form-group col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                                <label class="floating-label-activo-sm">Anestésia</label>
                                                <input type="text" class="form-control form-control-sm"
                                                    name="tipo_anest" id="tipo_anest">
                                            </div>
                                            <div class="form-group col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                                <label class="floating-label-activo-sm">Hora de cirugía</label>
                                                <input type="time" class="form-control form-control-sm" name="hora_op"
                                                    id="hora_op">
                                            </div>
                                        </div>
                                    </form>
                                        ...
                                        <div class="form-row mb-2">
                                            ...
                                            <div class="form-group col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                                ...
                                                <textarea class="form-control caja-texto form-control-sm" rows="1" onfocus="this.rows=3" onblur="this.rows=1;"
                                                    name="instrumental_especial" id="nstrumental_especial"></textarea>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                                    ...
                                    <form>
                                        <div class="form-row mb-2">
                                            <div class="col-sm-12 col-md-12 col-lg-12">
                                                ...
                                                <input class="mb-2" size="80" name="archivo_up" id="archivo_up"
                                                    type="file" onchange="javascript: submit();">
                                                <br>
                                        ...
                                        <div class="form-row mb-2">
                                            <div class="col-sm-12 col-md-12 col-lg-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control caja-texto form-control-sm" rows="1" onfocus="this.rows=3" onblur="this.rows=1;"
                                                        name="otros_hosp" id="otros_hosp"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
