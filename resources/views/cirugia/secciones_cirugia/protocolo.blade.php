                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <textarea class="form-control form-control-sm" rows="1" onfocus="this.rows=3" onblur="this.rows=2;"
                                                name="anestesias_ayudantes_protocolo_operatorio_dental" id="anestesias_ayudantes_protocolo_operatorio_dental"></textarea>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label class="floating-label">Arsenalería</label>
                                            <textarea class="form-control form-control-sm" rows="1" onfocus="this.rows=3" onblur="this.rows=2;"
                                                name="arsenaleria_protocolo_operatorio_dental" id="arsenaleria_protocolo_operatorio_dental"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-3">
                                            ...
                                            <textarea class="form-control form-control-sm" rows="1" onfocus="this.rows=4" onblur="this.rows=2;"
                                                name="nombre_operacion_protocolo_operatorio_dental" id="nombre_operacion_protocolo_operatorio_dental"></textarea>
                                        </div>
                                        <div class="form-group col-md-3">
                                            <label class="floating-label">Material de hemostasia</label>
                                            <textarea class="form-control form-control-sm" rows="1" onfocus="this.rows=4" onblur="this.rows=2;"
                                                name="material_hemostasia_protocolo_operatorio_dental" id="material_hemostasia_protocolo_operatorio_dental"></textarea>
                                        </div>
                                        <div class="form-group col-md-3">
                                            <label class="floating-label">Material de cierre</label>
                                            <textarea class="form-control form-control-sm" rows="1" onfocus="this.rows=4" onblur="this.rows=2;"
                                                onfocus="this.rows=4" onblur="this.rows=2;" name="material_cierre_protocolo_operatorio_dental"
                                                id="material_cierre_protocolo_operatorio_dental"></textarea>
                                        </div>
                                        <div class="form-group col-md-3">
                                            <label class="floating-label">Otros (implantes, aseo, etc.)</label>
                                            <textarea class="form-control form-control-sm" rows="1" onfocus="this.rows=4" onblur="this.rows=2;"
                                                name="otros_materiales_protocolo_operatorio_dental" id="otros_materiales_protocolo_operatorio_dental"></textarea>
                                        </div>
                                        <div class="form-group col-md-12">
                                            <textarea class="form-control form-control-sm" placeholder="Descripción de la cirugía" rows="1"
                                                onfocus="this.rows=4" onblur="this.rows=2;" name="descripcion_cirugia_protocolo_operatorio_dental"
                                ...
                                <div class="card-body shadow-none">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-3">
                                            ...
                                            <textarea class="form-control form-control-sm" rows="1" onfocus="this.rows=4" onblur="this.rows=2;"
                                                name="farmacos_protocolo_operatorio_dental" id="farmacos_protocolo_operatorio_dental"></textarea>
                                        </div>
                                        <div class="form-group col-md-3">
                                            ...
                                            <textarea class="form-control form-control-sm" rows="1" onfocus="this.rows=2" onblur="this.rows=1;"
                                                name="pulso_presion_protocolo_operatorio_dental" id="pulso_presion_protocolo_operatorio_dental"></textarea>
                                        </div>
                                        <div class="form-group col-md-3">
                                            <label class="floating-label">Incidentes</label>
                                            <textarea class="form-control form-control-sm" rows="1" onfocus="this.rows=4" onblur="this.rows=2;"
                                                name="incidentes_protocolo_operatorio_dental" id="incidentes_protocolo_operatorio_dental"></textarea>
                                        </div>
                                        <div class="form-group col-md-3">
                                            <label class="floating-label">Recuperación anestesia</label>
                                            <textarea class="form-control form-control-sm" rows="1" onfocus="this.rows=4" onblur="this.rows=2;"
                                                name="recuperacion_anestesia_protocolo_operatorio_dental" id="recuperacion_anestesia_protocolo_operatorio_dental"></textarea>
                                        </div>
                                        <div class="form-group col-md-12">
                                            <textarea class="form-control form-control-sm" placeholder="Descripción de anestesia"
                                                name="descripcion_anestesia_protocolo_operatorio_dental" id="descripcion_anestesia_protocolo_operatorio_dental"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-12">
                                            <textarea class="form-control form-control-sm" placeholder="Descripción de incidencias de la cirugía" rows="1"
                                                onfocus="this.rows=4" onblur="this.rows=2;" name="descripcion_incidencia_protocolo_operatorio_dental"
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <textarea class="form-control form-control-sm" placeholder="Sala UTI, Recuperación alta, etc." rows="1"
                                                onfocus="this.rows=2" onblur="this.rows=1;" name="destino_protocolo_operatorio_dental"
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <textarea class="form-control form-control-sm" placeholder="Indicaciones post-operatorias" rows="1"
                                                onfocus="this.rows=4" onblur="this.rows=2;" name="indicaciones_postoperacion_protocolo_operatorio_dental"
