<div id="indicar_examen" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="modal_indicar_examen"
    aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-row">
                    ...
                    <div class="col-sm-12">
                        <button type="button" onclick="indicar_examen_cirugia();" id="agregar_examen_tabla"
                    ...
                    <div class="col-sm-12 mt-3">
                        ...
                        <div class="table-responsive">
                            ...
                            <table id="tabla_examen_cirugia" class="table table-bordered table-sm">
                                <thead>
                                    <tr>
