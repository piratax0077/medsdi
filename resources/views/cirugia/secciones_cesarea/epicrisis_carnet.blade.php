                    ...
                    <div class="row bg-white shadow-sm rounded mx-3 mt-4">
                        <div class="col-md-12">
                            ...
                            <form id="form_ingreso_paciente"
                                action="@if (isset($epicrisis_alta_medica)) {{ route('cirugia.actualizar_epicrisis_alta_medica_cesarea') }} @else {{ route('cirugia.registrar_epicrisis_alta_medica_cesarea') }} @endif"
                                method="POST">
