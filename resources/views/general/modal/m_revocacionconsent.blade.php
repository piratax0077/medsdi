			...
			<div class="modal-body">
				...
				<div class="form-row">
                    <div class="form-group col-sm-12 col-md-4 col-lg-4 col-xl-4">
						...
						<input  type="text" class="form-control form-control-sm" id="numero_consentimiento"name="numero_consentimiento" value="">
					</div>
                    <div class="form-group col-sm-12 col-md-4 col-lg-4 col-xl-4">
                        <label class="floating-label-activo-sm">Fecha del consentimiento</label>
                        <input  type="date" class="form-control form-control-sm" id="fecha_consentimiento"name="fecha_consentimiento" value="">
                    </div>
                </div>
                <div class="form-row">
