    ...
    <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-sm btn-info"><i class="feather icon-save"></i> Guardar y enviar</button>
                <button type="button" class="btn btn-sm btn-primary"><i class="feather icon-file-text"></i> Ver formulario (PDF)</button>
                </form>
            </div>
        </div>
    </div>
