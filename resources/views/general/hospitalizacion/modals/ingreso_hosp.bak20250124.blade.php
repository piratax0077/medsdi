    ...
    <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header bg-info">
                <h5 class="modal-title text-white mt-1 f-18" id="eco_gine"> Solicitud de hospitalización 2</h5>
                            ...
                            <div class="tab-content" id="info-ingreso">
                                ...
                                <div class="tab-pane fade show" id="info_hospitalizacion" role="tabpanel"
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="floating-label-activo-sm">Observaciones a la
                                ...
                                <div class="tab-pane fade show active" id="info-ingreso-hosp" role="tabpanel"
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-sm-12 col-md-4 col-lg-4">
                                            ...
                                            <label
                                                class="label">{{ $paciente->nombres . ' ' . $paciente->apellido_uno . ' ' . $paciente->apellido_dos }}</label>
                                        </div>
                                        <div class="form-group col-sm-12 col-md-4 col-lg-4">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-sm-12 col-md-6 col-lg-6">
                                            <label class="label"><strong>Nombre: </strong></label>
                                            <label
                                                class="label">{{ $profesional->nombre . ' ' . $profesional->apellido_uno . ' ' . $profesional->apellido_dos }}</label>
                                        </div>
                                        <div class="form-group col-sm-12 col-md-6 col-lg-6">
                                    ...
                                    <div id="evol_med_urgencia" class="open" aria-labelledby="med_urgen"
                                        ...
                                        <div class="card-body-aten-a">
                                            <div id="form-servicios">
                                                <div class="row">
                                                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                                        <ul class="nav nav-tabs-aten nav-fill mb-10" id="med_urgen"
                                                            role="tablist">
                                                            <li class="nav-item">
                                                                            ...
                                                                            <div class="tab-pane fade show active"
                                                                                ...
                                                                                <div class="form-row">
                                                                                    ...
                                                                                    <div class="col-sm-6 mt-2">
                                                                                        <div class="form-group fill">
                                                                                            <label
                                                                                                class="floating-label">Vía de Administración</label>
                                                                                            <select
                                                                                                class="form-control form-control-sm"
                                                                            ...
                                                                            <div class="tab-pane fade show"
                                                                                ...
                                                                                <div class="form-row">
                                                                                    ...
                                                                                    <div class="col-sm-6 mt-2">
                                                                                        <div class="form-group">
                                                                                            <label
                                                                                                class="floating-label-activo-sm">Tipo Control</label>
                                                                                            <select
                                                                        ...
                                                                        <div class="card">
                                                                            <div class="modal-body">
                                                                                ...
                                                                                <div class="form-row">
                                                                                    ...
                                                                                    <div class="col-sm-6 mt-2">
                                                                                        <div class="form-group fill">
                                                                                            <label
                                                                                                class="floating-label">Lado</label>
                                                                                            <select
                                                                                                class="form-control form-control-sm"
                                                                                                id="lado"
                                                                                                name="lado">
                                                                                    ...
                                                                                    <div class="col-sm-6 mt-2">
                                                                                        <div class="form-group fill">
                                                                                            <label
                                                                                                class="floating-label">Prioridad</label>
                                                                                            <select
                                                                                                class="form-control form-control-sm"
                                                                                                id="prioridad"
                                                                                                name="prioridad">
                                                                            ...
                                                                            <div class="modal-footer">
                                                                                ...
                                                                                <button type="button"
                                                                                    ...
                                                                                    data-dismiss="modal"
                                                                                    class="btn btn-info">Generar Orden
                                                                                    de
                                                                                    Examen</button>
                                                                            </div>
                                                                        </div>
                                                            ...
                                                            <div class="tab-pane fade show" id="urg_dest_ind"
                                                                ...
                                                                <div class="form-row my-3">
                                                                    <div class="col-sm-12 col-md-12 col-xl-12">
                                                                        ...
                                                                        <button type="button" class="btn btn-outline-success btn-sm btn-icon float-right" onclick="registrar_salida_paciente()"> <i class="fas fa-save"></i></button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                    ...
                                    <form>
                                        <div class="form-row mb-2">
                                            <div class="col-sm-12 col-md-12 col-lg-12">
                                                ...
                                                <input class="mb-2" size="80" name="archivo_up"
                                                    id="archivo_up" type="file"
                                                    onchange="javascript: submit();">
                                                <br>

                                                <div class="alert alert-warning alert-dismissible fade show pb-2"
                                                    role="alert">
                                                    <i class="feather icon-file f-16"></i><a href="#"
                                                        class="alert-link"> CONSENTIMIENTO</a>
                                                    <button type="button" class="close pt-1" data-dismiss="alert"
                                                        aria-label="Close">
                                                ...
                                                <div class="alert alert-warning alert-dismissible fade show pb-2"
                                                    role="alert">
                                                    <i class="feather icon-file f-16"></i><a href="#"
                                                        class="alert-link"> Eco -Doppler- Nombre paciente.pdf</a>
                                                    <button type="button" class="close pt-1" data-dismiss="alert"
                                                        aria-label="Close">
                                                        <span aria-hidden="true">&times;</span>
                                                    </button>
