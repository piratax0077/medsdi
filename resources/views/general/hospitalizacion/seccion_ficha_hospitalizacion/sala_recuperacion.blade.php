                    ...
                    <div class="row bg-white shadow-sm rounded mx-3 mt-4">
                        ...
                        <div class="col-md-12">
                            <form id="form_ingreso_paciente"
                                action="{{ route('cirugia.registrar_recuperacion_cirugia') }}" method="POST">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        @if (isset($recuperaciones))
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-10">
                                                        ...
                                                        <input class="form-control form-control-sm"
                                                            name="evolucion{{ $recu->id }}" id="evolucion"
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-10">
                                                    <label class="floating-label">Evolución</label>
                                                    <textarea class="form-control form-control-sm" name="evolucion" id="evolucion" rows="2" onfocus="this.rows=4"
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-12 text-center">
                                        <button type="submit"
                                            onclick="agregar_medicamentos_cirugia(); agregar_interconsulta_cirugia(); agregar_examenes_cirugia();"
