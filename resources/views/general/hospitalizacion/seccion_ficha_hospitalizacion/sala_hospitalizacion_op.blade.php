<div class="user-profile user-card mt-0"style="background-color: #ecf0f5!important;">
    ...
    <div class="row px-4">
        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 mb-0">
            <h6 class="float-left text-c-blue d-inline pt-2 f-20">Atención de paciente en sala de hospitalización</h6>
            <div class="alert alert-purple px-0 float-md-right d-inline py-1">
                <p class="p-10 d-inline font-weight-bolder text-c-blue">Servicio: </p>
            ...
            <div class="card mb-3">
                <div class="card-body pt-2">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-sm-12 col-md-8 col-lg-8 col-xl-8 col-xxl-9">
                            <label class="floating-label-activo-sm">Evolución</label>
                            <textarea class="form-control form-control-sm" rows="2" onfocus="this.rows=10" onblur="this.rows=2;" id="hosp_op_evol" name="hosp_op_evol"></textarea>
                        </div>
                        <div class="form-group col-sm-12 col-md-2 col-lg-2 col-xl-2 col-xxl-1">
...
<script>
    ...
    function agregarEvolucion(){
        ...
        html += '<div id="evolucion" class="row mt-4">';
        html += '<div class="col-sm-12">';
        html += '<form>';
        html += '<div class="form-row">';
        html += '<div class="form-group col-sm-12 col-md-2 col-lg-2 col-xl-2 col-xxl-2 font-weight-bold">';
        ...
        html += '</div>';
        html += ' <div class="form-group col-sm-12 col-md-8 col-lg-8 col-xl-8 col-xx-9">';
        html += ' <label class="floating-label-activo-sm">Evolución</label>';
        html += '<textarea class="form-control form-control-sm" rows="2" onfocus="this.rows=10" onblur="this.rows=2;"></textarea>';
        html += '</div>';
        html += '<div class="form-group col-sm-12 col-md-2 col-lg-2 col-xl-2 col-xxl-2">';
