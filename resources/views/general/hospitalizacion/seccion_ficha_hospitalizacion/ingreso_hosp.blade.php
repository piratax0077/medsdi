<div class="user-profile user-card mt-0" style="background-color: #ecf0f5!important;">
    <div class="col-md-12 py-0 px-2 shadow-none">
        ...
        <div class="row bg-white shadow-sm rounded mx-3">
            <div class="col-md-12">
                <div class="row">
                    <div class="col-md-12 mt-3 mb-1">
                        <h6 class="f-16 text-c-blue text-left">Ingreso de Paciente</h6>
                            ...
                            <div class="tab-pane fade show" id="indicaciones" role="tabpanel"
                                ...
                                <form>
                                    <div class="form-row mb-2">
                                        ...
                                        <div class="form-group col-sm-6 col-md-6 col-lg-6">
                                            <label class="floating-label-activo-sm">Indicaciones de Examenes</label>
                                            <textarea class="form-control caja-texto form-control-sm" rows="1" onfocus="this.rows=4" onblur="this.rows=1;"name="ind_ingreso" id="ind_ingreso"></textarea>
                                        </div>
                                    ...
                                    <div class="form-group" style="background-color:#dbe7ff!important">
