    ...
    <div class="col-md-12 py-0 px-2 shadow-none">
        ...
        <div class="row bg-white shadow-sm rounded mx-3 mt-4">
            <div class="col-md-12">
                ...
                <div class="row">
                    <div class="form-group col-sm-12 col-md-12 col-lg-12" style="margin-left: 14px">
                        <script>
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12" style="margin-left: 14px">
                        <ul class="nav nav-tabs-aten nav-fill mb-3" id="ev-nutricional" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link-aten text-reset" id="biopsia-pab-tab" data-toggle="tab" href="#biopsia-pab" role="tab" aria-controls="biopsia-pab" aria-selected="false">Biòpsia</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link-aten text-reset" id="operacion-pab-tab" data-toggle="tab" href="#operacion-pab" role="tab" aria-controls="operacion-pab" aria-selected="false">Operaciòn</a>
                            </li>
                            <li class="nav-item">
                    ...
                    <div class="tab-content" id="protocolo">
                                    ...
                                    <form>
                                        <div class="form-row">
                                            <div class="form-group col-md-12">
                                                <label class="floating-label-activo-sm">Patologìas Cronicas y Riesgos especiales</label>
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-12 mb-2">
                                                <h6 class="text-c-blue">Información de cirugía</h6>
                                            </div>
                                        </div>
                                        <div class="form-row">
                            ...
                            <form>
                                <div class="form-row mb-2">
                                    ...
                                    <div class="form-group col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                        ...
                                        <input type="text" class="form-control form-control-sm"  name="ayudantes_protocolo_operatorio_dental"id="ayudantes_protocolo_operatorio_dental">
                                    </div>
                                    <div class="form-group col-sm-12 col-md-6 col-lg-6 col-xl-6">
                        ...
                        <div class="tab-pane fade show" id="biopsia-pab" role="tabpanel"aria-labelledby="biopsia-pab-tab">
                            <form>
                                <div class="form-row mb-2">
                                    <div class="col-md-12 mb-2">
                                        <h6 class="text-c-blue">Biopsia</h6>
                                    </div>
                        ...
                        <div class="tab-pane fade show" id="anestesia-protocolo-pab" role="tabpanel"aria-labelledby="anestesia-protocolo-pab-tab">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    <div class="form-group fill">
                                        <label class="floating-label-activo-sm">Evoluciòn signos vitales</label>
                                        <textarea class="form-control caja-texto form-control-sm" rows="1" onfocus="this.rows=3" onblur="this.rows=1;"name="instrumental_especial" id="nstrumental_especial"></textarea>
                                    </div>
                                </div>
                                <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                ...
                                <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    <div class="form-group fill">
                                        <label class="floating-label-activo-sm">Descripciòn</label>
                            ...
                            <form>
                                <div class="form-row mb-2">
                                    <div class="col-sm-12 col-md-12 col-lg-12">
                                        <h6 class="mb-3 text-c-blue">CONSENTIMIENTOS</h6>
                                        <form>
                                            <div class="form-row mb-2">
                                                    <!--IDEA DEL ARCHIVO ADJUNTO-->
                                                <div class="alert alert-warning alert-dismissible fade show pb-2" role="alert">
                                                    <i class="feather icon-file f-16"></i><a href="#" class="alert-link">CONSENTIMIENTO ANESTESIA.PDF</a>
                                                    <button type="button" class="close pt-1" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                </div>
                                                <div class="alert alert-warning alert-dismissible fade show pb-2" role="alert">
                                                    <i class="feather icon-file f-16"></i><a href="#" class="alert-link"> CONSENTIMIENTO CIRUGÌA.PDF</a>
                                                    <button type="button" class="close pt-1" data-dismiss="alert" aria-label="Close"> <span aria-hidden="true">&times;</span> </button>
                                                </div>
                                            </div>
                                        </form>
                        ...
                        <div class="tab-pane fade show" id="destino-pos-op-pab" role="tabpanel"aria-labelledby="destino-pos-op-pab-tab">
                            <form>
                                <div class="form-row mb-2">
                                    <div class="col-sm-12 col-md-12 col-lg-12">
                                        <h6 class="mb-3 text-c-blue">DESTINO E INDICACIONES POST-OPERATORIAS</h6>
