         ...
         <div class="modal-body pb-0">
             ...
             <ul class="nav nav-pills mt-3 mb-4" id="pills-tab-bonos" role="tablist">
                 ...
                 <li class="nav-item d-none" id="link_pago_presupuesto_dental">
                    <a class="nav-link-modal" id="pills-venta-dental-tab" data-toggle="pill" href="#pills-venta-dental"
                        role="tab" aria-controls="pills-venta-dental" aria-selected="false">Pago Presupuesto Dental</a>
                </li>
             </ul>
             {{--  PESTAÑAS  --}}
             <div class="tab-content" id="pills-tabContent-interconsulta">
                 ...
                 {{--  PESTAÑA DE VENTA DE BONO  --}}
                 <div class="tab-pane fade" id="pills-venta-dental" role="tabpanel" aria-labelledby="pills-venta-dental-tab">
                    ...
                    <div class="form-row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <select name="tratamientos_dentales" id="tratamientos_dentales" class="form-control form-control-sm">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group fill">
                                <label class="floating-label-activo-sm">Rut del Paciente</label>
                                <input type="person" class="form-control form-control-sm" name="bono_paciente_rut_dental"
                                    id="bono_paciente_rut_dental" disabled="disabled">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group fill">
                                <label class="floating-label-activo-sm">Nombre del Paciente</label>
                                <input type="text" class="form-control form-control-sm" name="bono_paciente_nombre_dental"
                                    id="bono_paciente_nombre_dental" disabled="disabled">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group fill">
                                <label class="floating-label-activo-sm"> Nombre Profesional</label>
                                <input type="text" class="form-control form-control-sm" name="bono_profesional_nombre_dental"
                                    id="bono_profesional_nombre_dental" disabled="disabled">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group fill">
                                <label class="floating-label-activo-sm"> Rut Profesional</label>
                                <input type="text" class="form-control form-control-sm" name="bono_profesional_rut_dental"
                                    id="bono_profesional_rut_dental" disabled="disabled">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group fill">
