                            ...
                            <div class="col-sm-6">
                                <div class="form-group fill">
                                    ...
                                    <input type="person" class="form-control form-control-sm"
                                        name="bono_paciente_rut" id="bono_paciente_rut" disabled="disabled">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group fill">
                                    ...
                                    <input type="text" class="form-control form-control-sm"
                                        name="bono_paciente_nombre" id="bono_paciente_nombre" disabled="disabled">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group fill">
                                    ...
                                    <input type="text" class="form-control form-control-sm"
                                        name="bono_profesional_nombre" id="bono_profesional_nombre" disabled="disabled">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group fill">
                                    ...
                                    <input type="text" class="form-control form-control-sm"
                                        name="bono_profesional_rut" id="bono_profesional_rut" disabled="disabled">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group fill">
                            ...
                            <div class="col-sm-6" id="div_btn_pedir_autorizacion">
                                <div class="form-group fill">
                                    <button type="button" onclick="conectar_api();"
                                        class="btn btn-info btn-sm">Pedir autorización</button>
                                </div>
                            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="form_reseva_de_horas">
                    ...
                    {{-- <div id="reserva_datos_procedimiento">
                        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                            <h6 class="text-c-blue f-16 d-inline">Procedimiento</h6>
                        </div>
                        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12" >
                            <div class="form-group paciente_view mt-3">
                                <label class="floating-label-activo-sm">Descripción reserva</label>
                                <select class="form-control form-control-sm" name="reserva_id_procedimiento" id="reserva_id_procedimiento">
                                    <option value="0">Seleccione</option>
                                </select>
                            </div>
                        </div>
                    ...
                    <div id="reserva_agregar_paciente_hora">
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12" >
                            <div class="form-group paciente_view mt-3">
                                <label class="floating-label-activo-sm">Descripción reserva</label>
                                <select class="form-control form-control-sm" name="reserva_nuevo_id_procedimiento" id="reserva_nuevo_id_procedimiento">
                                    <option value="0">Seleccione</option>
                                </select>
                            </div>
                        </div>
...
<script>
    ...
    function cargar_procedimiento_profesional(id_profesional, id_lugar_atencion)
    {
        var valido = 1;
        var mensaje = '';
        $('#reserva_id_procedimiento').html('');
        $('#reserva_nuevo_id_procedimiento').html('');

        if(id_profesional == '' || id_profesional == 0)
        {
            mensaje = 'se debe indicar el profesional';
            valido = 0;
        }
        if(id_lugar_atencion == '' || id_lugar_atencion == 0)
        {
            mensaje = 'se debe indicar el lugar atencion';
            valido = 0;
        }

        if(valido == 1)
        {
            let url = "{{ route('asistente.lab.ver.proced.profe.lugar_atencion') }}";
                ...
                .done(function(data) {
                    if (data.estado == 1)
                    {
                        $.each(data.registro, function (index, value) {
                            $('#reserva_id_procedimiento').append('<option value="0">'+value.nombre+'</option>');
                            $('#reserva_nuevo_id_procedimiento').append('<option value="0">'+value.nombre+'</option>');
                        });
                    }
                    else
                    {
                        swal({
                            title: "Caga de Procedimientos Profesional",
                            text: "Falla en carga de procedimientos del profesional.",
                            icon: "error",
                        });
                    }
                })
