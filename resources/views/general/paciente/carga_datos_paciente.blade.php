...
<body>
                    ...
                    <div class="col-sm-12 col-md-6 mx-auto py-2">
                        <div class="card">
                            <div class="card-top pt-2">
                                <h5>Carga de datos paciente</h5>
                                <p class="p-18">Complete los datos para finalizar el registro y confirmar hora medica</p>
                                <input type="hidden" name="id_paciente" id="id_paciente" value="{{ $paciente->id }}">
                                <input type="hidden" name="token_paciente" id="token_paciente" value="{{ $paciente->token }}">
                            </div>
                            <div class="card-body">
                                            ...
                                            <form class="wizard-container" id="js-wizard-form">
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-sm-12 col-md-6">
                                                        ...
                                                        <input type="text" class="form-control form-control-sm" name="rut" id="rut" value="{{ $paciente->rut }}" >{{-- onblur="verificador_rut();" onkeyup="formatoRut(this)" --}}
                                                    </div>
                                                    <div class="form-group col-sm-12 col-md-6">
                                                        <label class="floating-label-activo-sm">Nombre</label>
                                                        <input type="text" class="form-control form-control-sm" name="nombre" id="nombre" value="{{ $paciente->nombres }}">
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-sm-12 col-md-6">
                                                        ...
                                                        <input type="text" class="form-control form-control-sm" name="primer_apellido" id="primer_apellido" value="{{ $paciente->apellido_uno }}">
                                                    </div>
                                                    <div class="form-group col-sm-12 col-md-6">
                                                        <label class="floating-label-activo-sm">Segundo apellido</label>
                                                        <input type="text" class="form-control form-control-sm" name="segundo_apellido" id="segundo_apellido" value="{{ $paciente->apellido_dos }}">
                                                    </div>
                                                </div>
                                                <div class="form-row">
                                                    <div class="form-group col-sm-12 col-md-4">
                                                        <label class="floating-label-activo-sm">Nacimiento</label>
                                                        <input type="date" class="form-control form-control-sm" name="fecha_nacimiento" id="fecha_nacimiento" value="{{ !empty($paciente->fecha_nac)?date('Y-m-d', strtotime($paciente->fecha_nac)):'' }}">
                                                    </div>

                                                    <div class="form-group col-sm-12 col-md-4">
                                                        <label class="floating-label-activo-sm">Sexo</label>
                                                        <select class="form-control form-control-sm" id="sexo" name="sexo">
                                                            <option value="0" {{ $paciente->sexo == null ? 'selected' : '' }}>Seleccione</option>
                                                            <option value="M" {{ ($paciente->sexo ?? null) == 'M' ? 'selected' : '' }}>Hombre</option>
                                                            <option value="F" {{ ($paciente->sexo ?? null) == 'F' ? 'selected' : '' }}>Mujer</option>
                                                        </select>
                                                    </div>
                                                    <div class="form-group col-sm-12 col-md-4">
                                                ...
                                                <div class="form-row">
                                                    <div class="col-md-12">
                                                        <div class="btn-next-con">
                                                            ...
                                                            <a class="btn-next" href="#">Actualizar Datos</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </form>
    ...
    <script>
        ...
        function registrar_datos()
        {
            ...
            var token_paciente = $('#token_paciente').val();
            var rut = $('#rut').val();
