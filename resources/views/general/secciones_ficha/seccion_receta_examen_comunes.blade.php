            ...
            @if (isset($fichaAtencion) && $fichaAtencion->hipotesis_diagnostico != null)
                <div class="col-sm-12 col-md-6 text-center">
                    <div class="btn-group btn-group-xs w-100" data-toggle="buttons">
                        <button type="button" id="btn_agregar_medicamento" class=" btn_agregar_medicamento btn btn-info btn-xs mt-1" onclick="i_medicamento();"><i class="feather icon-plus"></i> Indicar medicamento</button>
                        <button type="button" onclick="ver_pdf_receta($('#id_fc').val());" class=" btn_medicamento_pdf btn btn-primary  btn-xs mt-1" id="btn_medicamento_pdf"><i class="feather icon-file"></i>PDF Receta</button>
                ...
                <div class="col-sm-12 col-md-6">
                    <div class="btn-group btn-group-xs w-100" data-toggle="buttons">
                        ...
                        <button type="button" onclick="ver_pdf_orden_examenes($('#id_fc').val());" class=" btn_examenes_pdf btn btn-primary  btn-xs mt-1" id="btn_examenes_pdf"><i class="feather icon-file"></i>Ver Receta</button>
                    </div>
                </div>
            @else
                <div class="col-sm-12 col-md-6 text-center">
                    <div class="btn-group btn-group-xs w-100" data-toggle="buttons">
                        ...
                        <button type="button" disabled="disabled" onclick="ver_pdf_receta($('#id_fc').val());" class=" btn_medicamento_pdf btn btn-primary  btn-xs mt-1" id="btn_medicamento_pdf"><i class="feather icon-file"></i> Ver Receta</button>
                ...
                <div class="col-sm-12 col-md-6">
                    <div class="btn-group btn-group-xs w-100" data-toggle="buttons">
                        ...
                        <button type="button" disabled="disabled" onclick="ver_pdf_orden_examenes($('#id_fc').val());" class=" btn_examenes_pdf btn btn-primary  btn-xs mt-1" id="btn_examenes_pdf"><i class="feather icon-file"></i> Ver PDF</button>
                    </div>
                </div>
            @endif
        @else
