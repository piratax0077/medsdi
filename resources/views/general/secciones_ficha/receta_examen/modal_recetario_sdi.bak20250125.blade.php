...
<script>
    ...
    function indicar_medicamento_sdi()
    {
        ...
        if($.inArray(id_medicamento,lista_med) == -1)
        {
            ...
            // {
            //     valido = 1;
            //     mensaje += 'Debe completar el campo Periodo 2.\n';
            // }
    ...
    {
        console.log('resources\views\general\secciones_ficha\receta_examen\modal_recetario_sdi.blade.php');
        ...
        .done(function(data)
        {
            ...
            if (data !== 'null')
            {
                ...
                html += '    </tr>';
                html += '</thead>';
                html += '<tbody id="tbody_tabla_medicamento_cirugia_sdi">';
