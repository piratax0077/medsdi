                        ...
                        <div class="card-header-fmu" id="enf-cron">
                                ...
                                <div class="row px-2 pt-2">
                                	<div class="col-sm-12 col-md-6 col-lg-6 col-xl-6 mb-2">
                                		<h6 class="f-14">{{$paciente->nombres}} {{$paciente->apellido_uno}} {{$paciente->apellido_dos}} <small>({{$paciente->rut}})</small><h6>
                                	</div>
                                	<div class="col-sm-12 col-md-6 col-lg-6 col-xl-6 mb-2">
                                		<h6 class="f-14">Grupo sanguíneo: <span style="color: #ff0000;font-weight: bold;">{{$grupo_sanguineo->nombre_gs}}</span></h6>
                                	</div>
                                	<div class="col-sm-12 col-md-6 col-lg-6 col-xl-6 mb-2">
                                		<h6 class="f-14">{{ \Carbon\Carbon::parse($paciente->fecha_nac)->age }} Años <small>({{ date('d-m-Y', strtotime($paciente->fecha_nac)) }})</small></h6>
                                	</div>
                                	<div class="col-sm-12 col-md-6 col-lg-6 col-xl-6 mb-2">
                                        @php
                                            $sexos = array(
                                        ...
                                        @endphp
                                		<h6 class="f-14">Sexo: {{$sexos[$paciente->sexo]}}</h6>
                                	</div>
                                	<div class="col-sm-12 col-md-6 col-lg-6 col-xl-6 mb-2">
                                	...
                                	<div class="col-sm-12 col-md-6 col-lg-6 col-xl-6 mb-2">
                                		<h6 class="f-14">Discapacidad: {!! ($cantidad_ante_discapacidad > 0?'<span style="color: #ff0000;font-weight: bold;">SI</span>':'<span style="color: #000000;font-weight: bold;">NO</span>') !!}</h6>
                                	</div>
