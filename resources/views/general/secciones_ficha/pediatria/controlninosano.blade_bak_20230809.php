                    ...
                    <div class="tab-content" id="v-pills-tabContent">
                                ...
                                <div class="tab-pane fade show active" id="em-partpuer" role="tabpanel" aria-labelledby="em-partpuer-tab">
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                            ...
                                            <input type="text" class="form-control form-control-sm" name="emb_nombre_centro" id="emb_nombre_centro">
                                            <input type="hidden" class="form-control form-control-sm" name="emb_id_institucion" id="emb_id_institucion">
                                        </div>
                                        <div class="form-group col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                            <label class="floating-label-activo-sm">Patología del embarazo</label>
                                            <input type="text" class="form-control form-control-sm" name="emb_pat_embarazo" id="emb_pat_embarazo"><!-- protocolo - diagnostico_preoperatorio -->
                                        </div>
                                        <div class="form-group col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                            <label class="floating-label-activo-sm">Embarazo controlado</label>
                                            <input type="text" class="form-control form-control-sm" name="emb_cont_emb" id="emb_cont_emb"> <!-- protocolo - tipo_embarazo -->
                                        </div>
                                        <div class="form-group col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                            <label class="floating-label-activo-sm">Tipo de parto</label>
                                            <input type="text" class="form-control form-control-sm" name="emb_tipo_procedimiento" id="emb_tipo_procedimiento">
                                        </div>
                                        <div class="form-group col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                            <label class="floating-label-activo-sm">Inscripción en Registro Civil</label>
                                            <input type="text" class="form-control form-control-sm" name="emb_insc" id="emb_insc">
                                            <input type="hidden" class="form-control form-control-sm" name="emb_id_infante" id="emb_id_infante">
                                        </div>
                                        <div class="form-group col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                            <label class="floating-label-activo-sm">Nombre Neonatólogo <i>(Recibe bebé)</i></label>
                                            <input type="text" class="form-control form-control-sm" name="emb_nombre_neonatologo" id="emb_nombre_neonatologo">
                                            <input type="hidden" class="form-control form-control-sm" name="emb_id_neonatologo" id="emb_id_neonatologo">
                                        </div>
                                        <div class="form-group col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                            <label class="floating-label-activo-sm">Nombre Obstétra <i>(Opera)</i></label>
                                            <input type="text" class="form-control form-control-sm" name="emb_nombre_obstetra" id="emb_nombre_obstetra">
                                            <input type="hidden" class="form-control form-control-sm" name="emb_id_profesional" id="emb_id_profesional">
                                        </div>
                                        <div class="form-group col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                            <label class="floating-label-activo-sm">Matrona</label>
                                            <input type="text" class="form-control form-control-sm" name="emb_matron" id="emb_matron">
                                        </div>
                                        {{-- <div class="form-group col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                            <label class="floating-label-activo-sm">Otros</label>
                                            <input type="text" class="form-control form-control-sm" name="emb_otros_parto" id="emb_otros_parto">
                                        </div> --}}
                                    </div>
                                </div>
                                ...
                                <div class="tab-pane fade show" id="nacido-partpuer" role="tabpanel" aria-labelledby="nacido-partpuer-tab">
                                   <div class="form-row">
                                        ...
                                        <div class="form-group col-sm-3 col-md-3">
                                            ...
                                            <input type="text" class="form-control form-control-sm" name="emb_codigo_brazalete" id="emb_codigo_brazalete">
                                        </div>
                                        <div class="form-group col-sm-3 col-md-3">
                                            <label class="floating-label-activo-sm">Sexo</label>
                                            <input type="text" class="form-control form-control-sm" name="emb_sexo_nacimiento" id="emb_sexo_nacimiento">
                                        </div>
                                        <div class="form-group col-sm-3 col-md-3">
                                            <label class="floating-label-activo-sm">Fecha nacimiento</label>
                                            <input type="date" class="form-control form-control-sm" name="emb_fecha_nacimiento" id="emb_fecha_nacimiento">
                                        </div>
                                        <div class="form-group col-sm-3 col-md-3">
                                            <label class="floating-label-activo-sm">Hora</label>
                                            <input type="time" class="form-control form-control-sm" name="emb_hora_nacimiento" id="emb_hora_nacimiento">
                                        </div>
                                        <div class="form-group col-sm-3 col-md-3">
                                            <label class="floating-label">Peso (kg.)</label>
                                            <input type="number" class="form-control form-control-sm" name="emb_peso_nacimiento" id="emb_peso_nacimiento">
                                        </div>
                                        <div class="form-group col-sm-3 col-md-3">
                                            <label class="floating-label">Talla (cm.)</label>
                                            <input type="number" class="form-control form-control-sm" name="emb_talla_nacimiento" id="emb_talla_nacimiento">
                                        </div>
                                        <div class="form-group col-sm-3 col-md-3">
                                            <label class="floating-label">Perimetro cefálico (cm.)</label>
                                            <input type="number" class="form-control form-control-sm" name="emb_perimetro_cefalico" id="emb_perimetro_cefalico">
                                        </div>
                                        <div class="form-group col-sm-3 col-md-3">
                                            <label class="floating-label">APGAR min</label>
                                            <input type="text" class="form-control form-control-sm" name="emb_apgar" id="emb_apgar">
                                        </div>
                                        <div class="form-group col-sm-3 col-md-3">
                                            <label class="floating-label">APGAR 5 min</label>
                                            <input type="text" class="form-control form-control-sm" name="emb_apgar_cinco" id="emb_apgar_cinco">
                                        </div>
                                        <div class="form-group col-sm-3 col-md-3">
                                            <label class="floating-label">Edad gestacional</label>
                                            <input type="text" class="form-control form-control-sm" name="emb_edad_gestacional" id="emb_edad_gestacional">
                                        </div>
                                        <div class="form-group col-sm-6 col-md-6">
                                            <label class="floating-label">Reanimación</label>
                                            <input type="text" class="form-control form-control-sm" name="emb_reanimacion" id="emb_reanimacion">
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label class="floating-label">Diagnóstico</label>
                                            <input class="form-control form-control-sm" name="emb_diag" id="emb_diag" value="">
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label class="floating-label">Pronóstico</label>
                                            <input class="form-control form-control-sm" name="emb_pronostico" id="emb_pronostico" value="">
                                        </div>
                                        <div class="form-group col-sm-6 col-md-6">
                                            <label class="floating-label">Sueros y medicamentos</label>
                                            <textarea class="form-control form-control-sm" rows="1" onfocus="this.rows=6" onblur="this.rows=1;" name="emb_medicamentos" id="emb_medicamentos"></textarea>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label class="floating-label">Observaciones</label>
                                            <textarea class="form-control form-control-sm" rows="1" onfocus="this.rows=6" onblur="this.rows=1;" name="emb_obs" id="emb_obs"></textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="tab-pane fade show" id="vac-partpuer" role="tabpanel" aria-labelledby="vac-partpuer-tab">
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" class="form-control form-control-sm" name="emb_bcg" id="emb_bcg">
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label class="floating-label-activo-sm">Hepatitis B</label>
                                            <input type="text" class="form-control form-control-sm" name="emb_hepatitis_b" id="emb_hepatitis_b">
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label class="floating-label-activo-sm">Otra</label>
                                            <textarea class="form-control form-control-sm" rows="1" onfocus="this.rows=6" onblur="this.rows=1;" name="emb_otras_vacunas" id="emb_otras_vacunas"></textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="tab-pane fade show" id="ex-tam-partpuer" role="tabpanel" aria-labelledby="ex-tam-partpuer-tab">
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="text" class="form-control form-control-sm" name="emb_tsh" id="emb_tsh">
                                        </div>
                                        <div class="form-group col-md-3">
                                            <label class="floating-label">Evaluación auditiva</label>
                                            <textarea class="form-control form-control-sm" rows="1" onfocus="this.rows=6" onblur="this.rows=1;" name="emb_eval_audit" id="emb_eval_audit"></textarea>
                                        </div>
                                        <div class="form-group col-md-3">
                                            <label class="floating-label">PKU</label>
                                            <input type="text" class="form-control form-control-sm" name="emb_pku" id="emb_pku">
                                        </div>
                                        <div class="form-group col-md-3">
                                            <label class="floating-label">Otros</label>
                                            <textarea class="form-control form-control-sm" rows="1" onfocus="this.rows=6" onblur="this.rows=1;" name="emb_otros_ex" id="emb_otros_ex"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="tab-pane fade" id="nsdos" role="tabpanel" aria-labelledby="nsdos-tab">
                            ...
                            <ul class="nav nav-tabs-aten nav-fill mb-3" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link-aten text-reset active" id="pa-gen-ns-07-tab" data-toggle="tab" href="#pa-gen-ns-07" role="tab" aria-controls="pa-gen-ns-07" aria-selected="false">Parametros generales</a>
                                </li>
                                <li class="nav-item">
                            ...
                            <div class="tab-content" >
                                ...
                                <div class="tab-pane fade show active" id="pa-gen-ns-07" role="tabpanel" aria-labelledby="pa-gen-ns-07-tab">
                                    <div class="form-row">
                                        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                        ...
                                        <div class="col-sm-12 col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select name="p_07_est_emo_redes" id="p_07_est_emo_redes" data-titulo="Emoción"class="form-control form-control-sm" onchange="evaluar_para_carga_detalle('p_07_est_emo_redes','p_07_est_emo_redes','obs_p_07_est_emo_redes',2);">
                                                    <option selected value="1">Normal</option>
                                                    <option value="2">Alterado</option>
                                                    <option value="3">No Informadas</option>
                                                </select>
                                            </div>
                                            <div class="form-group" id="p_07_est_emo_redes" style="display:none">
                                                <label class="floating-label-activo-sm">Estado emocional familiar <i>(describir)</i></label>
                                                <textarea class="form-control form-control-sm"  data-titulo="Emoción" rows="1"  onfocus="this.rows=6" onblur="this.rows=1;" name="obs_p_07_est_emo_redes" id="obs_p_07_est_emo_redes"></textarea>
                                            </div>
                                        </div>
                                        <div class="col-sm-12 col-md-4">
                                            <div class="form-group">
                                ...
                                <div class="tab-pane fade show" id="diagnos-ns-07" role="tabpanel" aria-labelledby="diagnos-ns-07-tab">
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <textarea class="form-control form-control-sm" rows="1" onfocus="this.rows=2" onblur="this.rows=1;" name="p_07_dg_gen" id="p_07_dg_gen"></textarea>
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label class="floating-label">Incremento ponderal</label>
                                            <textarea class="form-control form-control-sm" rows="1" onfocus="this.rows=2" onblur="this.rows=1;" name="p_07_inc_pon" id="p_07_inc_pon"></textarea>
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label class="floating-label">Lactancia</label>
                                            <textarea class="form-control form-control-sm" rows="1" onfocus="this.rows=2" onblur="this.rows=1;" name="p_07_nutricional" id="p_07_nutricional"></textarea>
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label class="floating-label">Salud del lactante</label>
                                            <textarea class="form-control form-control-sm" rows="1" onfocus="this.rows=2" onblur="this.rows=1;" name="p_07_sal_lact" id="p_07_sal_lact"></textarea>
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label class="floating-label">Salud de la madre</label>
                                                <textarea class="form-control form-control-sm" rows="1" onfocus="this.rows=2" onblur="this.rows=1;" name="p_07_otros" id="p_07_otros"></textarea>
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label class="floating-label">Salud psicosocial</label>
                                                <textarea class="form-control form-control-sm" rows="1" onfocus="this.rows=2" onblur="this.rows=1;" name="p_07_sal_sicosocial" id="p_07_sal_sicosocial"></textarea>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="tab-pane fade" id="nstres" role="tabpanel" aria-labelledby="nstres-tab">
                            ...
                            <ul class="nav nav-tabs-aten nav-fill mb-3" id="ns-01m" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link-aten text-reset active " id="pa-gen-ns-01m-tab" data-toggle="tab" href="#pa-gen-ns-1m" role="tab" aria-controls="pa-gen-ns-01m" aria-selected="false">Parametros generales</a>
                                </li>
                                <li class="nav-item">
                            ...
                            <div class="tab-content" id="ns-1m">
                                ...
                                <!--PARAMETROS GENERALES-->
                                <div class="tab-pane fade show active" id="pa-gen-ns-1m" role="tabpanel" aria-labelledby="pa-gen-ns-1m-tab">
                                    <div class="form-row">
                                        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                ...
                                <div class="tab-pane fade show" id="antropometria-ns-1m" role="tabpanel" aria-labelledby="antropometria-ns-1m-tab">
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="number" class="form-control form-control-sm" name="p_1_peso" id="p_1_peso">
                                        </div>
                                        <div class="form-group col-md-3">
                                            <label class="floating-label">Longitud (cm.)</label>
                                            <input type="number" class="form-control form-control-sm" name="p_1_longitud" id="p_1_longitud">
                                        </div>
                                        <div class="form-group col-md-3">
                                            <label class="floating-label">Perímetro cefálico (cm.)</label>
                                            <input type="number" class="form-control form-control-sm" name="p_1_per_cef" id="p_1_per_cef">
                                        </div>
                                        <div class="form-group col-md-3">
                                            <label class="floating-label">Cefalohematomas Fontanella ant.</label>
                                            <textarea class="form-control form-control-sm"  rows="1" onfocus="this.rows=6" onblur="this.rows=1;" id="p_1_otros_font" name="p_1_otros_font" ></textarea>
                                        </div>
                                    </div>
                                </div>
                                <!--LACTANCIA MATERNA-->
                                <div class="tab-pane fade show" id="lac-mat-ns-1m" role="tabpanel" aria-labelledby="llac-mat-ns-1m-tab">
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-3">
                                            <label class="floating-label">General</label>
                                            <textarea class="form-control form-control-sm"  rows="1" onfocus="this.rows=6" onblur="this.rows=1;" id="p_1_lac_general" name="p_1_lac_general" ></textarea>
                                        </div>
                                        <div class="form-group col-md-3">
                                            <label class="floating-label">Técnica</label>
                                            <textarea class="form-control form-control-sm"  rows="1" onfocus="this.rows=6" onblur="this.rows=1;" id="p_1_tec" name="p_1_tec" ></textarea>
                                        </div>
                                        <div class="form-group col-md-3">
                                            <label class="floating-label">Ex. Mamas</label>
                                            <textarea class="form-control form-control-sm"  rows="1" onfocus="this.rows=6" onblur="this.rows=1;" id="p_1_mamas" name="p_1_mamas" ></textarea>
                                        </div>
                                        <div class="form-group col-md-3">
                                            <label class="floating-label">Señales de maltrato</label>
                                                <textarea class="form-control form-control-sm"  rows="1" onfocus="this.rows=6" onblur="this.rows=1;" id="p_1_maltrato" name="p_1_maltrato" ></textarea>
                                        </div>
                                    </div>
                                </div>
                                <!--DIAGNÓSTICOS-->
                                <div class="tab-pane fade show" id="diagnos-ns-1m" role="tabpanel" aria-labelledby="diagnos-ns-1m-tab">
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-4">
                                            <label class="floating-label">General</label>
                                            <textarea class="form-control form-control-sm" rows="1" onfocus="this.rows=6" onblur="this.rows=1;" name="p_1_general" id="p_1_general"></textarea>
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label class="floating-label">Incremento ponderal</label>
                                            <textarea class="form-control form-control-sm" rows="1" onfocus="this.rows=6" onblur="this.rows=1;" name="p_1_inc_pon" id="p_1_inc_pon"></textarea>
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label class="floating-label">Nutricional</label>
                                            <textarea class="form-control form-control-sm" rows="1" onfocus="this.rows=6" onblur="this.rows=1;" name="p_1_nutricional" id="p_1_nutricional"></textarea>
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label class="floating-label">Salud del lactante</label>
                                            <textarea class="form-control form-control-sm" rows="1" onfocus="this.rows=6" onblur="this.rows=1;" name="p_1_sal_lact" id="p_1_sal_lact"></textarea>
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label class="floating-label">Salud de la madre</label>
                                            <textarea class="form-control form-control-sm" rows="1" onfocus="this.rows=6" onblur="this.rows=1;" name="p_1_sal_madre" id="p_1_sal_madre"></textarea>
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label class="floating-label">Salud psicosocial</label>
                                            <textarea class="form-control form-control-sm" rows="1" onfocus="this.rows=6" onblur="this.rows=1;" name="p_1_sal_psico" id="p_1_sal_psico"></textarea>
                                        </div>
                                    </div>
                                </div>
                                <!--INDICACIONES Y PROX. CONTROL-->
                                <div class="tab-pane fade show" id="indicaciones-ns-1m" role="tabpanel" aria-labelledby="indicaciones-ns-1m-tab">
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-2">
                                            <label class="floating-label-activo-sm">Fecha</label>
                                            <input type="date" class="form-control form-control-sm" name="p_1_fecha_proxcontrol" id="p_1_fecha_proxcontrol">
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label class="floating-label">Control con</label>
                                            <input type="text" class="form-control form-control-sm" name="p_1_control_con" id="p_1_control_con">
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label class="floating-label">Indicaciones</label>
                                            <textarea class="form-control form-control-sm" rows="1" onfocus="this.rows=4" onblur="this.rows=1;" name="p_1_ind" id="p_1_ind"></textarea>
                                        </div>
                                        <div class="form-group col-md-12">
                                            <label class="floating-label">Sugerencias</label>
                                            <textarea class="form-control form-control-sm" rows="1" onfocus="this.rows=4" onblur="this.rows=1;" name="p_1_sugerencias" id="p_1_sugerencias"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="tab-pane fade" id="nscuatro" role="tabpanel" aria-labelledby="nscuatro-tab">
                            ...
                            <ul class="nav nav-tabs-aten nav-fill mb-3" id="ns-25m" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link-aten text-reset active " id="pa-gen-ns-25m-tab" data-toggle="tab" href="#pa-gen-ns-25m" role="tab" aria-controls="pa-gen-ns-25m" aria-selected="false">Parametros generales</a>
                                </li>
                                <li class="nav-item">
                            ...
                            <div class="tab-content" id="ns-25">
                                ...
                                <!--PARAMETROS GENERALES-->
                                <div class="tab-pane fade show active" id="pa-gen-ns-25m" role="tabpanel" aria-labelledby="pa-gen-ns-25m-tab">
                                    <div class="form-row">
                                ...
                                <div class="tab-pane fade show" id="antropometria-ns-25m" role="tabpanel" aria-labelledby="antropometria-ns-25-tab">
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-3">
                                            <label class="floating-label">Peso en (gr.)</label>
                                            <input type="number" class="form-control form-control-sm" name="p_25_peso" id="p_25_peso">
                                        </div>
                                        <div class="form-group col-md-3">
                                            <label class="floating-label">Longitud (cm.)</label>
                                            <input type="number" class="form-control form-control-sm" name="p_25_longitud" id="p_25_longitud">
                                        </div>
                                        <div class="form-group col-md-3">
                                            <label class="floating-label">Perímetro cefálico (cm.)</label>
                                            <input type="number" class="form-control form-control-sm" name="p_25_per_cef" id="p_25_per_cef">
                                        </div>
                                        <div class="form-group col-md-3">
                                            <label class="floating-label">Otros (lesiones)</label>
                                            <textarea class="form-control form-control-sm"  rows="1" onfocus="this.rows=6" onblur="this.rows=1;" id="p_25_otros_font" name="p_25_otros_font"></textarea>
                                        </div>
                                        <div class="form-group col-md-12">
                                            <label class="floating-label">Señales de maltrato</label>
                                            <textarea class="form-control form-control-sm"  rows="1" onfocus="this.rows=4" onblur="this.rows=1;" id="p_25_maltrato" name="p_25_maltrato" ></textarea>
                                        </div>
                                    </div>
                                </div>
                                <!--DIAGNÓSTICO-->
                                <div class="tab-pane fade show" id="diagnos-ns-25m" role="tabpanel" aria-labelledby="diagnos-ns-25m-tab">
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-4">
                                            <label class="floating-label">General</label>
                                            <textarea class="form-control form-control-sm" rows="1" onfocus="this.rows=6" onblur="this.rows=1;" name="p_25_dg_gen" id="p_25_dg_gen"></textarea>
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label class="floating-label">Incremento ponderal</label>
                                            <textarea class="form-control form-control-sm" rows="1" onfocus="this.rows=6" onblur="this.rows=1;" name="p_25_inc_pon" id="p_25_inc_pon"></textarea>
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label class="floating-label">Lactancia</label>
                                            <textarea class="form-control form-control-sm" rows="1" onfocus="this.rows=6" onblur="this.rows=1;" name="p_25_nutricional" id="p_25_nutricional"></textarea>
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label class="floating-label">Salud del lactante</label>
                                            <textarea class="form-control form-control-sm" rows="1" onfocus="this.rows=6" onblur="this.rows=1;" name="p_25_sal_lact" id="p_25_sal_lact"></textarea>
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label class="floating-label">Otros</label>
                                                <textarea class="form-control form-control-sm" rows="1" onfocus="this.rows=6" onblur="this.rows=1;" name="p_25_otros" id="p_25_otros"></textarea>
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label class="floating-label">Salud psicosocial</label>
                                                <textarea class="form-control form-control-sm" rows="1" onfocus="this.rows=6" onblur="this.rows=1;" name="p_25_sal_sicosocial" id="p_25_sal_sicosocial"></textarea>
                                        </div>
                                    </div>
                                </div>
                                <!--INDICACIONES Y PROX. CONTROL-->
                                ...
                                <div class="form-row">
                                        ...
                                        <div class="form-group col-md-2">
                                            <label class="floating-label-activo-sm">Fecha</label>
                                            <input type="date" class="form-control form-control-sm" name="p_25_fecha_proxcontrol" id="p_25_fecha_proxcontrol">
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label class="floating-label">Control con:</label>
                                            <input type="text" class="form-control form-control-sm" name="p_25_control_con" id="p_25_control_con">
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label class="floating-label">Indicaciones</label>
                                            <textarea class="form-control form-control-sm" rows="1" onfocus="this.rows=4" onblur="this.rows=1;" name="p_25_ind" id="p_25_ind"></textarea>
                                        </div>
                                        <div class="form-group col-md-12">
                                            <label class="floating-label">Sugerencias</label>
                                            <textarea class="form-control form-control-sm" rows="1" onfocus="this.rows=4" onblur="this.rows=1;" name="p_25_sugerencias" id="p_25_sugerencias"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="tab-pane fade" id="nscinco" role="tabpanel" aria-labelledby="nscinco-tab">
                            ...
                            <ul class="nav nav-tabs-aten nav-fill mb-3" id="ns-01m" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link-aten text-reset active" id="pa-gen-ns-611m-tab" data-toggle="tab" href="#pa-gen-ns-611m" role="tab" aria-controls="pa-gen-ns-611m" aria-selected="false">Parametros generales</a>
                                </li>
                                <li class="nav-item">
                            ...
                            <div class="tab-content" id="ev-nutricional">
                                ...
                                <!--PARAMETROS GENERALES-->
                                <div class="tab-pane fade show active" id="pa-gen-ns-611m" role="tabpanel" aria-labelledby="pa-gen-ns-611m-tab">
                                    <div class="form-row">
                                        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                            <h6 class="f-16 text-c-blue mb-3">Control parámetros generales</h6>
                                        </div>
                                ...
                                <div class="tab-pane fade show" id="indicaciones-ns-611m" role="tabpanel" aria-labelledby="indicaciones-ns-611m-tab">
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-2">
                                            <label class="floating-label-activo-sm">Fecha</label>
                                            <input type="date" class="form-control form-control-sm" name="p_611_fecha_proxcontrol" id="p_611_fecha_proxcontrol">
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label class="floating-label">Control con:</label>
                        ...
                        <div class="tab-pane fade" id="nsseis" role="tabpanel" aria-labelledby="nsseis-tab">
                            ...
                            <ul class="nav nav-tabs-aten nav-fill mb-3" id="ns-123m" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link-aten text-reset active" id="pa-gen-ns-1223m-tab" data-toggle="tab" href="#pa-gen-ns-1223m" role="tab" aria-controls="pa-gen-ns-1223m" aria-selected="false">Parametros generales</a>
                                </li>
                                <li class="nav-item">
                            ...
                            <div class="tab-content" id="ns-1223m">
                                ...
                                <!--PARAMETROS GENERALES-->
                                <div class="tab-pane fade show active" id="pa-gen-ns-1223m" role="tabpanel" aria-labelledby="pa-gen-ns-1223m-tab">
                                    <div class="form-row">
                                        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                            <h6 class="f-16 text-c-blue mb-3">Parametros generales</h6>
                                        </div>
                        ...
                        <div class="tab-pane fade" id="nssiete" role="tabpanel" aria-labelledby="nssiete-tab">
                            ...
                            <ul class="nav nav-tabs-aten nav-fill mb-3" id="ns-24a" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link-aten text-reset active" id="pa-gen-ns-24a-tab" data-toggle="tab" href="#pa-gen-ns-24a" role="tab" aria-controls="pa-gen-ns-24a" aria-selected="false">Parametros generales</a>
                                </li>
                                <li class="nav-item">
                            ...
                            <div class="tab-content" id="ns-24a">
                                ...
                                <!--PARAMETROS GENERALES-->
                                <div class="tab-pane fade show active" id="pa-gen-ns-24a" role="tabpanel" aria-labelledby="pa-gen-ns-24a-tab">
                                    <div class="form-row">
                                        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                            <h6 class="f-16 text-c-blue mb-3">Parametros generales</h6>
                                        </div>
                        ...
                        <div class="tab-pane fade" id="nsocho" role="tabpanel" aria-labelledby="nsocho-tab">
                            ...
                            <ul class="nav nav-tabs-aten nav-fill mb-3" id="ns-69a" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link-aten text-reset active" id="pa-gen-ns-69a-tab" data-toggle="tab" href="#pa-gen-ns69a" role="tab" aria-controls="pa-gen-ns-69a" aria-selected="false">Parametros generales</a>
                                </li>
                                <li class="nav-item">
                            ...
                            <div class="tab-content" id="ns-6-9a">
                                ...
                                <!--PARAMETROS GENERALES-->
                                <div class="tab-pane fade show active" id="pa-gen-ns69a" role="tabpanel" aria-labelledby="pa-gen-ns69a-tab">
                                    <div class="form-row">
                                        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                ...
                                <div class="tab-pane fade show" id="antropometria-ns-69a" role="tabpanel" aria-labelledby="antropometria-ns-69a-tab">
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-4">
                                            <button type="button" class="btn btn-primary-light btn-block btn-sm" onclick="imc_ref()";>Valores referenciales</button>
                                        </div>
                                        <div class="form-group col-md-4">
