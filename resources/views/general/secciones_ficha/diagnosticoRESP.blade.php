                            ...
                            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                ...
                                <div class="form-row mb-3">
                                    {{--  <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4 my-1">
                                        <button type="button" class="btn btn-primary-light-c btn-xs btn-block" onclick="sol_examen_broncoscopia()";><i class="feather icon-edit-1"></i> Solicitar Broncoscopía</button>
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6 my-1">
                                        <button type="button" class="btn btn-primary-light-c btn-xs btn-block" onclick="sol_ex_funcional_cardio()";><i class="feather icon-edit-1"></i> Examenes Funcionales</button>
                                    </div>
                                </div>
                                @endif
                                ...
                                <div class="form-row m-2">
                                 ...
                                 <div class="form-row mb-3">
                                    <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4 my-1">
                                        <button type="button" class="btn btn-primary-light-c btn-xs btn-block" onclick="sol_examen_endoscopia()";><i class="feather icon-edit-1"></i> Solicitar Endoscopía</button>
                                    </div>
                                    <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4 my-1">
                                ...
                                <div class="form-row mb-3">
                                    <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4 my-1">
                                        <button type="button" class="btn btn-primary-light-c btn-xs btn-block" onclick="sol_examen_endosc_eda()";><i class="feather icon-edit-1"></i> Solicitar Endoscopía</button>

                                    </div>
                                    <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4 my-1">
                                        <button type="button" class="btn btn-primary-light-c btn-xs btn-block" onclick="sol_examen_endosc_edb()";><i class="feather icon-edit-1"></i> Solicitar Estudio Radiològico</button>
                                    </div>
                                    <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4 my-1">
                                        <button type="button" class="btn btn-primary-light-c btn-xs btn-block" onclick="mostrar_modal_examen_cirguria()";><i class="feather icon-edit-1"></i> Examenes Frecuentes</button>
                                    </div>
                                </div>
                                @endif
