...
<div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
    <div class="card-a">
        ...
        <div class="card-header-a" id="motivo1">
            <button class="accor-closed btn pt-1 pb-0 pl-1 btn-block text-left collapsed" type="button" data-toggle="collapse" data-target="#motivo1_c" aria-expanded="false" aria-controls="motivo1_c">
                Plan de tratamiento
            </button>
        </div>
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                        ...
                        <div class="form-row mb-3">
                            ...
                            <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4 my-1">
                                <button type="button" class="btn btn-primary-light-c btn-xs btn-block" onclick="sol_examen_endosc_edb()";><i class="feather icon-edit-1"></i> Solicitar Estudio Radiológico</button>
                            </div>
                            <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4 my-1">
                        ...
                        <div class="form-row">
                            <div class="col-sm-12 col-md-12 col-lg-4 col-xl-4 mb-0 mt-0">
                                <div class="form-group">
                                    <label class="ml-0" for="tto_med_cda"><strong>Tratamiento médico1</strong></label>
                                    <div class="switch switch-success d-inline m-r-10">
                                        <input type="checkbox" id="tto_med_cda" name="tto_med_cda" value="1" onchange="javascript:showContentTmcda()" />
                                        <label for="tto_med_cda" class="cr"></label>
                                    </div>
