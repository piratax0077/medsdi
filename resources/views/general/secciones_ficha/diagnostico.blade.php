                    ...
                    <div class=" col-sm-12 col-md-12 col-lg-12 col-xl-12">
                        <div id="motivo1_c" class="collapse" aria-labelledby="motivo1" data-parent="#motivo1">
                            <div class="card-body-aten-a">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                        ...
                                        <div class="form-row mb-3">
                                            ...
                                            <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6 my-1">
                                                <button type="button" class="btn btn-primary-light-c btn-xs btn-block" onclick="sol_ex_comunes()";><i class="feather icon-edit-1"></i> Examenes Funcionales</button>
                                            </div>
                                        </div>
                                        @endif
                                        ...
                                        <div class="form-row mb-3">
                                            <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4 my-1">
                                                <button type="button" class="btn btn-primary-light-c btn-xs btn-block" onclick="sol_examen_endoscopia()";><i class="feather icon-edit-1"></i> Solicitar Endoscopía Alta</button>
                                            </div>
                                            <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4 my-1">
                                                <button type="button" class="btn btn-primary-light-c btn-xs btn-block" onclick="sol_examen_endoscopia()";><i class="feather icon-edit-1"></i> Solicitar Endoscopía Baja</button>
                                            </div>
                                            <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4 my-1">
                                                <button type="button" class="btn btn-primary-light-c btn-xs btn-block" onclick="sol_ex_func_gastro()";><i class="feather icon-edit-1"></i> Examenes</button>
                                            </div>
                                        </div>
                                        @endif
                                ...
                                <div class="form-row">
                                    <div class="form-group col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                        <label class="floating-label-activo-sm"for="obs_plan_trat_cda">Obs. Plan de tratamiento1</label>
