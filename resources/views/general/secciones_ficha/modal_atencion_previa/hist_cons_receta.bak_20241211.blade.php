<div id="m_cons_receta" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="m_cons_recetaLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header bg-info">asdasdasd
                <h5 class="modal-title text-white" id="id_ficha_receta"> Recetas</h5>
            ...
            <div class="modal-body">
                <form>
                    <table id="tabla_atenciones_previas_receta" class="display table table-striped table-sm dt-responsive nowrap"
                        style="width:100%;">
                        <thead>
                            <tr>
                                {{--  <th>Fecha</th>  --}}
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-danger-light-c" data-dismiss="modal" onclick="$('#m_cons_receta').modal('hide'); ">Cerrar</button>
            </div>
        </div>
    </div>
</div>
