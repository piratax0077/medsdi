<div class="row">
    <div class="col-md-12 mt-2 mb-0">
        <h6 class="f-20 text-c-blue mb-3">Evaluación psicosocial</h6>
    </div>
</div>
<div class="row">
                            ...
                            <div class="tab-content" id="siquiatria_adulto">
                                    ...
                                    <div class="form-row">
                                        <div class="col-sm-12 col-md-4 col-lg-3 col-xl-2">
                                            <div class="nav flex-column nav-pills mb-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                                ...
                                                <a class="nav-link-aten text-reset" id="psi_esparcimiento-tab" data-toggle="tab" href="#psi_esparcimiento" role="tab" aria-controls="psi_esparcimiento" aria-selected="false">Esparcimiento</a>
                                            ...
                                            <div class="tab-content" id="v-pills-tabContent">
                                                ...
                                                <div class="tab-pane fade show" id="ant_especialidad" role="tabpanel" aria-labelledby="ant_especialidad-tab">
                                                    <form>
                                                        <div class="form-row">
                                                            <div class="col-12">
                                                                <h6 class="tit-gen">Antecedentes especialidad</h6>
                                                            </div>
                                                        </div>
                                                        <div class="form-row">
                                                            ...
                                                            <div class="form-group col-sm-12 col-md-12 col-lg-6 col-xl-6">
                                                                <label class="floating-label-activo-sm">Tratamientos psicológicos previos</label>
                                                ...
                                                <div class="tab-pane fade" id="psi_esparcimiento" role="tabpanel" aria-labelledby="psi_esparcimiento_tab">
                                                    <form>
                                                        <div class="form-row">
                                                            <div class="col-12">
                                                                <h6 class="tit-gen">Esparcimiento</h6>
                                                            </div>
                                                        </div>
                                                        <div class="form-row">
                                                            <div class="form-group col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                                ...
                                                <div class="tab-pane fade" id="psi_medic" role="tabpanel" aria-labelledby="psi_medic-tab">
                                                    <form>
                                                        <div class="form-row">
                                                            <div class="col-12">
                                                                <h6 class="tit-gen">Medicamentos en uso</h6>
                                                            </div>
                                                        </div>
                                                        <div class="form-row">
                                                            <div class="form-group col-sm-12 col-md-12 col-lg-6 col-xl-6">
                                                ...
                                                <div class="tab-pane fade show " id="psi_obs_gen_ant" role="tabpanel" aria-labelledby="psi_obs_gen_ant_tab">
                                                    <div class="form-row">
                                                        <div class="col-12">
                                                            <h6 class="tit-gen">Observaciones</h6>
                                                        </div>
                                                    </div>
                                                    <div class="form-row">
                                                        <div class="form-group col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="tab-content" id="v-pills-tabContent">
                                                ...
                                                <div class="tab-pane fade show active" id="ant_padres" role="tabpanel" aria-labelledby="ant_padres-tab">
                                                    <div class="form-row">
                                                        <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                                            <h6 class="tit-gen mb-3">PADRE</h6>
                                                ...
                                                <div class="tab-pane fade" id="ant_hermanos" role="tabpanel" aria-labelledby="ant_hermanos-tab">
                                                    <div class="form-row">
                                                        <div class="col-12">
                                                            <h6 class="tit-gen mb-3">HERMANOS</h6>
                                                        </div>
                                                        ...
                                                        <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6 col-xxl-4">
                                                            <div class="btn-group w-100 mb-4" role="group" aria-label="hnos-ps">
                                                ...
                                                <div class="tab-pane fade" id="marital" role="tabpanel" aria-labelledby="marital-tab">
                                                    <div class="form-row">
                                                        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                                            <h6 class="tit-gen mb-3">RELACIÓN MARITAL</h6>
                                                            <div class="form-group">
                                                ...
                                                <div class="tab-pane fade" id="hijos" role="tabpanel" aria-labelledby="ehijos-tab">
                                                    <div class="form-row">
                                                        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                                            <h6 class="tit-gen mb-3">HIJOS</h6>
                                                        </div>
                                                    </div>
                                                    <div class="form-row">
                                                        <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6 col-xxl-4">
                                                ...
                                                <div class="tab-pane fade" id="ot_pers" role="tabpanel" aria-labelledby="ot_pers-tab">
                                                    <div class="form-row">
                                                        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                                            <h6 class="d-inline tit-gen">OTROS</h6>
                                                            <div class="d-inline btn-group float-right" role="group" aria-label="hnos-ps">
                                                                <button type="button" class="btn btn-outline-primary btn-xs btn-agregar-otros " onclick="agregarOtro();"><i class="fas fa-plus"></i> Agregar otras personas</button>
                                                    ...
                                                    <div class="form-row">
                                                        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                                            <div class="form-group">
                                                                <label class="floating-label-activo-sm" for="obs_ex_generales_fc_ev">Obs. Generales Funciones Corticales</label>
                                ...
                                <div class="tab-pane fade show" id="biopat" role="tabpanel" aria-labelledby="biopat-tab">
                                    <form>
                                        <div class="form-row">
                                            <div class="col-12">
                                                <h6 class="tit-gen">Biopatografía</h6>
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            <div class="form-group col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                            ...
                                            <div class="col-sm-9">
                                                <div class="tab-content" id="v-pills-tabContent">
                                                    <div class="tab-pane fade show active" id="ant_psico_neur" role="tabpanel" aria-labelledby="ant_psico_neur-tab">
                                                        <div class="form-row">
                                                            <div class="col-12">
                                                                <h6 class="tit-gen">Antecedentes</h6>
                                                            </div>
                                                        </div>
                                                        <div class="form-row">
                                                    ...
                                                    <div class="tab-pane fade" id="eval_psiconeuro" role="tabpanel" aria-labelledby="aeval_psiconeurotab">
                                                        <div class="form-row">
                                                            <div class="col-12">
                                                                <h6 class="tit-gen">Evaluación psiconeurológica</h6>
                                                            </div>
                                                        </div>
                                                        <div class="form-row">
                                                        ...
                                                        <div class="form-row mt-3">
                                                            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                                                <h6 class="text-c-blue text-uppercase">Adjuntar archivos</h6>
                                                            </div>
                                                        </div>
                                                        <style>
                                                            .dropzone .dz-remove {
                                                    ...
                                                    <div class="form-row">
                                                        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                                            <div class="form-group fill">
                                                                <label class="floating-label-activo-sm" for="obs_ex_generales_fc_rm">Obs. Generales Funciones Corticales</label>
                                ...
                                <div class="tab-pane fade show" id="ex_ment_inicio" role="tabpanel" aria-labelledby="ex_ment_inicio-tab">
                                    <form>
                                        <div class="form-row">
                                            <div class="col-12">
                                                <h6 class="tit-gen">Examen mental</h6>
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                                <label class="floating-label-activo-sm">Estado de ánimo y afecto</label>
 ...
 <div class="row">
    <div class="col-12 text-center">
        <button type="button" class="btn btn-info " onclick="guardar_evaluacion_sico()"><i class="feather icon-save"></i> Guardar</button>
    </div>
</div>
