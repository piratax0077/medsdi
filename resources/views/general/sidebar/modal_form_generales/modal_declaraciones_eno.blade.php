    ...
    <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header bg-info">
                ...
                <button type="button" class="close text-white" data-dismiss="modal" onclick="$('#modal_enfermedades_declaracion_obligatoria').modal('hide')" aria-label="Close"><span aria-hidden="true">×</span></button>
            </div>
            <div class="modal-body">
                ...
                <input type="hidden" id="id_eno_email" name="id_eno_email" value="">

                <div class="bt-wizard" id="enfermedades_declaracion_obligatoria">
                    <ul class="nav nav-tabs-aten nav-fill">
                        <li class="nav-item"><a href="#ident_establecimiento_eno" class="nav-link-aten text-reset" data-toggle="tab">1. Identificación del establecimiento</a></li>
                        <li class="nav-item"><a href="#ident_paciente_eno" class="nav-link-aten text-resetnav-link-wizard rounded-0" data-toggle="tab">2. Identificación del paciente</a></li>
                        <li class="nav-item"><a href="#ident_clinica_paciente_eno" class="nav-link-aten text-reset" data-toggle="tab">3. Información clínica del paciente</a></li>
                        <li class="nav-item"><a href="#notificacion_eno" class="nav-link-aten text-reset" data-toggle="tab">4. Notificación</a></li>
                    </ul>
                    <div class="tab-content">
                        ...
                        <div class="tab-pane pt-4 active show" id="ident_establecimiento_eno">
                            <div class="form-row">
                                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                    <h6 class="tit-gen">1. Identificación del establecimiento</h6>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                    <div class="card-informacion">
                                        <div class="card-body px-2 pb-1">
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-sm-12 col-md-6 col-lg-6 col-xl-4 col-xxl-4">
                        ...
                        <div class="tab-pane pt-4" id="ident_paciente_eno">
                            <div class="form-row">
                                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                    <h6 class="tit-gen">2. Identificación del Paciente</h6>
                                </div>
                            </div>
                            <div class="form-row">
                                 <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                    <div class="card-informacion">
                                        <div class="card-body px-2 pb-1">
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-sm-12 col-md-6 col-lg-6 col-xl-4 col-xxl-4">
                                                    <label class="floating-label-activo-sm">Pueblo originario</label>
                        ...
                        <div class="tab-pane pt-4" id="ident_clinica_paciente_eno">
                            <div class="form-row">
                                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                    <h6 class="tit-gen">3. Información clínica del paciente</h6>
                                </div>
                            </div>
                            <div class="form-row">
                                 <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                        ...
                                        <div class="card-body px-2 pb-1">
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-sm-12 col-md-12">
                                                    <h6 class="text-uppercase mt-2">Antecedentes de Vacunación</h6>
                                                </div>
                                                <div class="form-group col-sm-4 col-md-4">
                                                ...
                                                <div class="col-sm-12 col-md-12">
                                                    <h6 class="text-uppercase mt-2 mb-3">Completar solo si la declaración corresponde a TBC</h6>
                                                </div>
                                                <div class="form-group col-sm-6 col-md-6">
                        ...
                        <div class="tab-pane pt-4" id="notificacion_eno">
                            <div class="form-row">
                                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                    <h6 class="tit-gen">4. Información del profesional que notifica</h6>
                                </div>
                            </div>
                            <div class="form-row">
                                 <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                    <div class="card-informacion">
                                        <div class="card-body px-2 pb-1">
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-12">
                                                    <h5 class="tit-gen text-center mt-3">Instructivo boletín notificación de enfermedades de declaración obligatoria (boletín E.N.O)</h5>
                                                </div>
                                                <div class="col-sm-12 col-md-12">
                                                    <div class="alert alert-primary text-justify pt-3 pb-1" role="alert">
                                                        <ol class="px-2">
                                                            <li value="1">
                                                                <p class="text-c-blue">Los Items <strong>Nombre, Establecimiento</strong>,<strong>Oficina Provincial</strong>,<strong>Códigos Asignados</strong>,<strong>Seremi</strong>,<strong>Nacionalidad</strong>,<strong>Pueblo originario declarado</strong>, <strong> Comuna de residencia</strong>, etc. <a href="https://deis.minsal.cl" target="_blank" class="btn btn-xs btn-info"> Los puede consultar acá. </a></p>
                                                            </li>
                                                            <li>
                                                                <p class="text-c-blue">Para el(la) enfermo(a) que presente 2 o más afecciones de
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-danger btn-sm" data-dismiss="modal" onclick="$('#modal_enfermedades_declaracion_obligatoria').modal('hide')"><i class="feather icon-x"></i> Cerrar</button>
                <button type="button" class="btn btn-warning btn-sm" onclick="enviar_eno_email();"><i class="feather icon-mail"></i> Enviar PDF</button>
                <button type="button" class="btn btn-info btn-sm" onclick="registrar_eno();"><i class="feather icon-save"></i> Guardar</button>
            </div>
        </div>
    </div>
</div>
...
<script>
            ...
            .done(function(data)
            {
                if (data !== 'null')
                {
                    if(data.estado == 1)
                    {
                        ...
                        // ✅ Guardar el ID de ENO registrado
                        if (data['id_eno_declaracion']) {
                            $('#id_eno_email').val(data['id_eno_declaracion']);
                        }
    ...
    $(document).ready(function() {
        ...
        // ✅ NUEVA FUNCIÓN: Enviar Declaración ENO por Email
        window.enviar_eno_email = function()
        {
            let id_eno_declaracion = $('#id_eno_email').val();

            if (!id_eno_declaracion) {
                swal({
                    title: "Información",
                    text: "La declaración ENO aún no ha sido registrada. Por favor, haga clic en 'Guardar' primero.",
                    icon: "info",
                });
                return;
            }

            let url = "{{ route('ficha_atencion.enviar_eno_email') }}";

            $.ajax({
                url: url,
                type: 'GET',
                data: {
                    id_eno_declaracion: id_eno_declaracion
                },
            })
            ...
            .fail(function(e) {
                ...
                swal({
                    title: "Error",
                    text: "No se pudo enviar la declaración ENO",
                    icon: "error",
                });
            });
        };
