...
class EscritorioAsistenteCmJefe extends Controller
{
    ...
    public function buscar_paciente()
    {
        ...
        $url = 'app.asistente_cm.buscar_paciente'; // institucion
        $array_data = array(
            'asistente' => $asistente,
            'lugares_atencion' => $lugares_atencion,
        );
    ...
    public function mis_profesionales()
    {
        ...
        $url = 'app.asistente_cm.mis_profesionales'; // institucion
        $array_data = array(
            'asistente' => $asistente,
            'lugares_atencion' => $lugares_atencion,
            'profesionales' => $profesionales,
    ...
    public function getEspecialidad(Request $request)
    {
        ...
        return view('app.asistente_cm.buscador_profesional', ['profesional' => $profesional]);
    }
    ...
    public function agendaPorProfesional()
    {
        ...
        return view('app.asistente_cm.agenda_por_profesional')->with([
            'asistente' => $asistente,
