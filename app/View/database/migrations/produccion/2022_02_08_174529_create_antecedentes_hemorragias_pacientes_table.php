...
class CreateAntecedentesHemorragiasPacientesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('antecedentes_hemorragias_pacientes', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('antecedentes_hemorragias_pacientes');
    }
}