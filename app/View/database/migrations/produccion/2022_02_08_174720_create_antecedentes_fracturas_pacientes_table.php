...
class CreateAntecedentesFracturasPacientesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('antecedentes_fracturas_pacientes', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('antecedentes_fracturas_pacientes');
    }
}